...
const u8 gText_StatTotal[] = _("BST"); // Unused / replaced quotation
const u8 gTextJP_PokemonData[] = _("ポケモンデ-タ");
const u8 gText_Cry[] = _("{START_BUTTON}CRY");
const u8 gText_DexEvoLeftPanel[] = _("{START_BUTTON}CRY {DPAD_UPDOWN}CHECK");
...
const u8 gText_NextPreviousData[] = _("{A_BUTTON}NEXT DATA {B_BUTTON}PREVIOUS DATA");
...
const u8 gOtherText_UnkF9_08_Clear_01[] = _("{NO}{CLEAR 0x01}"); //used tm case, puts No text symbol
...
const u8 gText_ItemCantBeHeld2[] = _("This item can't be held.");
...
const u8 gText_TM_String[] = _("TM");
const u8 gText_HM_String[] = _("HM");
const u8 gText_FontSizeSmall[] = _("{FONT_SMALL}");
const u8 gText_FontSizeNormal[] = _("{FONT_NORMAL}");
...
const u8 gText_ATK3[] = _("ATK");
const u8 gText_DEF3[] = _("DEF");
const u8 gText_SPD[] = _("SPD"); //or SPE
...
const u8 gText_ConfirmLearnMove[] = _("Are you sure you want to\nforget {STR_VAR_3}?");
...
const u8 gText_SetFormFlag[] = _("{STR_VAR_1} was reminded of home.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_RockClimb[] = _("Climb a rock face.");
...
const u8 gText_YourPartysEmpty[] = _("Your party's empty!");
...
const u8 gText_RelearnMove[] = _("REMEMBER MOVE");
...
const u8 gText_DeleteMoveDescription[] = _("You can delete a move from any\nPOKéMON in a BOX or your party.");
const u8 gText_RelearnMoveDescription[] = _("You can have any POKéMON in\na BOX or your party relearn a move.");
const u8 gText_SeeYaDescription[] = _("See you later!");
const u8 gText_NoPkmnInParty[] = _("Can't leave without POKéMON!");
...
const u8 gText_ResetMoveOkBack[] = _("{L_BUTTON}RESET {DPAD_ANY}MOVE {A_BUTTON}OK {B_BUTTON}BACK");
...
const u8 gText_PokeSum_Controls_PageRename[] = _("{DPAD_RIGHT}PAGE {L_BUTTON}RENAME");
...
const u8 gText_SpeciesCap[] = _("CAP. SPECIES"); //this and many others will need to be made lwower case to transfer to placeholder for misc cap
const u8 gText_AbilityCap[] = _("CAP. ABILITY"); //but its limited to 255... well less than that so idk how will work
...
const u8 gText_TextSpeedHyperFast[] = _("HYPER");
const u8 gText_BattleSceneOn[] = _("ON");
const u8 gText_BattleSceneOff[] = _("OFF");
const u8 gText_BattleStyleShift[] = _("SHIFT 2.0"); //changed so people are aware shift mode is different
...
const u8 gUnknown_841B2A9[] = _("{FONT_SMALL}MAX.{FONT 0x02} HP");
...
const u8 gUnknown_841B2DC[] = _("{FONT_SMALL}{PLUS}{FONT 0x02}");
const u8 gUnknown_841B2E5[] = _("{FONT_SMALL}-{FONT 0x02}");
...
const u8 gText_OneDash[] = _("-");//redid to use in hgss dex port

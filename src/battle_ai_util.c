...
//check consider may need to keep in line w battle_script_commands function
//see if can wrap this into that/replace w this, to avoid redundency/possibility of missing things
//yeah think can do that, should be everything after the else, in atk01_accuracycheck

...
static void DebugAction_Give_Item(u8 taskId)
{
    ...
    //default function was copyitemname
    //but after changes it no longer works
    //and causes memory corruption?
    //CopyItemName(1, gStringVar1);
    ItemId_GetName(gStringVar1, 1);
    StringCopyPadded(gStringVar1, gStringVar1, CHAR_SPACE, 15);
    ...
    gSprites[gTasks[taskId].tSpriteId].pos2.x = DEBUG_NUMBER_ICON_X+10;
    gSprites[gTasks[taskId].tSpriteId].pos2.y = DEBUG_NUMBER_ICON_Y+10;
...
static void DebugAction_Give_Pokemon_SelectLevel(u8 taskId)
{
    ...
    if (JOY_NEW(A_BUTTON))
    {
        ...
        {
            PlaySE(MUS_LEVEL_UP);
            ScriptGiveMon2(sDebugMonData->species, gTasks[taskId].tInput, ITEM_NONE, 0, 0, 0);
...
static void DebugAction_Give_Pokemon_SelectIVs(u8 taskId)
{
    ...
    if (JOY_NEW(A_BUTTON))
    {
        ...
        else
        {
            ...
            StringCopy(gStringVar2, gText_DigitIndicator[gTasks[taskId].tDigit]);
            StringCopy(gStringVar1, GetMoveName_(gTasks[taskId].tInput));
            StringCopyPadded(gStringVar1, gStringVar1, CHAR_SPACE, 15);

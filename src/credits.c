...
{
    switch (whichMon)//locks mon to not shiny
    {
    case CREDITSMON_CHARIZARD:
        InitWindows(sWindowTemplates_Charizard);
        FillWindowPixelBuffer(0, PIXEL_FILL(0));
        LoadMonPicInWindow(SPECIES_CHARIZARD, FALSE, 0, TRUE, 10, 0, TRUE);
    ...
    case CREDITSMON_VENUSAUR:
        ...
        FillWindowPixelBuffer(0, PIXEL_FILL(0));
        LoadMonPicInWindow(SPECIES_VENUSAUR, FALSE, 0, TRUE, 10, 0, TRUE);
    ...
    case CREDITSMON_BLASTOISE:
        ...
        FillWindowPixelBuffer(0, PIXEL_FILL(0));
        LoadMonPicInWindow(SPECIES_BLASTOISE, FALSE, 0, TRUE, 10, 0, TRUE);
    ...
    case CREDITSMON_PIKACHU:
        ...
        FillWindowPixelBuffer(0, PIXEL_FILL(0));
        LoadMonPicInWindow(SPECIES_PIKACHU, FALSE, 0, TRUE, 10, 0, TRUE);
...
static bool32 DoCreditsMonScene(void)
{
    ...
    case 7:
        ...
        else
        {
            HideBg(2);
            ShowBg(1);
            PlayCry_NormalNoDucking(GetCreditsMonSpecies(sCreditsMgr->whichMon), 0, CRY_VOLUME_RS, 10);

...
static void LoadCreditsMonPic(u8 whichMon)
{
    ...
    case CREDITSMON_CHARIZARD:
        ...
        LoadMonPicInWindow(SPECIES_CHARIZARD, 8, 0, TRUE, 10, 0, TRUE);
    ...
    case CREDITSMON_VENUSAUR:
        ...
        FillWindowPixelBuffer(0, PIXEL_FILL(0));
        LoadMonPicInWindow(SPECIES_VENUSAUR, 8, 0, TRUE, 10, 0, TRUE);
    ...
    case CREDITSMON_BLASTOISE:
        ...
        FillWindowPixelBuffer(0, PIXEL_FILL(0));
        LoadMonPicInWindow(SPECIES_BLASTOISE, 8, 0, TRUE, 10, 0, TRUE);
    ...
    case CREDITSMON_PIKACHU:
        ...
        FillWindowPixelBuffer(0, PIXEL_FILL(0));
        LoadMonPicInWindow(SPECIES_PIKACHU, 8, 0, TRUE, 10, 0, TRUE);

...
// not used
static void BtlController_EmitGetRawMonData(u32 battler, u8 bufferId, u8 monId, u8 bytes)
{
...
// not used
static void BtlController_EmitSetRawMonData(u32 battler, u8 bufferId, u8 monId, u8 bytes, void *data)
{
    s32 i;
...
void BtlController_EmitReturnMonToBall(u32 battler, u8 bufferId, u8 arg1)
{
...
// not used
static void BtlController_EmitPaletteFade(u32 battler, u8 bufferId)
{
...
// not used
static void BtlController_EmitSuccessBallThrowAnim(u32 battler, u8 bufferId)
{
...
// not used
static void BtlController_EmitPause(u32 battler, u8 bufferId, u8 toWait, void *data)
{
    s32 i;
...
void BtlController_EmitMoveAnimation(u32 battler, u8 bufferId, u16 move, u8 turnOfMove, u16 movePower, s32 dmg, u8 friendship, struct DisableStruct *disableStructPtr)
{
...
void BtlController_EmitChooseAction(u32 battler, u8 bufferId, u8 arg1, u16 arg2)
{
...
// not used
static void BtlController_EmitUnknownYesNoBox(u32 battler, u8 bufferId, u32 arg1) // TODO: Does the function name make sense for pokefirered? 
{
...
void BtlController_EmitChooseItem(u32 battler, u8 bufferId, u8 *arg1)
{
    s32 i;
...
void BtlController_EmitChoosePokemon(u32 battler, u8 bufferId, u8 caseId, u8 arg2, u16 abilityId, u8 *arg4)
{
    s32 i;
...
// not used
static void BtlController_EmitCmd23(u32 battler, u8 bufferId)
{
...
// not used
static void BtlController_EmitStatusXor(u32 battler, u8 bufferId, u8 b)
{
...
// not used
static void BtlController_EmitDMA3Transfer(u32 battler, u8 bufferId, void *dst, u16 size, void *data)
{
    s32 i;
...
// not used
static void BtlController_EmitPlayBGM(u32 battler, u8 bufferId, u16 songId, void *unusedDumbDataParameter)
{
    s32 i;
...
// not used
static void BtlController_EmitCmd32(u32 battler, u8 bufferId, u16 size, void *data)
{
    s32 i;
...
void BtlController_EmitTwoReturnValues(u32 battler, u8 bufferId, u8 arg1, u16 arg2)
{
...
void BtlController_EmitChosenMonReturnValue(u32 battler, u8 bufferId, u8 b, u8 *c)
{
    s32 i;
...
void BtlController_EmitOneReturnValue(u32 battler, u8 bufferId, u16 arg1)
{
...
void BtlController_EmitOneReturnValue_Duplicate(u32 battler, u8 bufferId, u16 b)
{
...
// not used
static void BtlController_EmitCmd37(u32 battler, u8 bufferId)
{
...
// not used
static void BtlController_EmitCmd38(u32 battler, u8 bufferId, u8 b)
{
...
// not used
static void BtlController_EmitCmd39(u32 battler, u8 bufferId)
{
...
// not used
static void BtlController_EmitCmd40(u32 battler, u8 bufferId)
{
...
void BtlController_EmitCmd42(u32 battler, u8 bufferId)
{
...
void BtlController_EmitPlayFanfare(u32 battler, u8 bufferId, u16 songId)
{
...
void BtlController_EmitDrawPartyStatusSummary(u32 battler, u8 bufferId, struct HpAndStatus* hpAndStatus, u8 param)
{
    s32 i;
...
void BtlController_EmitLinkStandbyMsg(u32 battler, u8 bufferId, u8 arg1)
{
...
void BtlController_EmitDebugMenu(u32 battler, u8 bufferId)
{
    sBattleBuffersTransferData[0] = CONTROLLER_DEBUGMENU;
    PrepareBufferDataTransfer(battler, bufferId, sBattleBuffersTransferData, 1);
}

void BtlController_EmitMoveInfo(u32 battler, u8 bufferId)
{
    sBattleBuffersTransferData[0] = CONTROLLER_MOVEINFO;
    PrepareBufferDataTransfer(battler, bufferId, sBattleBuffersTransferData, 1);
}
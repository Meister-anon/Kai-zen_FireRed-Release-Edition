...
EWRAM_DATA bool8 gHelpSystemToggleWithRButtonDisabled = FALSE; //vsonic can prob remove these
...
s32 HelpSystem_GetMenuInput(void)
{
    ...
    {
        PlaySE(SE_SELECT);
        return 0;//gHelpSystemListMenu.sub.items[gHelpSystemListMenu.itemsAbove + gHelpSystemListMenu.cursorPos].index;
    }

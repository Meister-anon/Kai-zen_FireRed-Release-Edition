...
#define DUMMY_TOWER_TEAM(iv) {.name = _(""), .gender = 1, .speechBefore = {0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF}, .speechWin = {0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF}, .speechLose = {0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF}, .speechAfter = {0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF}, .mons = {DUMMY_TOWER_MON(iv), DUMMY_TOWER_MON(iv), DUMMY_TOWER_MON(iv), DUMMY_TOWER_MON(iv), DUMMY_TOWER_MON(iv), DUMMY_TOWER_MON(iv)}}

//values identical to data/trainer_tower/trainers.inc  so think can remove that along with data_8479668.s
static const struct TrainerTowerFloor sTrainerTowerFloor_Single_4 = {
	...
	.trainers = {
	    {
			.name = _("COLE"),
			.facilityClass = FACILITY_CLASS_RS_YOUNGSTER,
			.gender = 1,
...
static const struct TrainerTowerFloor sTrainerTowerFloor_Double_6 = {
	...
	.trainers = {
	    {
			.name = _("EMY & ALEK"),
			.facilityClass = FACILITY_CLASS_RS_YOUNG_COUPLE,
			.gender = 1,
...
static const struct TrainerTowerFloor sTrainerTowerFloor_Knockout_2 = {
	...
	.trainers = {
	    {
			.name = _("MIKE"),
			.facilityClass = FACILITY_CLASS_RS_HIKER,
			.gender = 5,
		...
		{
			.name = _("NICOLAS"),
			.facilityClass = FACILITY_CLASS_RS_BLACK_BELT,
			.gender = 5,
...
static const struct TrainerTowerFloor sTrainerTowerFloor_Single_5 = {
	...
	.trainers = {
	    {
			.name = _("JOEY"),
			.facilityClass = FACILITY_CLASS_RS_CAMPER,
			.gender = 1,
...
static const struct TrainerTowerFloor sTrainerTowerFloor_Single_8 = {
	...
	.trainers = {
	    {
			.name = _("LILY"),
			.facilityClass = FACILITY_CLASS_RS_PKMN_BREEDER_M,
			.gender = 1,
...
static const struct TrainerTowerFloor sTrainerTowerFloor_Single_2 = {
	...
	.trainers = {
	    {
			.name = _("BRANDON"),
			.facilityClass = FACILITY_CLASS_RS_BUG_CATCHER,
			.gender = 1,
...
static const struct TrainerTowerFloor sTrainerTowerFloor_Double_1 = {
	...
	.trainers = {
	    {
			.name = _("JEN & KIRA"),
			.facilityClass = FACILITY_CLASS_RS_TWINS,
			.gender = 5,
...
static const struct TrainerTowerFloor sTrainerTowerFloor_Knockout_3 = {
	...
	.trainers = {
	    {
			.name = _("CAMRYN"),
			.facilityClass = FACILITY_CLASS_RS_PICNICKER,
			.gender = 1,
...
static const struct TrainerTowerFloor sTrainerTowerFloor_Single_1 = {
	...
	.trainers = {
	    {
			.name = _("ALBERTO"),
			.facilityClass = FACILITY_CLASS_RS_SAILOR,
			.gender = 5,
...
static const struct TrainerTowerFloor sTrainerTowerFloor_Mixed_5 = {
	...
	.trainers = {
	    {
			.name = _("KAT & KIPP"),
			.facilityClass = FACILITY_CLASS_RS_SIS_AND_BRO,
			.gender = 4,
...
static const struct TrainerTowerFloor sTrainerTowerFloor_Knockout_7 = {
	...
	.trainers = {
	    {
			.name = _("PRISCILLA"),
			.facilityClass = FACILITY_CLASS_RS_TUBER_F,
			.gender = 1,
		...
		{
			.name = _("CHARLOTTE"),
			.facilityClass = FACILITY_CLASS_RS_LADY,
			.gender = 1,
...
static const struct TrainerTowerFloor sTrainerTowerFloor_Knockout_4 = {
	...
	.trainers = {
		...
		{
			.name = _("KADEN"),
			.facilityClass = FACILITY_CLASS_RS_FISHERMAN,
			.gender = 1,
		...
		{
			.name = _("EMANUEL"),
			.facilityClass = FACILITY_CLASS_RS_GENTLEMAN,
			.gender = 1,
...
static const struct TrainerTowerFloor sTrainerTowerFloor_Knockout_5 = {
	...
	.trainers = {
		{
			.name = _("MAURA"),
			.facilityClass = FACILITY_CLASS_RS_BEAUTY,
			.gender = 2,
		...
		{
			.name = _("MIKAELA"),
			.facilityClass = FACILITY_CLASS_RS_LASS,
			.gender = 1,

...
static const VsSeekerData sVsSeekerData[] = {
   ...
   { {TRAINER_ENGINEER_BERNIE, 0xFFFF, 0xFFFF, TRAINER_ENGINEER_BERNIE_2},
      MAP_GROUP(ROUTE11), MAP_NUM(ROUTE11) },
   { {TRAINER_GAMBLER_HUGO, TRAINER_GAMBLER_HUGO},
      MAP_GROUP(ROUTE11), MAP_NUM(ROUTE11) },
   { {TRAINER_GAMBLER_JASPER, TRAINER_GAMBLER_JASPER},
      MAP_GROUP(ROUTE11), MAP_NUM(ROUTE11) },
   { {TRAINER_GAMBLER_DIRK, TRAINER_GAMBLER_DIRK},
      MAP_GROUP(ROUTE11), MAP_NUM(ROUTE11) },
   { {TRAINER_GAMBLER_DARIAN, 0xFFFF, 0xFFFF, TRAINER_GAMBLER_DARIAN_2},
      MAP_GROUP(ROUTE11), MAP_NUM(ROUTE11) },
   ...
   { {TRAINER_SUPER_NERD_LESLIE, TRAINER_SUPER_NERD_LESLIE},
      MAP_GROUP(ROUTE8), MAP_NUM(ROUTE8) },
   { {TRAINER_GAMBLER_STAN, TRAINER_GAMBLER_STAN},
      MAP_GROUP(ROUTE8), MAP_NUM(ROUTE8) },
   { {TRAINER_GAMBLER_RICH, 0xFFFF, 0xFFFF, TRAINER_GAMBLER_RICH_2},
      MAP_GROUP(ROUTE8), MAP_NUM(ROUTE8) },
...
static void ResetMovementOfRematchableTrainers(void)
{
    ...
    for (i = 0; i < OBJECT_EVENTS_COUNT; i++)
    {
        ...
        if (objectEvent->movementType == MOVEMENT_TYPE_RAISE_HAND_AND_STOP || objectEvent->movementType == MOVEMENT_TYPE_RAISE_HAND_AND_JUMP || objectEvent->movementType == MOVEMENT_TYPE_RAISE_HAND_AND_SWIM)
        {

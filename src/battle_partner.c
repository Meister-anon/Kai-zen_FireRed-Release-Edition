...
const struct Trainer gBattlePartners[PARTNER_COUNT] = {0};
/*{
...
//not ready to use as most of trainermon values
//not added unsure if plan to
//involves major party data overhaul

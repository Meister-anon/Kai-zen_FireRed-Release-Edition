...
static const void *const sItemIconGfxPtrs[][2] = {
    ...
    [ITEM_ALOLAN_SAND] = {gItemIcon_SeaIncense, gItemIconPalette_SpelonBerry},
    [ITEM_GALAR_SAND] = {gItemIcon_SeaIncense, gItemIconPalette_SeaIncense},
    [ITEM_HISUIAN_SAND] = {gItemIcon_SeaIncense, gItemIconPalette_LeafStone},
    [ITEM_PALDEAN_SAND] = {gItemIcon_SeaIncense, gItemIconPalette_SeaIncense},

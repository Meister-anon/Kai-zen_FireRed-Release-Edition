...
static const u8 sText_Infested[] = _("{B_ATK_NAME_WITH_PREFIX} is infested!"); //think not using
...
static const u8 sText_PkmnsWillPerishIn3Turns[] = _("{B_ATK_NAME_WITH_PREFIX} will perish\nin three turns!"); //used in persish body but plan rework so user doesnt faint
...
static const u8 sText_TargetTooHeavy[] = _("But the target was too heavy!");  //for seismic toss fail, Sky drop fail
...
//default values - Non static used in other files
...
//extra stuff new - NEEDED for text buffs
...
const u8 *const gBattleStringsTable[] = {
    ...
    [STRINGID_TRYTOLEARNMOVE1]               = COMPOUND_STRING("{B_BUFF1} is trying to\nlearn {B_BUFF2}.\p"),
    [STRINGID_TRYTOLEARNMOVE2]               = COMPOUND_STRING("But, {B_BUFF1} can't learn\nmore than four moves.\p"),
    [STRINGID_TRYTOLEARNMOVE3]               = COMPOUND_STRING("Delete a move to make\nroom for {B_BUFF2}?"),
    [STRINGID_PKMNFORGOTMOVE]                = COMPOUND_STRING("{B_BUFF1} forgot\n{B_BUFF2}.\p"),
    [STRINGID_STOPLEARNINGMOVE]              = COMPOUND_STRING("{PAUSE 32}Stop learning\n{B_BUFF2}?"),
    [STRINGID_DIDNOTLEARNMOVE]               = COMPOUND_STRING("{B_BUFF1} did not learn\n{B_BUFF2}.\p"),
    [STRINGID_PKMNLEARNEDMOVE2]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} learned\n{B_BUFF1}!"),
    [STRINGID_ATTACKMISSED]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s\nattack missed!"),
    [STRINGID_PKMNPROTECTEDITSELF]           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}\nprotected itself!"),
    [STRINGID_STATSWONTINCREASE2]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s stats won't\ngo any higher!"),
    [STRINGID_AVOIDEDDAMAGE]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} avoided\ndamage with {B_DEF_ABILITY}!"),
    [STRINGID_ITDOESNTAFFECT]                = COMPOUND_STRING("It doesn't affect\n{B_DEF_NAME_WITH_PREFIX}…"),
    [STRINGID_ATTACKERFAINTED]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\nfainted!\p"),
    [STRINGID_TARGETFAINTED]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}\nfainted!\p"),
    ...
    [STRINGID_PLAYERWHITEOUT2]               = COMPOUND_STRING("{B_PLAYER_NAME} panicked and lost ¥{B_BUFF1}…\p… … … …\p{B_PLAYER_NAME} whited out!{PAUSE_UNTIL_PRESS}"),
    [STRINGID_PREVENTSESCAPE]                = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} prevents\nescape with {B_SCR_ACTIVE_ABILITY}!\p"),
    [STRINGID_HITXTIMES]                     = COMPOUND_STRING("Hit {B_BUFF1} time(s)!"),
    [STRINGID_PKMNFROSTBITTEN]               = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} got frostbite!"),
    [STRINGID_PKMNFELLASLEEP]                = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}\nfell asleep!"),
    [STRINGID_PKMNMADESLEEP]                 = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nmade {B_EFF_NAME_WITH_PREFIX} sleep!"),
    [STRINGID_PKMNALREADYASLEEP]             = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is\nalready asleep!"),
    [STRINGID_PKMNALREADYASLEEP2]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is\nalready asleep!"),
    ...
    [STRINGID_PKMNPOISONEDBY]                = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\npoisoned {B_EFF_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNHURTBYPOISON]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt\nby poison!"),
    [STRINGID_PKMNALREADYPOISONED]           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is already\npoisoned."),
    [STRINGID_PKMNBADLYPOISONED]             = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} is badly\npoisoned!"),
    [STRINGID_PKMNENERGYDRAINED]             = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} had its\nenergy drained!"),
    [STRINGID_PKMNWASBURNED]                 = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} was burned!"),
    [STRINGID_PKMNBURNEDBY]                  = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nburned {B_EFF_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNHURTBYBURN]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt\nby its burn!"),
    [STRINGID_PKMNHURTBYFREEZE]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt\nby the cold!"),
    [STRINGID_PKMNWASFROZEN]                 = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} was\nfrozen!"),
    [STRINGID_PKMNFROZENBY]                  = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nfroze {B_EFF_NAME_WITH_PREFIX} solid!"),
    [STRINGID_PKMNISFROZEN]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is\nfrozen solid!"),
    [STRINGID_PKMNWASDEFROSTED]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was\ndefrosted!"),
    [STRINGID_PKMNWASDEFROSTED2]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} was\ndefrosted!"),
    [STRINGID_PKMNWASDEFROSTEDBY]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} was\ndefrosted by {B_CURRENT_MOVE}!"),
    [STRINGID_PKMNWASPARALYZED]              = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} is paralyzed!\nIt may be unable to move!"),
    [STRINGID_PKMNWASPARALYZEDBY]            = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nparalyzed {B_EFF_NAME_WITH_PREFIX}!\lIt may be unable to move!"),
    [STRINGID_PKMNISPARALYZED]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is paralyzed!\nIt can't move!"),
    [STRINGID_PKMNISALREADYPARALYZED]        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is\nalready paralyzed!"),
    [STRINGID_PKMNHEALEDPARALYSIS]           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was\nhealed of paralysis!"),
    [STRINGID_PKMNDREAMEATEN]                = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s\ndream was eaten!"),
    [STRINGID_STATSWONTINCREASE]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1}\nwon't go higher!"),
    [STRINGID_STATSWONTDECREASE]             = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}\nwon't go lower!"),
    [STRINGID_TEAMSTOPPEDWORKING]            = COMPOUND_STRING("Your team's {B_BUFF1}\nstopped working!"),
    [STRINGID_FOESTOPPEDWORKING]             = COMPOUND_STRING("The foe's {B_BUFF1}\nstopped working!"),
    [STRINGID_PKMNISCONFUSED]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is\nconfused!"),
    [STRINGID_PKMNHEALEDCONFUSION]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} snapped\nout of confusion!"),
    [STRINGID_PKMNWASCONFUSED]               = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} became\nconfused!"),
    [STRINGID_PKMNALREADYCONFUSED]           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is\nalready confused!"),
    [STRINGID_PKMNFELLINLOVE]                = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}\nfell in love!"),
    [STRINGID_PKMNINLOVEWITHBATTLER]         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is in love\nwith {B_SCR_ACTIVE_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNINLOVE]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is in love!"),
    [STRINGID_PKMNIMMOBILIZEDBYLOVE]         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is\nimmobilized by love!"),
    [STRINGID_PKMNBLOWNAWAY]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was\nblown away!"),
    [STRINGID_PKMNCHANGEDTYPE]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} transformed\ninto the {B_BUFF1} type!"),
    [STRINGID_PKMNFLINCHED]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} flinched!"),
    [STRINGID_PKMNREGAINEDHEALTH]            = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} regained\nhealth!"),
    [STRINGID_PKMNHPFULL]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s\nHP is full!"),
    [STRINGID_PKMNRAISEDSPDEF]               = COMPOUND_STRING("{B_ATK_PREFIX2}'s {B_CURRENT_MOVE}\nraised SP. DEF!"),
    [STRINGID_PKMNRAISEDDEF]                 = COMPOUND_STRING("{B_ATK_PREFIX2}'s {B_CURRENT_MOVE}\nraised DEFENSE!"),
    [STRINGID_PKMNCOVEREDBYVEIL]             = COMPOUND_STRING("{B_ATK_PREFIX2}'s party is covered\nby a veil!"),
    [STRINGID_PKMNUSEDSAFEGUARD]             = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s party is protected\nby SAFEGUARD!"),
    [STRINGID_PKMNSAFEGUARDEXPIRED]          = COMPOUND_STRING("{B_ATK_PREFIX3}'s party is no longer\nprotected by SAFEGUARD!"),
    [STRINGID_PKMNWENTTOSLEEP]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} went\nto sleep!"),
    [STRINGID_PKMNSLEPTHEALTHY]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} slept and\nbecame healthy!"),
    [STRINGID_PKMNWHIPPEDWHIRLWIND]          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} whipped\nup a whirlwind!"),
    [STRINGID_PKMNTOOKSUNLIGHT]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} took\nin sunlight!"),
    [STRINGID_PKMNLOWEREDHEAD]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} lowered\nits head!"),
    [STRINGID_PKMNISGLOWING]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is glowing!"),
    [STRINGID_PKMNFLEWHIGH]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} flew\nup high!"),
    [STRINGID_PKMNDUGHOLE]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} dug a hole!"),
    [STRINGID_PKMNSQUEEZEDBYBIND]            = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was squeezed by\n{B_ATK_NAME_WITH_PREFIX}'s BIND!"),
    [STRINGID_PKMNTRAPPEDINVORTEX]           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was trapped\nin the vortex!"),
    [STRINGID_PKMNWRAPPEDBY]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was WRAPPED by\n{B_ATK_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNCLAMPED]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} CLAMPED\n{B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNHURTBY]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt\nby {B_BUFF1}!"),
    [STRINGID_PKMNFREEDFROM]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} was freed\nfrom {B_BUFF1}!"),
    [STRINGID_PKMNCRASHED]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} kept going\nand crashed!"),
    [STRINGID_PKMNSHROUDEDINMIST]            = COMPOUND_STRING("{B_ATK_PREFIX2} became\nshrouded in MIST!"),
    [STRINGID_PKMNPROTECTEDBYMIST]           = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is protected\nby MIST!"),
    [STRINGID_PKMNGETTINGPUMPED]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is getting\npumped!"),
    [STRINGID_PKMNHITWITHRECOIL]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hit\nwith recoil!"),
    [STRINGID_PKMNPROTECTEDITSELF2]          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} protected\nitself!"),
    [STRINGID_PKMNBUFFETEDBYSANDSTORM]       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is buffeted\nby the sandstorm!"),
    [STRINGID_PKMNPELTEDBYHAIL]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is pelted\nby HAIL!"),
    [STRINGID_PKMNSEEDED]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was seeded!"),
    [STRINGID_PKMNEVADEDATTACK]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} evaded\nthe attack!"),
    [STRINGID_PKMNSAPPEDBYLEECHSEED]         = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s health is\nsapped by LEECH SEED!"),
    [STRINGID_PKMNFASTASLEEP]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is fast\nasleep."),
    [STRINGID_PKMNWOKEUP]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} woke up!"),
    [STRINGID_PKMNUPROARKEPTAWAKE]           = COMPOUND_STRING("But {B_SCR_ACTIVE_NAME_WITH_PREFIX}'s UPROAR\nkept it awake!"),
    [STRINGID_PKMNWOKEUPINUPROAR]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} woke up\nin the UPROAR!"),
    [STRINGID_PKMNWOKEUPREFRESHED]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} woke up\nrefreshed!"),
    [STRINGID_PKMNCAUSEDUPROAR]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} caused\nan UPROAR!"),
    [STRINGID_PKMNMAKINGUPROAR]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is making\nan UPROAR!"),
    [STRINGID_PKMNCALMEDDOWN]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} calmed down."),
    [STRINGID_PKMNCANTSLEEPINUPROAR]         = COMPOUND_STRING("But {B_DEF_NAME_WITH_PREFIX} can't\nsleep in an UPROAR!"),
    [STRINGID_PKMNSTOCKPILED]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} STOCKPILED\n{B_BUFF1}!"),
    [STRINGID_PKMNCANTSTOCKPILE]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} can't\nSTOCKPILE any more!"),
    [STRINGID_PKMNCANTSLEEPINUPROAR2]        = COMPOUND_STRING("But {B_DEF_NAME_WITH_PREFIX} can't\nsleep in an UPROAR!"),
    ...
    [STRINGID_PKMNSTORINGENERGY]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is storing\nenergy!"),
    [STRINGID_PKMNUNLEASHEDENERGY]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} unleashed\nenergy!"),
    [STRINGID_PKMNFATIGUECONFUSION]          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} became\nconfused due to fatigue!"),
    [STRINGID_PKMNPICKEDUPITEM]              = COMPOUND_STRING("{B_PLAYER_NAME} picked up\n¥{B_BUFF1}!\p"),
    [STRINGID_PKMNUNAFFECTED]                = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is\nunaffected!"),
    [STRINGID_PKMNTRANSFORMEDINTO]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} transformed\ninto {B_BUFF1}!"),
    [STRINGID_PKMNMADESUBSTITUTE]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} made\na SUBSTITUTE!"),
    [STRINGID_PKMNHASSUBSTITUTE]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} already\nhas a SUBSTITUTE!"),
    [STRINGID_SUBSTITUTEDAMAGED]             = COMPOUND_STRING("The SUBSTITUTE took damage\nfor {B_DEF_NAME_WITH_PREFIX}!\p"),
    [STRINGID_PKMNSUBSTITUTEFADED]           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s\nSUBSTITUTE faded!\p"),
    [STRINGID_PKMNMUSTRECHARGE]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} must\nrecharge!"),
    [STRINGID_PKMNRAGEBUILDING]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s RAGE\nis building!"),
    [STRINGID_PKMNMOVEWASDISABLED]           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}\nwas disabled!"),
    [STRINGID_PKMNMOVEISDISABLED]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_CURRENT_MOVE}\nis disabled!\p"),
    [STRINGID_PKMNMOVEDISABLEDNOMORE]        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is disabled\nno more!"),
    [STRINGID_PKMNGOTENCORE]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} got\nan ENCORE!"),
    [STRINGID_PKMNENCOREENDED]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s ENCORE\nended!"),
    [STRINGID_PKMNTOOKAIM]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} took aim\nat {B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNSKETCHEDMOVE]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} SKETCHED\n{B_BUFF1}!"),
    [STRINGID_PKMNTRYINGTOTAKEFOE]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is trying\nto take its foe with it!"),
    [STRINGID_PKMNTOOKFOE]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} took\n{B_ATK_NAME_WITH_PREFIX} with it!"),
    [STRINGID_PKMNREDUCEDPP]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}{B_BUFF3}\n{B_BUFF1} was reduced by {B_BUFF2}!"),
    [STRINGID_PKMNSTOLEITEM]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} stole\n{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}!"),
    [STRINGID_TARGETCANTESCAPENOW]           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} can't\nescape now!"),
    [STRINGID_PKMNFELLINTONIGHTMARE]         = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} fell into\na NIGHTMARE!"),
    [STRINGID_PKMNLOCKEDINNIGHTMARE]         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is locked\nin a NIGHTMARE!"),
    [STRINGID_PKMNLAIDCURSE]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} cut its own HP and\nlaid a CURSE on {B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNAFFLICTEDBYCURSE]          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is afflicted\nby the CURSE!"),
    [STRINGID_SPIKESSCATTERED]               = COMPOUND_STRING("SPIKES were scattered all around\nthe opponent's side!"),
    [STRINGID_PKMNHURTBYSPIKES]              = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is hurt\nby SPIKES!"),
    [STRINGID_PKMNIDENTIFIED]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} identified\n{B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNPERISHCOUNTFELL]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s PERISH count\nfell to {B_BUFF1}!"),
    [STRINGID_PKMNBRACEDITSELF]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} braced\nitself!"),
    [STRINGID_PKMNENDUREDHIT]                = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} ENDURED\nthe hit!"),
    [STRINGID_MAGNITUDESTRENGTH]             = COMPOUND_STRING("MAGNITUDE {B_BUFF1}!"),
    [STRINGID_PKMNCUTHPMAXEDATTACK]          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} cut its own HP\nand maximized ATTACK!"),
    [STRINGID_PKMNCOPIEDSTATCHANGES]         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} copied\n{B_DEF_NAME_WITH_PREFIX}'s stat changes!"),
    [STRINGID_PKMNGOTFREE]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} got free of\nall traps!"),
    [STRINGID_PKMNSHEDLEECHSEED]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} shed\nLEECH SEED!"),
    [STRINGID_PKMNBLEWAWAYSPIKES]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} blew away\nSPIKES!"),
    [STRINGID_PKMNFLEDFROMBATTLE]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} fled from\nbattle!"),
    [STRINGID_PKMNFORESAWATTACK]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} foresaw\nan attack!"),
    [STRINGID_PKMNTOOKATTACK]                = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} took the\n{B_BUFF1} attack!"),
    [STRINGID_PKMNATTACK]                    = COMPOUND_STRING("{B_BUFF1}'s attack!"),
    [STRINGID_PKMNCENTERATTENTION]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} became the\ncenter of attention!"),
    [STRINGID_PKMNCHARGINGPOWER]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} began\ncharging power!"),
    [STRINGID_NATUREPOWERTURNEDINTO]         = COMPOUND_STRING("NATURE POWER turned into\n{B_CURRENT_MOVE}!"),
    [STRINGID_PKMNSTATUSNORMAL]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s status\nreturned to normal!"),
    [STRINGID_PKMNHASNOMOVESLEFT]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} has no\nmoves left!\p"),
    [STRINGID_PKMNSUBJECTEDTOTORMENT]        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was subjected\nto TORMENT!"),
    [STRINGID_PKMNCANTUSEMOVETORMENT]        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} can't use the same\nmove in a row due to the TORMENT!\p"),
    [STRINGID_PKMNTIGHTENINGFOCUS]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is tightening\nits focus!"),
    [STRINGID_PKMNFELLFORTAUNT]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} fell for\nthe TAUNT!"),
    [STRINGID_PKMNCANTUSEMOVETAUNT]          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} can't use\n{B_CURRENT_MOVE} after the TAUNT!\p"),
    [STRINGID_PKMNREADYTOHELP]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is ready to\nhelp {B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNSWITCHEDITEMS]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} switched\nitems with its opponent!"),
    [STRINGID_PKMNCOPIEDFOE]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} copied\n{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}!"),
    ...
    [STRINGID_PKMNABSORBEDNUTRIENTS]         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} absorbed\nnutrients with its roots!"),
    [STRINGID_PKMNANCHOREDITSELF]            = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} anchored\nitself with its roots!"),
    [STRINGID_PKMNWASMADEDROWSY]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} made\n{B_DEF_NAME_WITH_PREFIX} drowsy!"),
    [STRINGID_PKMNKNOCKEDOFF]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} knocked off\n{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}!"),
    [STRINGID_PKMNSWAPPEDABILITIES]          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} swapped abilities\nwith its opponent!"),
    [STRINGID_PKMNSEALEDOPPONENTMOVE]        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} sealed the\nopponent's moveシsス!"),
    [STRINGID_PKMNCANTUSEMOVESEALED]         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} can't use the\nsealed {B_CURRENT_MOVE}!\p"),
    [STRINGID_PKMNWANTSGRUDGE]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} wants the\nopponent to bear a GRUDGE!"),
    [STRINGID_PKMNLOSTPPGRUDGE]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} lost\nPP due to the GRUDGE!"),
    [STRINGID_PKMNSHROUDEDITSELF]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} shrouded\nitself in {B_CURRENT_MOVE}!"),
    [STRINGID_PKMNMOVEBOUNCED]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_CURRENT_MOVE}\nwas bounced back by MAGIC COAT!"),
    [STRINGID_PKMNWAITSFORTARGET]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} waits for its foe\nto make a move!"),
    [STRINGID_PKMNSNATCHEDMOVE]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} SNATCHED\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s move!"),
    [STRINGID_PKMNMADEITRAIN]                = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nmade it rain!"),
    [STRINGID_PKMNRAISEDSPEED]               = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nraised its SPEED!"),
    [STRINGID_PKMNPROTECTEDBY]               = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was protected\nby {B_DEF_ABILITY}!"),
    [STRINGID_PKMNPREVENTSUSAGE]             = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nprevents {B_ATK_NAME_WITH_PREFIX}\lfrom using {B_CURRENT_MOVE}!"),
    [STRINGID_PKMNRESTOREDHPUSING]           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} restored HP\nusing its {B_DEF_ABILITY}!"),
    [STRINGID_PKMNCHANGEDTYPEWITH]           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nmade it the {B_BUFF1} type!"),
    [STRINGID_PKMNPREVENTSPARALYSISWITH]     = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nprevents paralysis!"),
    [STRINGID_PKMNIGNOREDADVANCESWITH]       = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s remained\n{B_DEF_ABILITY}!"),
    [STRINGID_PKMNPREVENTSPOISONINGWITH]     = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nprevents poisoning!"),
    [STRINGID_PKMNPREVENTSCONFUSIONWITH]     = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nprevents confusion!"),
    [STRINGID_PKMNRAISEDFIREPOWERWITH]       = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nraised its FIRE power!"),
    [STRINGID_PKMNANCHORSITSELFWITH]         = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} anchors\nitself with {B_DEF_ABILITY}!"),
    [STRINGID_PKMNCUTSATTACKWITH]            = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\ncuts {B_DEF_NAME_WITH_PREFIX}'s ATTACK!"), 
    [STRINGID_DARKTYPE_INTIMIDATE_RESIST]    = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nhas no affect on Dark Types!"),
    [STRINGID_PKMNPREVENTSSTATLOSSWITH]      = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nprevents stat loss!"),
    [STRINGID_PKMNHURTSWITHABILITY]          = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nhurt {B_ATK_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNTRACED]                    = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} TRACED\n{B_BUFF1}'s {B_BUFF2}!"),
    ...
    [STRINGID_ATTACKERSSTATROSE]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1}\n{B_BUFF2}"),
    [STRINGID_DEFENDERSSTATROSE]             = COMPOUND_STRING(("{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}\n{B_BUFF2}")),
    [STRINGID_ATTACKERSSTATFELL]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1}\n{B_BUFF2}"),
    [STRINGID_DEFENDERSSTATFELL]             = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}\n{B_BUFF2}"),
    [STRINGID_CRITICALHIT]                   = COMPOUND_STRING("A critical hit!"),
    [STRINGID_ONEHITKO]                      = COMPOUND_STRING("It's a one-hit KO!"),
    [STRINGID_123POOF]                       = COMPOUND_STRING("{PAUSE 32}1, {PAUSE 15}2, and{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}Poof!\p"),
    ...
    [STRINGID_WILDPKMNFLED]                  = COMPOUND_STRING("{PLAY_SE SE_FLEE}Wild {B_BUFF1} fled!"),
    [STRINGID_NORUNNINGFROMTRAINERS]         = COMPOUND_STRING("No! There's no running\nfrom a TRAINER battle!\p"),
    [STRINGID_CANTESCAPE]                    = COMPOUND_STRING("Can't escape!\p"),
    [STRINGID_DONTLEAVEBIRCH]                = COMPOUND_STRING(""),
    [STRINGID_BUTNOTHINGHAPPENED]            = COMPOUND_STRING("…\nBut nothing happened!"),
    [STRINGID_BUTITFAILED]                   = COMPOUND_STRING("But it failed!"),
    [STRINGID_ITHURTCONFUSION]               = COMPOUND_STRING("It hurt itself in its\nconfusion!"),
    ...
    [STRINGID_DOWNPOURSTARTED]               = COMPOUND_STRING("A downpour started!"),
    [STRINGID_RAINCONTINUES]                 = COMPOUND_STRING("Rain continues to fall."),
    [STRINGID_DOWNPOURCONTINUES]             = COMPOUND_STRING("The downpour continues."),
    [STRINGID_RAINSTOPPED]                   = COMPOUND_STRING("The rain stopped."),
    [STRINGID_SANDSTORMBREWED]               = COMPOUND_STRING("A sandstorm brewed!"),
    [STRINGID_SANDSTORMRAGES]                = COMPOUND_STRING("The sandstorm rages."),
    ...
    [STRINGID_SUNLIGHTSTRONG]                = COMPOUND_STRING("The sunlight is strong."),
    [STRINGID_SUNLIGHTFADED]                 = COMPOUND_STRING("The sunlight faded."),
    [STRINGID_STARTEDHAIL]                   = COMPOUND_STRING("It started to hail!"),
    [STRINGID_HAILCONTINUES]                 = COMPOUND_STRING("Hail continues to fall."),
    [STRINGID_HAILSTOPPED]                   = COMPOUND_STRING("The hail stopped."),
    [STRINGID_FAILEDTOSPITUP]                = COMPOUND_STRING("But it failed to SPIT UP\na thing!"),
    [STRINGID_FAILEDTOSWALLOW]               = COMPOUND_STRING("But it failed to SWALLOW\na thing!"),
    [STRINGID_WINDBECAMEHEATWAVE]            = COMPOUND_STRING("The wind turned into a\nHEAT WAVE!"),
    [STRINGID_STATCHANGESGONE]               = COMPOUND_STRING("All stat changes were\neliminated!"),
    [STRINGID_COINSSCATTERED]                = COMPOUND_STRING("Coins scattered everywhere!"),
    ...
    [STRINGID_FAINTINTHREE]                  = COMPOUND_STRING("All affected POKéMON will\nfaint in three turns!"),
    [STRINGID_NOPPLEFT]                      = COMPOUND_STRING("There's no PP left for\nthis move!\p"),
    [STRINGID_BUTNOPPLEFT]                   = COMPOUND_STRING("But there was no PP left\nfor the move!"),
    [STRINGID_PLAYERUSEDITEM]                = COMPOUND_STRING("{B_PLAYER_NAME} used\n{B_LAST_ITEM}!"),
    ...
    [STRINGID_ITDODGEDBALL]                  = COMPOUND_STRING("It dodged the thrown BALL!\nThis POKéMON can't be caught!{PAUSE 10}"),
    [STRINGID_YOUMISSEDPKMN]                 = COMPOUND_STRING("You missed!\nThe POKéMON dodged the thrown BALL!{PAUSE 10}"),
    ...
    [STRINGID_GOTCHAPKMNCAUGHT]              = COMPOUND_STRING("Gotcha!\n{B_DEF_NAME} was caught!{WAIT_SE}{PLAY_BGM MUS_CAUGHT}\p"),
    [STRINGID_GOTCHAPKMNCAUGHT2]             = COMPOUND_STRING("Gotcha!\n{B_DEF_NAME} was caught!{WAIT_SE}{PLAY_BGM MUS_CAUGHT}{PAUSE 127}"),
    ...
    [STRINGID_SANDSTORMISRAGING]             = COMPOUND_STRING("A sandstorm is raging."),
    [STRINGID_CANTESCAPE2]                   = COMPOUND_STRING("Can't escape!\p"),
    [STRINGID_PKMNIGNORESASLEEP]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} ignored\norders while asleep!"),
    [STRINGID_PKMNIGNOREDORDERS]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} ignored\norders!"),
    [STRINGID_PKMNBEGANTONAP]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} began to nap!"),
    [STRINGID_PKMNLOAFING]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is\nloafing around!"),
    [STRINGID_PKMNWONTOBEY]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} won't\nobey!"),
    [STRINGID_PKMNTURNEDAWAY]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} turned away!"),
    [STRINGID_PKMNPRETENDNOTNOTICE]          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} pretended\nnot to notice!"),
    [STRINGID_ENEMYABOUTTOSWITCHPKMN]        = COMPOUND_STRING("{B_TRAINER1_CLASS} {B_TRAINER1_NAME} is\nabout to send out\ltheir next POKéMON.\pWill {B_PLAYER_NAME} change\nPOKéMON?"),
    ...
    [STRINGID_DUMMY288]                      = COMPOUND_STRING(""),
    [STRINGID_DUMMY289]                      = COMPOUND_STRING(""),
    [STRINGID_OUTOFSAFARIBALLS]              = COMPOUND_STRING("{PLAY_SE SE_DING_DONG}ANNOUNCER: You're out of\nSAFARI BALLS! Game over!\p"),
    [STRINGID_PKMNSITEMCUREDPARALYSIS]       = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\ncured paralysis!"),
    [STRINGID_PKMNSITEMCUREDPOISON]          = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\ncured poison!"),
    [STRINGID_PKMNSITEMHEALEDBURN]           = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nhealed its burn!"),
    [STRINGID_PKMNSITEMDEFROSTEDIT]          = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\ndefrosted it!"),
    [STRINGID_PKMNSITEMWOKEIT]               = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nwoke it from its sleep!"),
    [STRINGID_PKMNSITEMSNAPPEDOUT]           = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nsnapped it out of confusion!"),
    [STRINGID_PKMNSITEMCUREDPROBLEM]         = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\ncured its {B_BUFF1} problem!"),
    [STRINGID_PKMNSITEMRESTOREDHEALTH]       = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nrestored health!"),
    [STRINGID_PKMNSITEMRESTOREDPP]           = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nrestored {B_BUFF1}'s PP!"),
    [STRINGID_PKMNSITEMRESTOREDSTATUS]       = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nrestored its status!"),
    [STRINGID_PKMNSITEMRESTOREDHPALITTLE]    = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nrestored its HP a little!"),
    [STRINGID_ITEMALLOWSONLYYMOVE]           = COMPOUND_STRING("{B_LAST_ITEM}'s effect allows only\n{B_CURRENT_MOVE} to be used!\p"),
    [STRINGID_PKMNHUNGONWITHX]               = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} hung on\nusing its {B_LAST_ITEM}!"),
    [STRINGID_EMPTYSTRING3]                  = COMPOUND_STRING(""),
    [STRINGID_PKMNSXPREVENTSBURNS]           = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}'s {B_EFF_ABILITY}\nprevents burns!"),
    [STRINGID_PKMNSXBLOCKSY]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nblocks {B_CURRENT_MOVE}!"),
    [STRINGID_PKMNSXRESTOREDHPALITTLE2]      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\nrestored its HP a little!"),
    [STRINGID_PKMNSXWHIPPEDUPSANDSTORM]      = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nwhipped up a sandstorm!"),
    [STRINGID_PKMNSXPREVENTSYLOSS]           = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nprevents {B_BUFF1} loss!"),
    [STRINGID_PKMNSXINFATUATEDY]             = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\ninfatuated {B_ATK_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNSXMADEYINEFFECTIVE]        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nmade {B_CURRENT_MOVE} ineffective!"),
    [STRINGID_PKMNSXCUREDYPROBLEM]           = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\ncured its {B_BUFF1} problem!"),
    [STRINGID_ITSUCKEDLIQUIDOOZE]            = COMPOUND_STRING("It sucked up the\nLIQUID OOZE!"),
    [STRINGID_PKMNTRANSFORMED]               = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} transformed!"),
    [STRINGID_ELECTRICITYWEAKENED]           = COMPOUND_STRING("Electricity's power was\nweakened!"),
    [STRINGID_FIREWEAKENED]                  = COMPOUND_STRING("Fire's power was\nweakened!"),
    [STRINGID_PKMNHIDUNDERWATER]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} hid\nunderwater!"),
    ...
    [STRINGID_XFOUNDONEY]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} found\none {B_LAST_ITEM}!"),
    ...
    [STRINGID_ITEMSCANTBEUSEDNOW]            = COMPOUND_STRING("Items can't be used now.{PAUSE 34}"),
    [STRINGID_FORXCOMMAYZ]                   = COMPOUND_STRING("For {B_SCR_ACTIVE_NAME_WITH_PREFIX},\n{B_LAST_ITEM} {B_BUFF1}"),
    [STRINGID_USINGXTHEYOFZN]                = COMPOUND_STRING("Using {B_LAST_ITEM}, the {B_BUFF1}\nof {B_SCR_ACTIVE_NAME_WITH_PREFIX} {B_BUFF2}"),
    [STRINGID_PKMNUSEDXTOGETPUMPED]          = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} used\n{B_LAST_ITEM} to hustle!"),
    [STRINGID_PKMNSXMADEYUSELESS]            = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nmade {B_CURRENT_MOVE} useless!"),
    [STRINGID_PKMNTRAPPEDBYSANDTOMB]         = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was trapped\nby SAND TOMB!"),
    [STRINGID_EMPTYSTRING4]                  = COMPOUND_STRING(""),
    [STRINGID_ABOOSTED]                      = COMPOUND_STRING(" a boosted"),
    [STRINGID_PKMNSXINTENSIFIEDSUN]          = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nintensified the sun's rays!"),
    [STRINGID_PKMNMAKESGROUNDMISS]           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} can float!\nGROUND-based moves can't hit it!{PAUSE 8}"),
    [STRINGID_YOUTHROWABALLNOWRIGHT]         = COMPOUND_STRING("You throw a BALL now, right?\nI… I'll do my best!"),
    [STRINGID_PKMNSXTOOKATTACK]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\ntook the attack!"),
    [STRINGID_PKMNCHOSEXASDESTINY]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} chose\n{B_CURRENT_MOVE} as its destiny!"),
    [STRINGID_PKMNLOSTFOCUS]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} lost its\nfocus and couldn't move!"),
    [STRINGID_USENEXTPKMN]                   = COMPOUND_STRING("Use next POKéMON?"),
    [STRINGID_PKMNFLEDUSINGITS]              = COMPOUND_STRING("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX} fled\nusing its {B_LAST_ITEM}!\p"),
    [STRINGID_PKMNFLEDUSING]                 = COMPOUND_STRING("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX} fled\nusing {B_ATK_ABILITY}!\p"),
    [STRINGID_PKMNWASDRAGGEDOUT]             = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was\ndragged out!\p"),
    [STRINGID_PREVENTEDFROMWORKING]          = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nprevented {B_SCR_ACTIVE_NAME_WITH_PREFIX}'s\l{B_BUFF1} from working!"),
    [STRINGID_PKMNSITEMNORMALIZEDSTATUS]     = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nnormalized its status!"),
    [STRINGID_TRAINER1USEDITEM]              = COMPOUND_STRING("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}\nused {B_LAST_ITEM}!"),
    [STRINGID_BOXISFULL]                     = COMPOUND_STRING("The BOX is full!\nYou can't catch any more!\p"),
    [STRINGID_PKMNAVOIDEDATTACK]             = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} avoided\nthe attack!"),
    [STRINGID_PKMNSXMADEITINEFFECTIVE]       = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nmade it ineffective!"),
    [STRINGID_PKMNSXPREVENTSFLINCHING]       = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}'s {B_EFF_ABILITY}\nprevents flinching!"),
    [STRINGID_PKMNALREADYHASBURN]            = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} already\nhas a burn."),
    [STRINGID_STATSWONTDECREASE2]            = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s stats won't\ngo any lower!"),
    [STRINGID_PKMNSXBLOCKSY2]                = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nblocks {B_CURRENT_MOVE}!"),
    [STRINGID_PKMNSXWOREOFF]                 = COMPOUND_STRING("{B_ATK_PREFIX1}'s {B_BUFF1}\nwore off!"),
    [STRINGID_PKMNRAISEDDEFALITTLE]          = COMPOUND_STRING("{B_ATK_PREFIX2}'s {B_CURRENT_MOVE}\nraised DEFENSE a little!"),
    [STRINGID_PKMNRAISEDSPDEFALITTLE]        = COMPOUND_STRING("{B_ATK_PREFIX2}'s {B_CURRENT_MOVE}\nraised SP. DEF a little!"),
    [STRINGID_THEWALLSHATTERED]              = COMPOUND_STRING("The wall shattered!"),
    [STRINGID_PKMNSXPREVENTSYSZ]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\nprevents {B_DEF_NAME_WITH_PREFIX}'s\l{B_DEF_ABILITY} from working!"),
    [STRINGID_ATTACKERCANTESCAPE]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} can't escape!"),
    [STRINGID_PKMNOBTAINEDX]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} obtained\n{B_BUFF1}."),
    [STRINGID_PKMNOBTAINEDX2]                = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} obtained\n{B_BUFF2}."),
    [STRINGID_PKMNOBTAINEDXYOBTAINEDZ]       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} obtained\n{B_BUFF1}.\p{B_DEF_NAME_WITH_PREFIX} obtained\n{B_BUFF2}."),
    [STRINGID_BUTNOEFFECT]                   = COMPOUND_STRING("But it had no effect!"),
    [STRINGID_PKMNSXHADNOEFFECTONY]          = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nhad no effect on {B_EFF_NAME_WITH_PREFIX}!"),
    [STRINGID_OAKPLAYERWON]                  = COMPOUND_STRING("OAK: Hm! Excellent!\pIf you win, you earn prize money,\nand your POKéMON will grow!\pBattle other TRAINERS and make\nyour POKéMON strong!\p"),
    [STRINGID_OAKPLAYERLOST]                 = COMPOUND_STRING("OAK: Hm…\nHow disappointing…\pIf you win, you earn prize money,\nand your POKéMON grow.\pBut if you lose, {B_PLAYER_NAME}, you end\nup paying prize money…\pHowever, since you had no warning\nthis time, I'll pay for you.\pBut things won't be this way once\nyou step outside these doors.\pThat's why you must strengthen your\nPOKéMON by battling wild POKéMON.\p"),
    [STRINGID_PLAYERLOSTAGAINSTENEMYTRAINER] = COMPOUND_STRING("{B_PLAYER_NAME} is out of\nusable POKéMON!\pPlayer lost against\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}!{PAUSE_UNTIL_PRESS}"), 
    [STRINGID_PLAYERPAIDPRIZEMONEY]          = COMPOUND_STRING("{B_PLAYER_NAME} paid ¥{B_BUFF1} as the prize\nmoney…\p… … … …\p{B_PLAYER_NAME} whited out!{PAUSE_UNTIL_PRESS}"),
    [STRINGID_PKMNTRANSFERREDSOMEONESPC]     = COMPOUND_STRING("{STR_VAR_2} was transferred to\nSomeone's PC.\pIt was placed in\nBOX “{STR_VAR_1}.”"),
    [STRINGID_PKMNTRANSFERREDBILLSPC]        = COMPOUND_STRING("{STR_VAR_2} was transferred to\nBILL'S PC.\pIt was placed in\nBOX “{STR_VAR_1}.”"),
    [STRINGID_PKMNBOXSOMEONESPCFULL]         = COMPOUND_STRING("BOX “{STR_VAR_3}” on\nSomeone's PC was full.\p{STR_VAR_2} was transferred to\nBOX “{STR_VAR_1}.”"),
    [STRINGID_PKMNBOXBILLSPCFULL]            = COMPOUND_STRING("BOX “{STR_VAR_3}” on\nBILL'S PC was full.\p{STR_VAR_2} was transferred to\nBOX “{STR_VAR_1}.”"),
    ...
    [STRINGID_POKEFLUTE]                     = COMPOUND_STRING("{B_PLAYER_NAME} played the\n{B_LAST_ITEM}."),
    [STRINGID_MONHEARINGFLUTEAWOKE]          = COMPOUND_STRING("The POKéMON hearing the FLUTE\nawoke!"),
    [STRINGID_PKMNSXCALLEDDOWNHAIL]          = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\ncalled down hail!"),
    [STRINGID_POKEMONBLOCKEDBALL]            = COMPOUND_STRING("The Wild {B_DEF_NAME}\nblocked the BALL!{PAUSE 10}"), //
    [STRINGID_NEUTRALIZINGGASENTERS]         = COMPOUND_STRING("Neutralizing Gas filled the area!"),
    [STRINGID_NEUTRALIZINGGASOVER]           = COMPOUND_STRING("The effects of Neutralizing Gas\n wore off!"), //new values below
    [STRINGID_INFESTATION]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} has been afflicted\nwith an infestation!"),
    [STRINGID_ENDUREDSTURDY]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} ENDURED\nthe hit via {B_DEF_ABILITY}!"),
    [STRINGID_POWERHERB]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} became fully charged\ndue to its {B_LAST_ITEM}!"),
    [STRINGID_HURTBYITEM]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} was hurt\nby its {B_LAST_ITEM}!"),
    [STRINGID_PSNBYITEM]                     = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} was badly \npoisoned by the {B_LAST_ITEM}!"),
    [STRINGID_BRNBYITEM]                     = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} was burned\nby the {B_LAST_ITEM}!"),
    ...
    [STRINGID_TARGETIDENTIFIED]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was \nidentified!"),
    [STRINGID_TARGETWOKEUP]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} woke up!"),
    [STRINGID_PKMNSTOLEANDATEITEM]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} stole and\nate {B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}!"),
    [STRINGID_TAILWINDBLEW]                  = COMPOUND_STRING("The tailwind blew from\nbehind {B_ATK_TEAM2} team!"),
    [STRINGID_PKMNWENTBACK]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} went back\nto {B_ATK_TRAINER_CLASS}{B_ATK_TRAINER_NAME}"),
    [STRINGID_PKMNCANTUSEITEMSANYMORE]       = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} can't use\nitems anymore!"),
    [STRINGID_PKMNFLUNG]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} flung its\n{B_LAST_ITEM}!"),
    [STRINGID_PKMNPREVENTEDFROMHEALING]      = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was prevented\nfrom healing!"),
    [STRINGID_PKMNSWITCHEDATKANDDEF]         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} switched its\nAttack and Defense!"),
    [STRINGID_PKMNSABILITYSUPPRESSED]        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s ability\nwas suppressed!"),
    [STRINGID_SHIELDEDFROMCRITICALHITS]      = COMPOUND_STRING("The {B_CURRENT_MOVE} shielded {B_ATK_TEAM2}\nteam from critical hits!"),
    [STRINGID_SWITCHEDATKANDSPATK]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} switched all its\nchanges to its Attack and\pSp. Atk with the target!"),
    [STRINGID_SWITCHEDDEFANDSPDEF]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} switched all its\nchanges to its Defense and\pSp. Def with the target!"),
    [STRINGID_PKMNACQUIREDABILITY]           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} acquired\n{B_DEF_ABILITY}!"),
    [STRINGID_POISONSPIKESSCATTERED]         = COMPOUND_STRING("Poison Spikes were scattered all\naround the opposing team's feet!"),
    [STRINGID_PKMNSWITCHEDSTATCHANGES]       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} switched stat changes\nwith the target!"),
    [STRINGID_PKMNSURROUNDEDWITHVEILOFWATER] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} surrounded itself\nwith a veil of water!"),
    [STRINGID_PKMNLEVITATEDONELECTROMAGNETISM] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} levitated on\nelectromagnetism!"),
    [STRINGID_PKMNTWISTEDDIMENSIONS]         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} twisted\nthe dimensions!"),
    [STRINGID_POINTEDSTONESFLOAT]            = COMPOUND_STRING("Pointed stones float in the air\naround {B_DEF_TEAM2} team!"),
    [STRINGID_CLOAKEDINMYSTICALMOONLIGHT]    = COMPOUND_STRING("It became cloaked in mystical\nmoonlight!"),
    [STRINGID_TRAPPEDBYSWIRLINGMAGMA]        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} became\ntrapped by swirling magma!"),
    [STRINGID_VANISHEDINSTANTLY]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} vanished\ninstantly!"),
    [STRINGID_PROTECTEDTEAM]                 = COMPOUND_STRING("{B_CURRENT_MOVE} protected\n{B_ATK_TEAM2} team!"),
    [STRINGID_SHAREDITSGUARD]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} shared its\nguard with the target!"),
    [STRINGID_SHAREDITSPOWER]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} shared its\npower with the target!"),
    [STRINGID_SWAPSDEFANDSPDEFOFALLPOKEMON] = COMPOUND_STRING("It created a bizarre area in which\nthe Defense and Sp.Def stats are swapped!"),
    [STRINGID_BECAMENIMBLE]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} became nimble!"),
    [STRINGID_HURLEDINTOTHEAIR]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was hurled\ninto the air!"),
    [STRINGID_HELDITEMSLOSEEFFECTS]          = COMPOUND_STRING("It created a bizarre area in which\nPokémon's held items lose their effects!"),
    [STRINGID_FELLSTRAIGHTDOWN]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} fell\nstraight down!"),
    [STRINGID_TRANSFORMEDINTOWATERTYPE]      = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} transformed\ninto the water type!"),
    [STRINGID_PKMNACQUIREDSIMPLE]            = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} acquired\nSimple!"),
    [STRINGID_EMPTYSTRING5]                  = COMPOUND_STRING(""),
    [STRINGID_KINDOFFER]                     = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}\ntook the kind offer!"),
    [STRINGID_RESETSTARGETSSTATLEVELS]       = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s stat changes\nwere removed!"),
    [STRINGID_EMPTYSTRING6]                  = COMPOUND_STRING(""),
    ...
    [STRINGID_TOOKPKMNINTOTHESKY]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} took\n{B_DEF_NAME_WITH_PREFIX} into the sky!"),
    [STRINGID_FREEDFROMSKYDROP]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was freed\nfrom the Sky Drop!"),
    [STRINGID_POSTPONETARGETMOVE]            = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s move\nwas postponed!"),
    [STRINGID_REFLECTTARGETSTYPE]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s type\nchanged to match the {B_DEF_NAME_WITH_PREFIX}'s!"),
    [STRINGID_TRANSFERHELDITEM]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} received {B_LAST_ITEM}\nfrom {B_ATK_NAME_WITH_PREFIX}"),
    [STRINGID_EMBARGOENDS]                   = COMPOUND_STRING("{B_ATK_TEAM1} side can\nuse items again!"),
    [STRINGID_ELECTROMAGNETISM]              = COMPOUND_STRING("electromagnetism"),
    [STRINGID_BUFFERENDS]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1}\nwore off!"),
    [STRINGID_TELEKINESISENDS]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} was freed\nfrom the telekinesis!"),
    [STRINGID_TAILWINDENDS]                  = COMPOUND_STRING("{B_ATK_TEAM1} team's tailwind\n petered out!"),
    [STRINGID_LUCKYCHANTENDS]                = COMPOUND_STRING("{B_ATK_TEAM1} team's Lucky Chant\n wore off!"),
    [STRINGID_TRICKROOMENDS]                 = COMPOUND_STRING("The twisted dimensions returned to\nnormal!"),
    [STRINGID_WONDERROOMENDS]                = COMPOUND_STRING("Wonder Room wore off, and\nDefense and Sp. Def stats returned to normal!"),
    [STRINGID_MAGICROOMENDS]                 = COMPOUND_STRING("Magic Room wore off, and\nheld items' effects returned to normal!"),
    ...
    [STRINGID_AURORAVEILENDS]                = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nwore off!"),
    ...
    [STRINGID_POISONHEALHPUP]                = COMPOUND_STRING("The poison restored {B_ATK_NAME_WITH_PREFIX}'s\nHP a little!"),
    ...
    [STRINGID_TERAVOLTENTERS]                = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is radiating \na bursting aura!"),
    [STRINGID_TURBOBLAZEENTERS]              = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is radiating\na blazing aura!"),
    [STRINGID_SLOWSTARTENTERS]               = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is\nin a weakened state!{PAUSE 9}"),
    [STRINGID_SLOWSTARTEND]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s power has\nreturned to its zenith!{PAUSE 9}"),
    [STRINGID_SOLARPOWERHPDROP]              = COMPOUND_STRING("The {B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\ntook its toll!"),
    [STRINGID_AFTERMATHDMG]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY} tried to take\n{B_ATK_NAME_WITH_PREFIX} out with them!"),
    [STRINGID_ANTICIPATIONACTIVATES]         = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} sensed {B_BUFF1}\nand shuddered in anticipation!"),
    [STRINGID_FOREWARNACTIVATES]             = COMPOUND_STRING("{B_SCR_ACTIVE_ABILITY} {B_BUFF3} {B_SCR_ACTIVE_NAME_WITH_PREFIX}\n{B_BUFF2} {B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}!"),
    [STRINGID_ICEBODYHPGAIN]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\nhealed it a little bit!"),
    [STRINGID_CRYOSTORMHAIL]               = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\ncalled down hail!"),
    [STRINGID_FRISKACTIVATES]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} frisked {B_DEF_NAME_WITH_PREFIX} and\nfound its {B_LAST_ITEM}!"),
    [STRINGID_UNNERVEENTERS]                 = COMPOUND_STRING("The opposing team is too nervous\nto eat Berries!"),
    [STRINGID_HARVESTBERRY]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} harvested\nits {B_LAST_ITEM}!"),
    [STRINGID_LASTABILITYRAISEDSTAT]         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY} raised its Attack!"),
    [STRINGID_MAGICBOUNCEACTIVATES]          = COMPOUND_STRING("The {B_DEF_NAME_WITH_PREFIX} bounced the\n{B_ATK_NAME_WITH_PREFIX} back!"),
    [STRINGID_PROTEANTYPECHANGE]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY} transformed\nit into the {B_BUFF1} type!"),
    [STRINGID_SYMBIOSISITEMPASS]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} passed its {B_LAST_ITEM}\nto {B_SCR_ACTIVE_NAME_WITH_PREFIX} through {B_ATK_ABILITY}!"),
    [STRINGID_STEALTHROCKDMG]                = COMPOUND_STRING("Pointed stones dug into\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}!"),
    [STRINGID_TOXICSPIKESABSORBED]           = COMPOUND_STRING("The poison spikes disappeared\nfrom around {B_ATK_TEAM2} team's feet!"),
    [STRINGID_TOXICSPIKESPOISONED]           = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} was poisoned!"),
    [STRINGID_STICKYWEBSWITCHIN]             = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} was\ncaught in a Sticky Web!"),
    ...
    [STRINGID_LUNARDANCECAMETRUE]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} became cloaked\nin mystical moonlight!"),
    [STRINGID_CUSEDBODYDISABLED]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1} was disabled\nby {B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}!"),
    [STRINGID_ATTACKERACQUIREDABILITY]       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} acquired {B_LAST_ABILITY}!"),
    [STRINGID_TARGETABILITYSTATLOWER]        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nlowered its {B_BUFF1}!"),
    [STRINGID_TARGETSTATWONTGOHIGHER]        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}\nwon't go higher!"),
    [STRINGID_PKMNMOVEBOUNCEDABILITY]        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_CURRENT_MOVE} was refelcted\nby {B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}{PAUSE 26}!"),
    [STRINGID_IMPOSTERTRANSFORM]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} transformed into\na {B_DEF_NAME_WITH_PREFIX} using {B_BUFF2}!"),
    [STRINGID_ASSAULTVESTDOESNTALLOW]        = COMPOUND_STRING("The effects of the {B_LAST_ITEM} prevent status\nmoves from being used!\p"),
    [STRINGID_GRAVITYPREVENTSUSAGE]          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} can't use {B_CURRENT_MOVE}\nbecause of gravity!\p"),
    [STRINGID_HEALBLOCKPREVENTSUSAGE]        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} was\nprevented from healing!\p"),
    [STRINGID_NOTDONEYET]                    = COMPOUND_STRING("Not Done Yet"),
    [STRINGID_STICKYWEBUSED]                 = COMPOUND_STRING("A sticky web spreads out on the\nground around {B_DEF_TEAM2} team!"),
    [STRINGID_QUASHSUCCESS]                  = COMPOUND_STRING("The opposing {B_ATK_NAME_WITH_PREFIX}'s move was postponed!"),
    [STRINGID_PKMNBLEWAWAYTOXICSPIKES]       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} blew away\nTOXIC SPIKES!"),
    [STRINGID_PKMNBLEWAWAYSTICKYWEB]         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} blew away\nSTICKY WEB!"),
    [STRINGID_PKMNBLEWAWAYSTEALTHROCK]       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} blew away\nSTEALTH ROCK!"),
    ...
    [STRINGID_TARGETELECTRIFIED]             = COMPOUND_STRING("The {B_DEF_NAME_WITH_PREFIX}'s moves\nhave been electrified!"),
    [STRINGID_MEGAEVOREACTING]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ITEM} is \nreacting to {B_ATK_TRAINER_NAME}'s Mega Ring!"),
    [STRINGID_MEGAEVOEVOLVED]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} has Mega\nEvolved into Mega {B_BUFF1}!"),    
    [STRINGID_DRASTICALLY]                   = COMPOUND_STRING("drastically "),
    [STRINGID_SEVERELY]                      = COMPOUND_STRING("severely "),
    [STRINGID_NOEFFECTONTARGET]              = COMPOUND_STRING("It had no effect\non {B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_BURSTINGFLAMESHIT]             = COMPOUND_STRING("The bursting flames\nhit {B_SCR_ACTIVE_NAME_WITH_PREFIX}!"),
    [STRINGID_BESTOWITEMGIVING]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} received {B_LAST_ITEM}\nfrom {B_ATK_NAME_WITH_PREFIX}!"),
    [STRINGID_THIRDTYPEADDED]                = COMPOUND_STRING("{B_BUFF1} type was added to\n{B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_FELLFORFEINT]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} fell for\nthe feint!"),
    [STRINGID_POKEMONCANNOTUSEMOVE]          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} cannot\nuse {B_CURRENT_MOVE}!"),
    ...
    [STRINGID_SPECTRALTHIEFSTEAL]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} stole the target's\nboosted stats!"),
    ...
    [STRINGID_FLOWERVEILPROTECTED]           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} surrounded itself\nwith a veil of petals!"),
    [STRINGID_SWEETVEILPROTECTED]            = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} surrounded itself\nwith a veil of sweetness!"),
    [STRINGID_AROMAVEILPROTECTED]            = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is protected\nby an aromatic veil!"),
    [STRINGID_CELEBRATEMESSAGE]              = COMPOUND_STRING("Congratulations, {B_PLAYER_NAME}!"),
    [STRINGID_USEDINSTRUCTEDMOVE]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} used the move\ninstructed by {B_BUFF1}!"),
    [STRINGID_THROATCHOPENDS]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} can\nuse sound-based moves again!"),
    [STRINGID_PKMNCANTUSEMOVETHROATCHOP]     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} can't use\n{B_CURRENT_MOVE} due to Throat Chop!\p"),    
    ...
    [STRINGID_AIRBALLOONFLOAT]               = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} floats in the air\nwith its {B_LAST_ITEM}!"),
    [STRINGID_AIRBALLOONPOP]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ITEM} popped!"),
    [STRINGID_INCINERATEBURN]                = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nwas burnt up!"),
    [STRINGID_BUGBITE]                       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} stole and ate\n{B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}!"),
    [STRINGID_ILLUSIONWOREOFF]               = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s Illusion wore off!"),
    [STRINGID_ATTACKERCUREDTARGETSTATUS]     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} cured\n{B_DEF_NAME_WITH_PREFIX}'s problem!"),
    [STRINGID_ATTACKERLOSTTYPE]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} lost it's {B_BUFF3} type!"),
    [STRINGID_HEALERCURE]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\ncured {B_SCR_ACTIVE_NAME_WITH_PREFIX}'s problem!"),
    [STRINGID_SCRIPTINGABILITYSTATRAISE]     = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nraised its {B_BUFF1}!"),
    [STRINGID_RECEIVERABILITYTAKEOVER]       = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nwas taken over!"),
    ...
    [STRINGID_DESTINYKNOTACTIVATES]          = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} fell in love\nfrom the {B_LAST_ITEM}!"),
    [STRINGID_CLOAKEDINAFREEZINGLIGHT]       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} became cloaked\nin a freezing light!"),
    [STRINGID_STATWASNOTLOWERED]             = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}\nwas not lowered!"),
    ...
    [STRINGID_PRESSUREENTERS]                = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is exerting its\npressure!"),
    [STRINGID_DARKAURAENTERS]                = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is radiating\na dark aura!"),
    [STRINGID_FAIRYAURAENTERS]               = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is radiating\na fairy aura!"),
    [STRINGID_AURABREAKENTERS]               = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} reversed all\nother POKéMON's auras!"),
    ...
    [STRINGID_FETCHEDPOKEBALL]               = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} found\na {B_LAST_ITEM}!"),
    [STRINGID_BATTLERABILITYRAISEDSTAT]      = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nraised its {B_BUFF1}!"),
    [STRINGID_ASANDSTORMKICKEDUP]            = COMPOUND_STRING("A sandstorm kicked up!"),
    [STRINGID_ATTACKERWILLPERISHIN3TURNS]       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} will perish\nin three turns!"),
    [STRINGID_ABILITYRAISEDSTATDRASTICALLY]  = COMPOUND_STRING("{B_DEF_ABILITY} raised {B_DEF_NAME_WITH_PREFIX}'s\n{B_BUFF1} drastically!"),  
    [STRINGID_AURAFLAREDTOLIFE]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s aura flared to life!"),
        ...
        [STRINGID_CURIOUSMEDICINEENTERS] = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}'s\nstat changes were reset!"),
        [STRINGID_CANACTFASTERTHANKSTO] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} moved faster,\nthanks to {B_BUFF1}!"),
        [STRINGID_MICLEBERRYACTIVATES] = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} boosted the accuracy of its\nnext move using {B_LAST_ITEM}!"),
        [STRINGID_PKMNSHOOKOFFTHETAUNT] = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} shook off\nthe taunt!"),
        [STRINGID_PKMNGOTOVERITSINFATUATION] = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} got over\nits infatuation!"),
        [STRINGID_ITEMCANNOTBEREMOVED] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s item cannot be removed!"),
        [STRINGID_STICKYBARBTRANSFER] = COMPOUND_STRING("The {B_LAST_ITEM} attached itself to\n{B_ATK_NAME_WITH_PREFIX}!"),
        [STRINGID_PKMNBURNHEALED] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s\nburn was healed."),
        [STRINGID_REDCARDACTIVATE] = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} held up its {B_LAST_ITEM}\nagainst {B_ATK_NAME_WITH_PREFIX}!"),
        [STRINGID_EJECTBUTTONACTIVATE] = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is switched\nout with the {B_LAST_ITEM}!"),
        [STRINGID_ATKGOTOVERINFATUATION] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} got over\nits infatuation!"),
        [STRINGID_TORMENTEDNOMORE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is\ntormented no more!"),
        [STRINGID_HEALBLOCKEDNOMORE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is cured of\nits heal block!"),
        [STRINGID_ATTACKERBECAMEFULLYCHARGED] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} became fully charged\ndue to its bond with its trainer!\p"),
        [STRINGID_ATTACKERBECAMEASHSPECIES] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} became Ash-{B_BUFF1}!\p"),
        [STRINGID_EXTREMELYHARSHSUNLIGHT] = COMPOUND_STRING("The sunlight turned\nextremely harsh!"),
        [STRINGID_EXTREMESUNLIGHTFADED] = COMPOUND_STRING("The extreme sunlight faded.{PAUSE 32}"),
        [STRINGID_MOVEEVAPORATEDINTHEHARSHSUNLIGHT] = COMPOUND_STRING("The Water-type attack evaporated\nin the harsh sunlight!"),
        [STRINGID_EXTREMELYHARSHSUNLIGHTWASNOTLESSENED] = COMPOUND_STRING("The extremely harsh sunlight\nwas not lessened at all!"),
        [STRINGID_HEAVYRAIN] = COMPOUND_STRING("A heavy rain began to fall!"),
        [STRINGID_HEAVYRAINLIFTED] = COMPOUND_STRING("The heavy rain has lifted!{PAUSE 32}"),
        [STRINGID_MOVEFIZZLEDOUTINTHEHEAVYRAIN] = COMPOUND_STRING("The Fire-type attack fizzled out\nin the heavy rain!"),
        [STRINGID_NORELIEFROMHEAVYRAIN] = COMPOUND_STRING("There is no relief from\nthis heavy rain!"),
        [STRINGID_MYSTERIOUSAIRCURRENT] = COMPOUND_STRING("A mysterious air current is\nprotecting Flying-type Pokémon!"),
        [STRINGID_STRONGWINDSDISSIPATED] = COMPOUND_STRING("The mysterious strong winds\nhave dissipated!{PAUSE 32}"),
        [STRINGID_MYSTERIOUSAIRCURRENTBLOWSON] = COMPOUND_STRING("The mysterious air current\nblows on regardless!"),
        [STRINGID_ATTACKWEAKENEDBYSTRONGWINDS] = COMPOUND_STRING("The mysterious strong winds\nweakened the attack!"),
        [STRINGID_STUFFCHEEKSCANTSELECT] = COMPOUND_STRING("Stuff Cheeks cannot be\nselected without a Berry!\p"),
        [STRINGID_PKMNREVERTEDTOPRIMAL] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} reverted to its primal form!"),
        [STRINGID_BUTPOKEMONCANTUSETHEMOVE] = COMPOUND_STRING("But {B_ATK_NAME_WITH_PREFIX} can't\nuse the move!"),
        [STRINGID_BUTHOOPACANTUSEIT] = COMPOUND_STRING("But Hoopa can't use it\nthe way it is now!"),
        [STRINGID_BROKETHROUGHPROTECTION] = COMPOUND_STRING("It broke through the\n{B_DEF_NAME_WITH_PREFIX}'s protection!"),
        [STRINGID_ABILITYALLOWSONLYMOVE] = COMPOUND_STRING("{B_ATK_ABILITY} allows the\nuse of only {B_CURRENT_MOVE}!\p"),
        [STRINGID_SWAPPEDABILITIES] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} swapped Abilities\nwith its target!"),
        [STRINGID_PASTELVEILPROTECTED] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is protected\nby a pastel veil!"),
        [STRINGID_PASTELVEILENTERS] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was cured\nof its poisoning!"),
        [STRINGID_BATTLERTYPECHANGEDTO] = COMPOUND_STRING("{B_BUFF1}'s type\nchanged to {B_BUFF2}!"),
        [STRINGID_BOTHCANNOLONGERESCAPE] = COMPOUND_STRING("Neither Pokémon can run away!"),
        [STRINGID_CANTESCAPEDUETOUSEDMOVE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} can no longer escape\nbecause it used {B_CURRENT_MOVE}!"),
        [STRINGID_PKMNBECAMEWEAKERTOFIRE] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} became\nweaker to fire!"),
        [STRINGID_ABOUTTOUSEPOLTERGEIST] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is about\nto be attacked by its {B_BUFF1}!"),
        [STRINGID_CANTESCAPEBECAUSEOFCURRENTMOVE] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} can no longer escape\nbecause of {B_CURRENT_MOVE}!"),
        [STRINGID_TARGETTOOHEAVY] = COMPOUND_STRING("But the target was too heavy!"),
        [STRINGID_PKMNTOOKTARGETHIGH] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} took {B_DEF_NAME_WITH_PREFIX}\ninto the air!"),        
    [STRINGID_CUPIDSARROWSTRUCK]             = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} fell in love\nat first sight!"),
    [STRINGID_PKMNALREADYFROZEN]             = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is already\nfrozen."),
    [STRINGID_SNAPTRAP]                      = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was ensnared\nby {B_ATK_NAME_WITH_PREFIX}'s trap!"),
    [STRINGID_PKMNSTOPPEDROOSTING]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} stopped roosting\nand took to the air!{PAUSE 15}"),
    [STRINGID_CONFIRMFORGETMOVE]             = COMPOUND_STRING("{PAUSE 32}Are you sure you want to\nforget {B_BUFF2}?"),
    [STRINGID_TERRAINBECOMESFIRE]            = COMPOUND_STRING("The battlefield was set aflame!"),
    [STRINGID_TERRAINBECOMESWATER]           = COMPOUND_STRING("Water flooded The battlefield!"),
    [STRINGID_TERRAINBECOMESDEEPWATER]       = COMPOUND_STRING("The battlefield is covered by\ndeep water!"),
    [STRINGID_CRASHEDTOTHEGROUND]            = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} crashed\nto the ground!"),
    [STRINGID_DEFEATISTACTIVATED]            = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} lost the will to fight\nand is ready to run!{PAUSE 22}"),
    [STRINGID_PKMNHURTBYFROSTBITE]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt\nby frostbite!"),
    [STRINGID_IRONWILL_ATKCANCEL]             = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY} made\n{B_SCR_ACTIVE_NAME_WITH_PREFIX} too afraid to attack!"),
    [STRINGID_STEALTHROCKABROSBED]           = COMPOUND_STRING("Pointed stones disappeared\nfrom around {B_ATK_TEAM2}'s team!"),
    [STRINGID_PICKUP_ITEM]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} picked up\na {B_BUFF1}!{PAUSE 12}"),
    [STRINGID_TIGER_MOM_ACTIVATES]          = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} pressured\n{B_DEF_NAME_WITH_PREFIX} cutting its DEFENSE!"),
    [STRINGID_DEFROST_POKEMON]               = COMPOUND_STRING("{B_ATK_TEAM1} {B_SCR_ACTIVE_NAME_WITH_PREFIX} was\ndefrosted!"),
    [STRINGID_CORRUPTIONENTERS]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} spread {B_ATK_ABILITY}!\n{B_DEF_TEAM1} side can't heal!\p"),
    [STRINGID_BANDITENTERS]                  = COMPOUND_STRING("The {B_ATK_ABILITY} is on the scene!\n{B_DEF_TEAM1} side can't use items!{PAUSE 32}"),
    [STRINGID_ANTICIPATE_EXPLOSION]          = COMPOUND_STRING("an explosive move"),
    [STRINGID_ANTICIPATE_OHKO]               = COMPOUND_STRING("a one-hit KO move"),
    [STRINGID_ANTICIPATE_DEFAULT]            = COMPOUND_STRING("a dangerous move"),
    [STRINGID_SPITE_BADLUCK]                 = COMPOUND_STRING(" had bad luck!"),
    [STRINGID_SPITE_TOTAL_LOSS]              = COMPOUND_STRING("'s luck ran out!"),
    [STRINGID_PKMNSPOISONWORSENED]           = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}'s poisoning got worse!\nIt's badly poisoned!"),
    [STRINGID_STENCHENTERS]                  = COMPOUND_STRING("A foul stench is in the air!"),
    [STRINGID_STENCHENDS]                    = COMPOUND_STRING("The foul odor has cleared!"),
    [STRINGID_WELLRESTED]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is\nwell rested!"),
    [STRINGID_PKMNHURTSWITH2]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} was hurt by\n{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}!"),
    [STRINGID_PKMNSABILITYPREVENTSABILITY]   = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nprevents {B_DEF_NAME_WITH_PREFIX}'s\l{B_DEF_ABILITY} from working!"),
    [STRINGID_STICKYHOLDABSORBEDITEM]        = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ITEM} was absorbed\nby {B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}!"),
    ...
    [STRINGID_EMPATHIC_CURSE_ACTIVATES]      = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} suffered\nthe {B_DEF_ABILITY}!"),
    [STRINGID_ATTACKER_STURDY]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} hung on\nvia {B_ATK_ABILITY}!"),
    [STRINGID_TARGETSXWHIPPEDUPSANDSTORM]    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nwhipped up a sandstorm!"),
    [STRINGID_ATTACKER_ABILITYHURTS_TARGET]  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1}\nhurt {B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNINFESTED]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is infested!"),
    [STRINGID_PKMNPANICKED]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} panicked\nand used a random move!"),
    [STRINGID_ABILITYNULLIFYTYPEDAMAGE]      = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} nullifies {B_BUFF1}\nmoves with {B_DEF_ABILITY}!"),
    [STRINGID_CAUGHTMONDROPPEDITEM]          = COMPOUND_STRING("{B_DEF_NAME} dropped a {B_BUFF3}!\p"),
    [STRINGID_MONROOSTING]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is resting\non the ground."),
    [STRINGID_ATK_RAGEBUILDING]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s RAGE\nis building!"),
    [STRINGID_ATK_RAGEABATED]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s RAGE\nabated!{PAUSE 15}"),
    [STRINGID_BIND_NO_PP]                    = COMPOUND_STRING("{B_BUFF1} ran out PP!"), 
    [STRINGID_FEMME_FATALE]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nresisted the infatuation."),
    [STRINGID_ABILITY_LOSTRESOLVE]           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY} made\n{B_ATK_NAME_WITH_PREFIX} lose its resolve!"),
    [STRINGID_AURA_OF_LIGHT_AWOKE]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nawoke {B_SCR_ACTIVE_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNMOVESEALEDNOMORE]         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1} is\nno longer sealed!"),
    [STRINGID_PKMNMOVESEALED]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} has lost the memory\nof how to use {B_BUFF1}!"),
    [STRINGID_ATEBERRY]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} ate its {B_BUFF1}!"),
    [STRINGID_PHOENIX_CLEANSE]             = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nhealed itself and\lcleansed hazards from the field!{PAUSE 97}"),  
    [STRINGID_PLAYER_FOREWARN]             = COMPOUND_STRING("to the"),
    [STRINGID_ENEMY_FOREAWRN]              = COMPOUND_STRING("to"), 
    [STRINGID_PLAYER_ALERT]                = COMPOUND_STRING("alerted"),
    [SRINGID_ENEMY_ALERT]                  = COMPOUND_STRING("alerted the"),
    [STRINGID_ANTICIPATE_STRONG_MOVE]      = COMPOUND_STRING("a strong move"),
    [STRINGID_FORECAST_BLIZZARD]           = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} predicted\na chilling Blizzard!\p"),
    [STRINGID_FORECAST_DUST_STORM]         = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} predicted\na harsh Dust Storm!\p"),
    [STRINGID_FORECAST_HEATWAVE]           = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} predicted\na blazing Heatwave!\p"),
    [STRINGID_FORECAST_TORRENTIAL_RAIN]    = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} predicted\nTorrential Rain!\p"),
    [STRINGID_FORECAST_SANDSTORM]          = COMPOUND_STRING("The Forecast came true!\nA sandstorm brewed!\p"),
    [STRINGID_FORECAST_HAIL]               = COMPOUND_STRING("The Forecast came true!\nIt started to hail!\p"),
    [STRINGID_FORECAST_RAIN]               = COMPOUND_STRING("The Forecast came true!\nIt started to rain!\p"),
    [STRINGID_FORECAST_SUNNY]              = COMPOUND_STRING("The Forecast came true!\nThe sunlight got bright!\p"),
    [STRINGID_FORECAST_PREDICTION]         =  COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} predicted\n{B_BUFF1} and {B_BUFF2}!\p"),
    [STRINGID_RAIN]                        = COMPOUND_STRING("rain"), 
    [STRINGID_SUN]                         = COMPOUND_STRING("sun"), 
    [STRINGID_SAND]                        = COMPOUND_STRING("sand"), 
    [STRINGID_HAIL]                        = COMPOUND_STRING("hail"), 
    [STRINGID_STATWENTBACKDOWN]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1} went back down!"),
    [STRINGID_CELEBRATE]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} began to dance strangely!"),
    [STRINGID_ANTICIPATE_SOME_MOVE]         = COMPOUND_STRING("something"),
    [STRINGID_JUDGMENT]                      = COMPOUND_STRING("{B_DEF_NAME} faced {STR_VAR_2} Judgment!{PAUSE 15}"),
    [STRINGID_GROUND_NULLIFY]                = COMPOUND_STRING("GROUND Types can't be blinded\nby Earth attacks!{PAUSE 5}"),
    [STRINGID_NOE_FLIGHT]                    = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is flying under the radar!"),
    [STRINGID_WONDER_GUARD_ENTERS]           = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is wreathed in\nan otherworldly veil!{PAUSE 36}"),
    [STRINGID_WONDER_GUARD_ENDS]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\nhas dissipated!{PAUSE 36}"),
    [STRINGID_DEF_RAGEABATED]                = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s RAGE\nabated!{PAUSE 15}"),
    ...
    [STRINGID_ITEMTOBAG]                     = COMPOUND_STRING("Item(s) added to the bag.{PAUSE 47}"),
    [STRINGID_DAMP_PREVENTS_AFTERMATH]       = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nprevents {B_SCR_ACTIVE_NAME_WITH_PREFIX}\lfrom using {B_LAST_ABILITY}!"),
    [STRINGID_CUPIDSARROWSTRUCK_BOTH]        = COMPOUND_STRING("{B_SCR_ACTIVE_ABILITY} struck both targets!"),
    [STRINGID_ATK_CUTECHARM]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\ninfatuated {B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_INVERSIONTRANSFORM]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} transformed into\na {B_BUFF1} using {B_BUFF2}!"),
    ...
    [STRINGID_HEAT_TRANCE_HPUP]              = COMPOUND_STRING("The burn restored {B_ATK_NAME_WITH_PREFIX}'s\nHP a little!"),
    ...
    [STRINGID_PKMNBLEWAWAYSHARPSTEEL]       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} blew away\nSTEEL SURGE!"),
    ...
    [STRINGID_PKMNSXINTENSIFIEDMOONLIGHT] = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nintensified the moon's rays!"),
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_SNOWWARNINGSNOW]                      = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nmade it snow!"),
...
>>>>>>> bb41e5622c (Refactor move target failure (#8696))
    ...
    [STRINGID_TRAINER2CLASS]                 = COMPOUND_STRING("{B_TRAINER2_CLASS}"),
    [STRINGID_TRAINER2NAME]                  = COMPOUND_STRING("{B_TRAINER2_NAME}"),
    [STRINGID_PLAYERWHITEDOUT]               = COMPOUND_STRING("{B_PLAYER_NAME} whited out!{PAUSE_UNTIL_PRESS}"),

...
//may add B_MSG_SWAPPED_INTO_PARTY  see about my custom string setup
...
//potentially add new charge effeect to this
//oh nvm this is a different effect from Wish
//this works by healing next switching mon after user faints
...
const u16 gAbilityWeatherChangeStringId[] =
{
    ...
    [B_MSG_STARTED_HAIL_STORM]     = STRINGID_CRYOSTORMHAIL,
    [B_MSG_STARTED_SNOW_WARNING]   = STRINGID_SNOWWARNINGSNOW,
    [B_MSG_STARTED_LUNAR_SOLSTICE] = STRINGID_PKMNSXINTENSIFIEDMOONLIGHT,
    [B_MSG_STARTED_TOXIC_DELUGE]   = STRINGID_PKMNSXSUMMONEDACIDRAIN,
...
const u16 gScreenSetStringIds[] =
{
    ...
    [B_MSG_SET_MAGIC_COAT_SINGLE]  = STRINGID_PKMNSHROUDEDITSELF,
    [B_MSG_SET_MAGIC_COAT_DOUBLE]  = STRINGID_PKMNSHROUDEDITSPARTY,
...
//idk if should be but think want add poison worsening here
const u16 gGotPoisonedStringIds[] =
{
    [B_MSG_STATUSED]            = STRINGID_PKMNWASPOISONED,
    [B_MSG_STATUSED_BY_ABILITY] = STRINGID_PKMNPOISONEDBY,
    [B_MSG_POISON_WORSENED]     = STRINGID_PKMNSPOISONWORSENED,
};
    ...
    while (*src != EOS)
    {
        ...
        {   //for stuff that could work better
            ...
            case B_TRAINER2_WIN_TEXT:   //B_TRAINER2_WIN_TEXT
                ...
                break;
            case B_26: //B_26   don't know what for? //seems not used in FR has diff use in EE
            ...
            case B_TRAINER2_NAME:
                ...
                break;
            case B_TRAINER2_NAME_WITH_CLASS:
                toCpy = textStart;
            ...
            case B_ATK_TRAINER_CLASS:   //B_ATK_TRAINER_CLASS //messes w player formatting so shifted, remove space append space when actually using 
                ...
                break;
            case B_ATK_TRAINER_NAME_WITH_CLASS:
                toCpy = textStart;

...
const u8 *const gBattleStringsTable[] = {
    ...
    [STRINGID_PKMNBLEWAWAYSTEELSURGE]       = sText_PkmnBlewAwaySteelSurge,
    [STRINGID_POINTEDSTEELSURROUNDS]            = COMPOUND_STRING("Pointed steel spears\nsurround {B_DEF_TEAM2}'s team!"),
    [STRINGID_STEELSURGE_ABSORBED]          = COMPOUND_STRING("The steel spears disappeared\nfrom around {B_ATK_TEAM2}'s team!"),
    ...
    [STRINGID_SYMBIOSIS_SWITCH_IN]      = sText_SymbiosisItemStorage,
...
const u16 gDmgHazardsStringIds[] =
{
    ...
    [B_MSG_STEEL_SPEARS]       = STRINGID_POINTEDSTEELSURROUNDS
};

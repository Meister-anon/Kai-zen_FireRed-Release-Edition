...
static const u8 sText_PkmnMadeSleep[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nmade {B_EFF_NAME_WITH_PREFIX} sleep!");
...
static const u8 sText_PkmnPoisonedBy[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\npoisoned {B_EFF_NAME_WITH_PREFIX}!");
...
static const u8 sText_PkmnBurnedBy[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nburned {B_EFF_NAME_WITH_PREFIX}!");
...
static const u8 sText_PkmnFrozenBy[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nfroze {B_EFF_NAME_WITH_PREFIX} solid!");
...
static const u8 sText_PkmnDefrosted[] = _("{B_ATK_TEAM1} {B_SCR_NAME_WITH_PREFIX} was\ndefrosted!"); //why?? prob remove this
...
static const u8 sText_PkmnWasParalyzedBy[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nparalyzed {B_EFF_NAME_WITH_PREFIX}!\lIt may be unable to move!");
...
static const u8 sText_PkmnHurtEmpathCurse[] = _("{B_SCR_NAME_WITH_PREFIX} suffered\nthe {B_DEF_ABILITY}!");
...
static const u8 sText_PkmnMadeItRain[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nmade it rain!");
static const u8 sText_PkmnRaisedSpeed[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nraised its SPEED!");
...
static const u8 sText_PkmnCutsAttackWith[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\ncuts {B_DEF_NAME_WITH_PREFIX}'s ATTACK!");
static const u8 sText_TigerMomActivation[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} pressured\n{B_DEF_NAME_WITH_PREFIX} cutting its DEFENSE!"); //maybe just do cuts defense?
static const u8 sText_DarkTypeIntimidateResist[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nhas no affect on Dark Types!");
static const u8 sText_PkmnPreventsStatLossWith[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nprevents stat loss!");
...
static const u8 sText_PkmnsXBlocksY2[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nblocks {B_CURRENT_MOVE}!");
static const u8 sText_PkmnsXRestoredHPALittle2[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\nrestored its HP a little!");
static const u8 sText_PkmnsXWhippedUpSandstorm[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nwhipped up a sandstorm!");
static const u8 sText_TargetsXWhippedUpSandstorm[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nwhipped up a sandstorm!");
static const u8 sText_PkmnsXIntensifiedSun[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nintensified the sun's rays!");
static const u8 sText_PkmnsXIntensifiedMoon[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nintensified the moon's rays!");
static const u8 sText_PkmnsXPreventsYLoss[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nprevents {B_BUFF1} loss!");
...
static const u8 sText_PkmnsXCuredYProblem[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\ncured its {B_BUFF1} problem!");
...
static const u8 sText_PkmnsXMadeItIneffective[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nmade it ineffective!");
static const u8 sText_PkmnsXPreventsFlinching[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_EFF_ABILITY}\nprevents flinching!");
static const u8 sText_PkmnsXPreventsYsZ[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\nprevents {B_DEF_NAME_WITH_PREFIX}'s\l{B_DEF_ABILITY} from working!");
static const u8 sText_PkmnsAbilityPreventsAbility[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nprevents {B_DEF_NAME_WITH_PREFIX}'s\l{B_DEF_ABILITY} from working!");
//taken from damp explosion logic specifically for aftermath damp
static const u8 sText_PkmnPreventsAbilityUsage[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nprevents {B_SCR_NAME_WITH_PREFIX}\lfrom using {B_LAST_ABILITY}!");//{B_LAST_ABILITY}
static const u8 sText_PkmnsXCuredItsYProblem[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\ncured its {B_BUFF1} problem!");
static const u8 sText_PkmnsXHadNoEffectOnY[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nhad no effect on {B_EFF_NAME_WITH_PREFIX}!");
...
static const u8 sText_PkmnsItemCuredParalysis[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\ncured paralysis!");
static const u8 sText_PkmnsItemCuredPoison[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\ncured poison!");
static const u8 sText_PkmnsItemHealedBurn[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nhealed its burn!");
static const u8 sText_PkmnsItemDefrostedIt[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\ndefrosted it!");
static const u8 sText_PkmnsItemWokeIt[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nwoke it from its sleep!");
static const u8 sText_PkmnsItemSnappedOut[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nsnapped it out of confusion!");
static const u8 sText_PkmnsItemCuredProblem[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\ncured its {B_BUFF1} problem!");
static const u8 sText_PkmnsItemNormalizedStatus[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nnormalized its status!");
static const u8 sText_PkmnsItemRestoredHealth[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nrestored health!");
static const u8 sText_PkmnsItemRestoredPP[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nrestored {B_BUFF1}'s PP!");
static const u8 sText_PkmnsItemRestoredStatus[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nrestored its status!");
static const u8 sText_PkmnsItemRestoredHPALittle[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nrestored its HP a little!");
...
static const u8 sText_PkmnsXCalledDownHail[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\ncalled down hail!");
...
static const u8 sText_ScriptingAbilityRaisedStat[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nraised its {B_BUFF1}!");
...
static const u8 sText_TeravoltEnters[] = _("{B_SCR_NAME_WITH_PREFIX} is radiating \na bursting aura!");
static const u8 sText_TurboblazeEnters[] = _("{B_SCR_NAME_WITH_PREFIX} is radiating\na blazing aura!");
static const u8 sText_SlowStartEnters[] = _("{B_SCR_NAME_WITH_PREFIX} is\nin a weakened state!{PAUSE 9}");
static const u8 sText_SlowStartEnd[] = _("{B_ATK_NAME_WITH_PREFIX}'s power has\nreturned to its zenith!{PAUSE 9}");
static const u8 sText_WonderGuardEnters[] = _("{B_SCR_NAME_WITH_PREFIX} is wreathed in\nan otherworldly veil!{PAUSE 36}"); //wraith something
...
static const u8 sText_AnticipationActivates[] = _("{B_SCR_NAME_WITH_PREFIX} sensed {B_BUFF1}\nand shuddered in anticipation!");
static const u8 sText_ForewarnActivates[] = _("{B_SCR_ABILITY} {B_BUFF3} {B_SCR_NAME_WITH_PREFIX}\n{B_BUFF2} {B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}!");
...
static const u8 sText_SnowWarningHail[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nbrought down hail!");
...
static const u8 sText_ForecastBlizzard[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} predicted\na chilling Blizzard!\p");
static const u8 sText_ForecastDuststorm[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} predicted\na harsh Dust Storm!\p");
static const u8 sText_ForecastHeatwave[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} predicted\na blazing Heatwave!\p");
static const u8 sText_ForecastTorrentialrain[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} predicted\nTorrential Rain!\p");
...
static const u8 sText_ForecastPrediction[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} predicted\n{B_BUFF1} and {B_BUFF2}!\p");//learned ending with new paragraph lets it stay till press
...
static const u8 sText_SymbiosisItemStorage[] = _("{B_ATK_NAME_WITH_PREFIX} stored a {B_BUFF1}\nfor its ally through {B_ATK_ABILITY}!");
...
static const u8 sText_StickyWebSwitchIn[] = _("{B_SCR_NAME_WITH_PREFIX} was\ncaught in a Sticky Web!");
...
static const u8 sText_AirBalloonFloat[] = _("{B_SCR_NAME_WITH_PREFIX} floats in the air\nwith its {B_LAST_ITEM}!");
...
static const u8 sText_ReceiverAbilityTakeOver[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nwas taken over!");
...
static const u8 sText_DestinyKnotActivates[] = _("{B_SCR_NAME_WITH_PREFIX} fell in love\nfrom the {B_LAST_ITEM}!");
...
static const u8 sText_DefeatistActivates[] = _("{B_SCR_NAME_WITH_PREFIX} lost the will to fight\nand is ready to run!{PAUSE 22}");
static const u8 sText_PressureActivates[] = _("{B_SCR_NAME_WITH_PREFIX} is exerting its\npressure!");
...
static const u8 sText_DarkAuraActivates[] = _("{B_SCR_NAME_WITH_PREFIX} is radiating\na dark aura!");
static const u8 sText_FairyAuraActivates[] = _("{B_SCR_NAME_WITH_PREFIX} is radiating\na fairy aura!");
static const u8 sText_AuraBreakActivates[] = _("{B_SCR_NAME_WITH_PREFIX} reversed all\nother POKéMON's auras!");
...
static const u8 sText_FetchedPokeBall[] = _("{B_SCR_NAME_WITH_PREFIX} found\na {B_LAST_ITEM}!");
static const u8 sText_BattlerAbilityRaisedStat[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nraised its {B_BUFF1}!");
...
static const u8 sText_MicleBerryActivates[] = _("{B_SCR_NAME_WITH_PREFIX} boosted the accuracy of its\nnext move using {B_LAST_ITEM}!");
static const u8 sText_PkmnShookOffTheTaunt[] = _("{B_SCR_NAME_WITH_PREFIX} shook off\nthe taunt!");
static const u8 sText_PkmnGotOverItsInfatuation[] = _("{B_SCR_NAME_WITH_PREFIX} got over\nits infatuation!");
...
static const u8 sText_RedCardActivate[] = _("{B_SCR_NAME_WITH_PREFIX} held up its {B_LAST_ITEM}\nagainst {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_EjectButtonActivate[] = _("{B_SCR_NAME_WITH_PREFIX} is switched\nout with the {B_LAST_ITEM}!");

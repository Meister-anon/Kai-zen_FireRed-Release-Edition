...
//      "description":  "An exquisitely beautiful gem that\\nhas a blue glow.\\nIt symbolizes honesty.,
    ...
    [ITEM_ULTIMA_BRACE] =
    {
      ...
      .price =  0,
      .holdEffect = HOLD_EFFECT_NONE, //HOLD_EFFECT_POWER_ITEM 
      .holdEffectParam =  0,
...
//      "description":  "An extremely powerful attack.\\nHowever, if the user is hit before\\nusing the move, they will flinch.,
    ...
    [ITEM_TM_TRAILBLAZE] =
    {
      ...
      .itemId = ITEM_TM_TRAILBLAZE,
      .price =  3000,
      .holdEffect = HOLD_EFFECT_NONE,
      .holdEffectParam =  0,
     .description = gTrailBlaze_Description,
//      "description":  "An extremely powerful attack.\\nHowever, if the user is hit before\\nusing the move, they will flinch.,
      .importance = 0,
      .exitsBagOnUse = 0,
      .pocket = POCKET_TM_CASE,
...
//      "description":  "An extremely powerful attack.\\nHowever, if the user is hit before\\nusing the move, they will flinch.,
    ...
    {
      .name = _("TM Flatter"),
      .itemId = ITEM_TM_FLATTER,
      .price =  3000,
      .holdEffect = HOLD_EFFECT_NONE,
      .holdEffectParam =  0,
     .description = gMoveDescription_Flatter,
//      "description":  "An extremely powerful attack.\\nHowever, if the user is hit before\\nusing the move, they will flinch.,
      .importance = 0,
      .exitsBagOnUse = 0,
      .pocket = POCKET_TM_CASE,

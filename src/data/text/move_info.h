...
const u8 gMoveDescription_ConversionZ[MOVE_DESCRIPTION_LENGTH + 5] = _("The user changes\ntype to resist\nthe target best\nas it can.");
...
const u8 gMoveDescription_FeintAttack[MOVE_DESCRIPTION_LENGTH + 5] = _("The user draws up\nclose to the foe\ndisarmingly, then\nhits without fail.");
...
const u8 gMoveDescription_Astonish[MOVE_DESCRIPTION_LENGTH + 5] = _("The user attacks\nwhile screaming in\na startling manner.\nIt also may make\nthe foe flinch.");
...
const u8 gTRICK_ROOM_Description 
    [MOVE_DESCRIPTION_LENGTH + 5] = _("Slower POKéMON get to\nmove first for 5 turns.");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT] = {
    ...
    [MOVE_FEINT_ATTACK ] = gMoveDescription_FeintAttack,
    ...
    [MOVE_SMELLING_SALTS] = gMoveDescription_SmellingSalt,

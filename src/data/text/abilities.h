...
static const u8 sFemmeFataleDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Immune to infatuation or Intimidation.\nAlso blocks flinch taunt and torment.");
...
static const u8 sCacophonyDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Avoids sound-based moves.");
...
static const u8 sMoldBreakerDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Moves hit through abilities.");
static const u8 sSuperLuckDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Critical hits land often.");
static const u8 sAftermathDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Fainting damages foes and lowers foe's speed.\nAlso does reduced effects on switch.");
...
static const u8 sFilterDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Weakens “supereffective” moves.");
static const u8 sSlowStartDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Takes a while to get going.");
static const u8 sScrappyDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Hits Ghost-type Pokémon.\nNormal or Fighting Moves do neutral dmg");
...
static const u8 sPickpocketDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Braces itself, then steals the foe's\nheld item when they make contact.");
static const u8 sMagicianDescription[ABILITY_DESCRIPTION_LENGTH + 1] =_("Steals foe's item when it does dmg.\nSwaps items if user is holding an item.");
static const u8 sSheerForceDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Trades effects for power.");
...
static const u8 sMultiscaleDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Halves damage at full HP.");
...
static const u8 sPranksterDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Status moves go first.");
...
static const u8 sGaleWingsDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Flying moves go first.");
...
static const u8 sPixilateDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Normal moves become Fairy.");
...
static const u8 sTriageDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Healing moves go first.");
...
static const u8 sQueenlyMajestyDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Protects from priority.");
static const u8 sInnardsOutDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Hurts foe when defeated.");
...
static const u8 sNuisanceDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("“Weak attacks” strike first.");
...
static const u8 sUrsurperDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Ups Atk and Sp. Atk. if stats lowered.\nAnd if suffering from status.");
...
static const u8 sFeatherJacketDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Protected from the cold\nby a jacket of downy feathers.");
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_USURPER] = sUrsurperDescription,

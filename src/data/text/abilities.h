...
static const u8 sRattledDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Raises Speed if Intimdated\nor hit by Dark, Bug, or Ghost moves.");
...
static const u8 sStakeoutDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Doubles the power of moves used against\ntargets switched in mid turn."); //vsonic fix description    //Stakeout doubles the power of moves used against targets switched in mid turn.
...
static const u8 sPoisonedLegacyDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Hits POISON type. At 50% ups PSN moves\n& gets 100% toxic on any type if poisons"); //ugly as hell but only way could fit all effets...
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_LINGERING_AROMA] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_SEED_SOWER] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_THERMAL_EXCHANGE] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_ANGER_SHELL] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_PURIFYING_SALT] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_WELL_BAKED_BODY] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_WIND_RIDER] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_GUARD_DOG] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_ROCKY_PAYLOAD] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_WIND_POWER] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_ZERO_TO_HERO] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_COMMANDER] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_ELECTROMORPHOSIS] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_PROTOSYNTHESIS] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_QUARK_DRIVE] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_GOOD_AS_GOLD] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_VESSEL_OF_RUIN] = COMPOUND_STRING("Lowers Sp.Atk by 25% for all mon\nwithout this ability."),
    [ABILITY_SWORD_OF_RUIN] = COMPOUND_STRING("Lowers Defense by 25% for all mon\nwithout this ability."),
    [ABILITY_TABLETS_OF_RUIN] = COMPOUND_STRING("Lowers Speed by 25% for all mon\nwithout this ability."),
    [ABILITY_BEADS_OF_RUIN] = COMPOUND_STRING("Lowers Sp.Def by 25% for all mon\nwithout this ability."),
    [ABILITY_ORICHALCUM_PULSE] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_HADRON_ENGINE] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_OPPORTUNIST] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_CUD_CHEW] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_SHARPNESS] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_SUPREME_OVERLORD] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_COSTAR] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_TOXIC_DEBRIS] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_ARMOR_TAIL] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_EARTH_EATER] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_MYCELIUM_MIGHT] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_HOSPITALITY] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_MINDS_EYE] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_EMBODY_ASPECT_TEAL_MASK] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_EMBODY_ASPECT_HEARTHFLAME_MASK] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_EMBODY_ASPECT_WELLSPRING_MASK] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_EMBODY_ASPECT_CORNERSTONE_MASK] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_TOXIC_CHAIN] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_SUPERSWEET_SYRUP] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_TERA_SHIFT] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_TERA_SHELL] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_TERAFORM_ZERO] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_POISON_PUPPETEER] = COMPOUND_STRING("Spreads with contact."),

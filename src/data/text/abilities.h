...
static const u8 sVoltAbsorbDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Turns incomming electric damage into HP.");
static const u8 sWaterAbsorbDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Turns incomming water damage into HP.\nSlight HP recovery in rain");
...
static const u8 sRainDishDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Moderate HP recovery in rain.");
...
static const u8 sThickFatDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Reduces Heat-and-cold effectiveness.");
...
static const u8 sWhiteSmokeDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Prevents stat drops by foes.");
...
static const u8 sHeatproofDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Lowers effectiveness of Fire and burn.");
static const u8 sSimpleDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Prone to wild stat changes.");
static const u8 sDrySkinDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Prefers moisture to heat. Absorbs water.\nHeals in rain, takes more Dmg from fire."); //removed sunlight hp drop,
...
static const u8 sHydrationDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Cures status ailments and other\nnegative effects in rain."); //buffs still in works
...
static const u8 sQuickFeetDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Ups Speed if statused or Intimdated.\nPrevents loss of speed except from traps.");
...
static const u8 sFilterDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Weakens incoming “Super effective”\nmoves.");
...
static const u8 sHoneyGatherDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("May gather Honey gives off a sweet scent\nRecovers a little HP if holding Honey.");
...
static const u8 sHealerDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("If partner is statused, may attempt to\nheal them. Cures status.");
...
static const u8 sToxicBoostDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Ups Attack if poisoned or has Toxic orb.\nAnd ignores poison damage.");
static const u8 sFlareBoostDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Ups Sp. Atk if burned or has Flame orb.\nAnd ignores burn damage.");
...
static const u8 sInfiltratorDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Stealthily bypasses barriers and walls.\nAlso bypasses Substitute and Disguise.");//adjust for non ghost stealthily bypasses walls and barriers
...
static const u8 sPrimordialSeaDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Calls Primal rain, blocks Fire moves.\nBlock all Non-Primal weather changes."); //primal weather...does a lot more than this
static const u8 sDesolateLandDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Calls Primal sunlight, blocks Water moves\nBlock all Non-Primal weather changes.");
static const u8 sDeltaStreamDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Block all Non-Primal weather changes.\nAlso removes Flying-type weaknesses.");
static const u8 sStaminaDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Boosts Defense when hit.");
static const u8 sWimpOutDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Flees if HP below half after attacking.");
...
static const u8 sCupidsArrowDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Infatuates foes upon switching in.");
...
static const u8 sOceanMemoryDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Recalls a time it dwelled in the sea.\nReduces Damage from Water-type moves.");
...
static const u8 sPhotosynthesizeDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Moderate HP recovery in sun.");
...
static const u8 sToadstoolNymphDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Add STAB on FAIRY moves. A fae blessing\ngiven for devotion to nature.");

...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_VESSEL_OF_RUIN] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_SWORD_OF_RUIN] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_TABLETS_OF_RUIN] = COMPOUND_STRING("Spreads with contact."),
    [ABILITY_BEADS_OF_RUIN] = COMPOUND_STRING("Spreads with contact."),

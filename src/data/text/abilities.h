...
static const u8 sPlusDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Powers up with MINUS on field.\nOr when Electric Partner is in a pinch.");
static const u8 sMinusDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Powers up with PLUS on field.\nOr when Electric Partner is in a pinch.");
...
static const u8 sStallDescription[ABILITY_DESCRIPTION_LENGTH + 1] = _("Always moves last. It bides its time to\ngreatly boost its power.");

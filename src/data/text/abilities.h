...
static const u8 sIceBodyDescription[] = _("Slight HP recovery in Hail.");//for this and regiice ability potentially add frostbite on contact and increase egg hatch time, give freee to regice only
...
static const u8 sHealerDescription[] = _("If partner is statused, 40% chance to\nheal them and cure status.");
...
static const u8 sSymbiosisDescription[] = _("User stores a copy of its allies item.\nIt passes the copy to its ally on use.");

...
//if don't space = from _  causes memory issue...
...
const u8 gItemDescription_ITEM_DRAGON_SCALE[] = _("A thick and tough scale.\nA DRAGON-type may be holding it.\nBoosts SEADRA or HORSEA's Sp. Def.");

const u8 gItemDescription_ITEM_EXP_NULL[] = _("Disclaimer this is not an Exp. Share\nPress {START_BUTTON} on POKéMON or end of\nparty to activate. Nulls EXP gain.");
...
const u8 gItemDescription_ITEM_EXP_SHARE[] = _("Press {START_BUTTON} on POKéMON or end of\nparty to activate. The user gets\na share of EXP. points.");
...
const u8 gItemDescription_ITEM_MENTAL_HERB[] = _("Snaps Pokémon out\nof move-binding\neffects and attraction\nIt can only be used once.");
...
const u8 gItemDescription_ITEM_KINGS_ROCK[] = _("An item to be held by a POKéMON.\nGives moves without flinch\neffect ability to flinch targets.");//modern gives flinch to moves that don't have it natively
...
extern const u8 gQUASH_Description[];
extern const u8 gHONE_CLAWS_Description[];
extern const u8 gMoveDescription_Brine[];
extern const u8 gCHARGE_BEAM_Description[];
extern const u8 gMoveDescription_Endure[];
extern const u8 gDRAGON_PULSE_Description[];
...
extern const u8 gPOISON_JAB_Description[];
...
extern const u8 gTHUNDER_FANG_Description[];
extern const u8 gFIRE_FANG_Description[];
extern const u8 gICE_FANG_Description[];
extern const u8 gMoveDescription_Explosion[];
extern const u8 gSHADOW_CLAW_Description[];
extern const u8 gNIGHT_SLASH_Description[];
extern const u8 gMoveDescription_RazorLeaf[];
extern const u8 gX_SCISSOR_Description[];
extern const u8 gCROSS_POISON_Description[];
extern const u8 gPSYCHO_CUT_Description[];
extern const u8 gMoveDescription_FalseSwipe[];
extern const u8 gMoveDescription_Payback[];
extern const u8 gROCK_POLISH_Description[];
extern const u8 gMoveDescription_MudSport[];
extern const u8 gMoveDescription_WaterSport[];
extern const u8 gAURORA_VEIL_Description[];
extern const u8 gSTONE_EDGE_Description[];
...
extern const u8 gELECTRO_BALL_Description[];
...
extern const u8 gSPEED_SWAP_Description[];
extern const u8 gSTEALTH_ROCK_Description[];
...
extern const u8 gSWARM_Description[];
extern const u8 gMoveDescription_PsychUp[];
extern const u8 gCAPTIVATE_Description[];
extern const u8 gCONFIDE_Description[];
extern const u8 gMoveDescription_FakeTears[];
extern const u8 gACID_SPRAY_Description[];
extern const u8 gDARK_PULSE_Description[];
extern const u8 gMoveDescription_RockThrow[];
extern const u8 gPOWER_GEM_Description[];
...
extern const u8 gGRASS_KNOT_Description[];
...
extern const u8 gFLIP_TURN_Description[];
...
extern const u8 gTRICK_ROOM_Description[];
extern const u8 gMAGIC_ROOM_Description[];
extern const u8 gWONDER_ROOM_Description[];
extern const u8 gMoveDescription_Gravity[];
extern const u8 gDRAINING_KISS_Description[];
extern const u8 gMoveDescription_LeechLife[];
extern const u8 gSTORM_THROW_Description[];
...
extern const u8 gMoveDescription_PsychoBoost[];
extern const u8 gMoveDescription_Flatter[];
...
extern const u8 gSOLAR_BLADE_Description[];
...
extern const u8 gENERGY_BALL_Description[];
extern const u8 gMoveDescription_DoubleEdge[];
extern const u8 gMISTY_EXPLOSION_Description[];
...
const u8 gItemDescription_ITEM_OMNI_BOX[] = _("A unique box that simulates\nstatus effects on POKéMON.\nPress {SELECT_BUTTON} in party to activate.");

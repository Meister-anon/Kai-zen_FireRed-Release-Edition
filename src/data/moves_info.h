...
const struct MoveInfo gMovesInfo[MOVES_COUNT] =
{
    ...
    [MOVE_SOLAR_BEAM] =
    {
        ...
        .sleepTalkBanned = TRUE,
        .instructBanned = TRUE,
       .argument.twoTurnAttack = { .stringId =  STRINGID_PKMNTOOKSUNLIGHT, .status = WEATHER_SUN },
        //.contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING,
        //.contestCategory = CONTEST_CATEGORY_COOL,
        //.contestComboStarterId = 0,
    ...
    [MOVE_FUTURE_SIGHT] =
    {
        ...
        #if UPDATED_MOVE_DATA <= GEN_6 //actually Ill use this since there are no 120 power psychic moves
            .power = 120,
            .accuracy = 100,
            .pp = 10,
        #elif B_UPDATED_MOVE_DATA == GEN_5
    ...
    },//lower than upperhand can be beaten by fast ex speed and accel rock
    ...
    [MOVE_DOODLE] =
    {
        ...
        .priority = 1, //believe safe to raise, best can do is double intimidate foe very niche
        .category = DAMAGE_CATEGORY_STATUS,
        .ignoresProtect = TRUE,
        .metronomeBanned = TRUE,
        .artMove = TRUE,
    ...
    [MOVE_ELECTRO_SHOT] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .argument.twoTurnAttack = { .stringId = STRINGID_ELECTROSHOTCHARGING, .status = WEATHER_RAIN },
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SP_ATK_PLUS_1,
            .self = TRUE,
            .onChargeTurnOnly = TRUE,
    ...
    },//sets heal block but heal block is now side status
    //will just make target both  I guess works cuz sound move

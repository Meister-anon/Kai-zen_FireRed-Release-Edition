const u16 *const gTMHMLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_NIDORAN_F] = sNidoranF_TMHMLearnset,
    [SPECIES_NIDORINA] = sNidorinaTMHMLearnset,
    [SPECIES_NIDOQUEEN] = sNidoqueenTMHMLearnset,
    [SPECIES_NIDORAN_M] = sNidoranM_TMHMLearnset,
    ...
    [SPECIES_SHAYMIN_LAND] = sShayminTMHMLearnset,
    ...
    [SPECIES_UNFEZANT_MALE] = sUnfezantTMHMLearnset,
    ...
    [SPECIES_BASCULIN_RED_STRIPED] = sBasculinTMHMLearnset,
    ...
    [SPECIES_FRILLISH_MALE] = sFrillishTMHMLearnset,
    [SPECIES_JELLICENT_MALE] = sJellicentTMHMLearnset,
    ...
    [SPECIES_TORNADUS_INCARNATE] = sTornadusTMHMLearnset,
    [SPECIES_THUNDURUS_INCARNATE] = sThundurusTMHMLearnset,
    [SPECIES_RESHIRAM] = sReshiramTMHMLearnset,
    [SPECIES_ZEKROM] = sZekromTMHMLearnset,
    [SPECIES_LANDORUS_INCARNATE] = sLandorusTMHMLearnset,
    ...
    [SPECIES_VIVILLON_SNOW] = sVivillonTMHMLearnset,
    [SPECIES_LITLEO] = sLitleoTMHMLearnset,
    [SPECIES_PYROAR_MALE] = sPyroarTMHMLearnset,
    ...
    [SPECIES_MEOWSTIC_MALE] = sMeowsticMaleTMHMLearnset,
    ...
    [SPECIES_PUMPKABOO_AVERAGE_SIZE] = sPumpkabooTMHMLearnset,
    [SPECIES_GOURGEIST_AVERAGE_SIZE] = sGourgeistTMHMLearnset,
    ...
    [SPECIES_ORICORIO_BAILE] = sOricorioTMHMLearnset,
    [SPECIES_CUTIEFLY] = sCutieflyTMHMLearnset,
    [SPECIES_RIBOMBEE] = sRibombeeTMHMLearnset,
    [SPECIES_ROCKRUFF] = sRockruffTMHMLearnset,
    [SPECIES_LYCANROC_MIDDAY] = sLycanrocTMHMLearnset,
    [SPECIES_WISHIWASHI_SOLO] = sWishiwashiTMHMLearnset,
    ...
    [SPECIES_TOXTRICITY_AMPED] = sToxtricityTMHMLearnset,
    ...
    [SPECIES_EISCUE_ICE_FACE] = sEiscueTMHMLearnset,
    [SPECIES_INDEEDEE_MALE] = sIndeedeeMaleTMHMLearnset,
    [SPECIES_MORPEKO_FULL_BELLY] = sMorpekoTMHMLearnset,
    ...
    [SPECIES_URSHIFU_SINGLE_STRIKE_STYLE] = sUrshifuSingleStrikeStyleTMHMLearnset,
    ...
    [SPECIES_BASCULEGION_MALE] = sBasculegionTMHMLearnset,
    [SPECIES_SNEASLER] = sSneaslerTMHMLearnset,
    [SPECIES_OVERQWIL] = sOverqwilTMHMLearnset,
    [SPECIES_ENAMORUS_INCARNATE] = sEnamorusTMHMLearnset,

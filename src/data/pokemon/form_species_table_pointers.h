const u16 *const gFormSpeciesIdTables[NUM_SPECIES] =
{
    ...
    [SPECIES_FRILLISH_MALE] = sFrillishFormSpeciesIdTable,
    [SPECIES_JELLICENT_MALE] = sJellicentFormSpeciesIdTable,
    ...
    [SPECIES_VIVILLON_SNOW] = sVivillonFormSpeciesIdTable,
    ...
    [SPECIES_PUMPKABOO_AVERAGE_SIZE] = sPumpkabooFormSpeciesIdTable,

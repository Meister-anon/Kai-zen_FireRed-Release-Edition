...
static const u8 sItemEffect_Region_Vial[6] = {
    [1] = ITEM1_SET_FORM,
}; //plan setup  effect like vitamins evs are used with array listing
//decied not give friendship boost
...
static const u8 sItemEffect_XSpDef[8] = {
    [2] = 1, //plan for // ITEM2_X_SPADEF   //vsonic value here isn't permanent need to figure out how these are calc to find correct value
    [5] = ITEM5_FRIENDSHIP_LOW | ITEM5_FRIENDSHIP_MID,
    STAT_BOOST_FRIENDSHIP_CHANGE,
};
...
const u8* const gItemEffectTable[] =
{
    ...
    [ITEM_ALOLAN_SAND - ITEM_POTION] = sItemEffect_Region_Vial,
    [ITEM_GALAR_SAND - ITEM_POTION] = sItemEffect_Region_Vial,
    [ITEM_HISUIAN_SAND - ITEM_POTION] = sItemEffect_Region_Vial,
    [ITEM_CEFERIA_SAND - ITEM_POTION] = sItemEffect_Region_Vial,
    ...
    [ITEM_UP_GRADE - ITEM_POTION] = sItemEffect_LeafStone,
    [ITEM_ELECTIRIZER - ITEM_POTION] = sItemEffect_LeafStone,
    [ITEM_MAGMARIZER - ITEM_POTION] = sItemEffect_LeafStone,
    [ITEM_DUBIOUS_DISC - ITEM_POTION] = sItemEffect_LeafStone,
    [ITEM_REAPER_CLOTH - ITEM_POTION] = sItemEffect_LeafStone,
    [ITEM_METAL_COAT - ITEM_POTION] = sItemEffect_LeafStone,    

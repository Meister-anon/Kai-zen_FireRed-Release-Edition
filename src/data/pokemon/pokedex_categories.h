...
const u16 gDexCategory_GrasslandPkmnlist[] = 
{
    SPECIES_RATTATA,
    SPECIES_RATICATE,
    SPECIES_SENTRET,
...
const u16 gDexCategory_CavePkmnlist[] = {
    SPECIES_ZUBAT,
    SPECIES_GOLBAT,
    SPECIES_CROBAT,
...
const u16 gDexCategory_MountainPkmnlist[] = {
    SPECIES_GEODUDE,
    SPECIES_GRAVELER,
    SPECIES_GOLEM,
...
const u16 gDexCategory_RoughTerrainPkmnlist[] = {
    SPECIES_SPEAROW,
    SPECIES_FEAROW,
...
const u16 gDexCategory_UrbanPkmnlist[] = {
    SPECIES_MEOWTH,
    SPECIES_PERSIAN,
    SPECIES_SNUBBULL,
    SPECIES_GRANBULL,
...
//revised setup, instead of copying other struct setup,
//instead uhh use array lists, to put them in proper category and build cat pages that way
//on catch, will not need to be added to a physical cat page which would just be unnecessary bloat
//still need to add rest of post gen 3 species to these lists to finish

...
//total max length is 168
//4 lines max so plus 3 for line total

const u8 gDummyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "This is a newly discovered Pokémon.\n"
    "It is currently under investigation.\n"
    "No detailed information is available\n"
    "at this time.");

const u8 gBulbasaurPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Bulbasaur can be seen napping in bright\n"
    "sunlight. There is a seed on its back.\n"
    "By soaking up the sun's rays, the seed\n"
    "grows progressively larger.");

const u8 gIvysaurPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "To support its bulb, Ivysaur's legs\n"
    "grow sturdy. If it spends more time\n"
    "lying in the sunlight, the bud will\n"
    "soon bloom into a large flower.");

const u8 gVenusaurPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Venusaur's flower is said to take on vivid\n"
    "colors if it gets plenty of nutrition and\n"
    "sunlight. The flower's aroma soothes the\n"
    "emotions of people.");

const u8 gCharmanderPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "The flame that burns at the tip of its\n"
    "tail is an indication of its emotions.\n"
    "The flame wavers when Charmander is\n"
    "happy, and blazes when it is enraged.");

const u8 gCharmeleonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Without pity, its sharp claws destroy\n"
    "foes. If it encounters a strong enemy, it\n"
    "becomes agitated, and the flame on\n"
    "its tail flares with a bluish white color.");

const u8 gCharizardPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A Charizard flies about in search of\n"
    "strong opponents. It breathes intense\n"
    "flames that can melt any material.\n"
    "However, it will never torch weaker foes.");

const u8 gSquirtlePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMetapodPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gButterfreePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It collects honey every day. It rubs\n"       
    "honey onto the hairs on its legs to carry\n"      
    "back to its nest. Its wings, covered\n"
    "with poisonous powders, repel rain.");

const u8 gWeedlePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gKakunaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPidgeottoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPidgeotPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gRattataPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A Rattata is cautious in the extreme.\n"
    "Even while it is asleep, it constantly\n"
    "moves its ears and listens for danger.\n"
    "It will make its nest anywhere.");

const u8 gRaticatePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A Raticate's sturdy fangs grow steadily.\n"
    "To keep them ground down, it gnaws on\n"
    "rocks and logs. It may even chew on the\n"
    "walls of houses.");

const u8 gSpearowPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its loud cry can be heard over half\n"
    "a mile away. If its high, keening cry is\n"
    "heard echoing all around, it is a sign\n"
    "that they are warning of danger.");

const u8 gFearowPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its long neck and elongated beak are\n"
    "ideal for catching prey in soil or water.\n"
    "It deftly moves this extended and skinny\n"
    "beak to pluck prey.");

const u8 gEkansPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gArbokPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPikachuPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It stores electricity in the electric sacs\n"
    "on its cheeks. When it releases pent-up\n"
    "energy in a burst, the electric power is\n"
    "equal to a lightning bolt.");

const u8 gRaichuPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSandshrewPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "When it curls up in a ball, it can make\n"
    "any attack bounce off harmlessly.\n"
    "Its hide has turned tough and solid as\n"
    "a result of living in the desert.");

const u8 gSandslashPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It curls up in a ball to protect itself\n"
    "from enemy attacks. It also curls up\n"
    "to prevent heatstroke during the\n"
    "daytime when temperatures rise sharply.");

const u8 gNidoranFPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its highly toxic barbs are thought to\n"
    "have developed as protection for this\n"
    "small-bodied Pokémon. When enraged, it\n"
    "releases a horrible toxin from its horn.");

const u8 gNidorinaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gNidoqueenPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gNidorinoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its horn is harder than a diamond.\n"
    "If it senses a hostile presence, all the\n"
    "barbs on its back bristle up at once, and\n"
    "it challenges the foe with all its might.");

const u8 gNidokingPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gClefairyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gClefablePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gWigglytuffPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gVileplumePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gParasPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gParasectPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gVenonatPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gVenomothPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDiglettPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDugtrioPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMeowthPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPersianPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A Persian's six bold whiskers sense air\n"
    "movements to determine what is in its\n"
    "vicinity. It becomes docile if grabbed\n"
    "by the whiskers.");

const u8 gPsyduckPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGolduckPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMankeyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPrimeapePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGrowlithePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gArcaninePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "This fleet-footed Pokémon is said to run\n"
    "over 6,200 miles in a single day\n"
    "and night. The fire that blazes wildly\n"
    "within its body is its source of power.");

const u8 gPoliwagPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPoliwhirlPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPoliwrathPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMachokePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gWeepinbellPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gVictreebelPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTentacoolPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTentacruelPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGeodudePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGravelerPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGolemPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPonytaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSlowbroPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its tail has a Shellder firmly attached\n"
    "with a bite. As a result, the tail can't\n"
    "be used for fishing anymore. This forces\n"
    "it to reluctantly swim and catch prey.");

const u8 gMagnemitePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "The units at its sides are extremely\n"
    "powerful magnets. They generate enough\n"
    "magnetism to draw in iron objects from\n"
    "over 300 feet away.");

const u8 gMagnetonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gFarfetchdPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It is always seen with a stick of leek.\n"
    "Apparently, there are good sticks and\n"
    "bad sticks. This Pokémon occasionally\n"
    "fights with others over choice sticks.");

const u8 gDoduoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDewgongPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGrimerPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gShellderPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    ...
    "with its broad tongue to make a place\n"
    "to sleep. While asleep, it closes its\n"
    "shell, but leaves its tongue hanging out.");

const u8 gCloysterPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It swims in the sea by swallowing water,\n"
    "then jetting it out toward the rear.\n"
    "The Cloyster shoots spikes from its\n"
    "shell using the same system.");

const u8 gGastlyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gHaunterPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGengarPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gOnixPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDrowzeePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "If your nose becomes itchy while you are\n"
    "sleeping, it's a sure sign that a Drowzee\n"
    "is standing above your pillow and trying\n"
    "to eat your dream through your nostrils.");

const u8 gHypnoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "The arcing movement and glitter of the\n"
    "pendulum in a Hypno's hand lull the foe\n"
    "into deep hypnosis. While searching for\n"
    "prey, it polishes the pendulum.");

const u8 gKrabbyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gKinglerPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gVoltorbPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gElectrodePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gExeggcutePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gExeggutorPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gCubonePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMarowakPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLickitungPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gKoffingPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gWeezingPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gKangaskhanPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "If you come across a young Kangaskhan\n"
    "playing by itself, never try to catch it.\n"
    "The baby's parent is sure to be in the\n"
    "area, and will become violently enraged.");

const u8 gHorseaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSeadraPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gStaryuPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gStarmiePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMrMimePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A Mr. Mime is a master of pantomime.\n"
    "It can convince others that something\n"
    "unseeable actually exists. Once believed,\n"
    "the imaginary object does become real.");

const u8 gScytherPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gJynxPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Jynx sashays rhythmically as if it were\n"
    "dancing. Its motions are so bouncingly\n"
    "alluring, people seeing it are compelled\n"
    "to shake their hips without noticing.");

const u8 gElectabuzzPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTaurosPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMagikarpPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGyaradosPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLaprasPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gVaporeonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gJolteonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gFlareonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPorygonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gOmanytePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gOmastarPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gKabutoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It is a Pokémon that has been regenerated\n"
    "from a fossil. In rare cases, living\n"
    "examples have been discovered. Kabuto\n"
    "have not changed for 300 million years.");

const u8 gKabutopsPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gAerodactylPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSnorlaxPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gArticunoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMoltresPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    ...
    "can control fire. If injured, it is said\n"
    "to dip its body in the molten magma\n"
    "of a volcano to burn and heal itself.");
...
const u8 gDragonitePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMewtwoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMewPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A Mew is said to possess the genes of all\n"
    "Pokémon. It is capable of making itself\n"
    "invisible at will, so it entirely avoids\n"
    "notice even if it approaches people.");

const u8 gChikoritaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gCyndaquilPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gQuilavaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTyphlosionPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTotodilePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Despite its small body, Totodile's jaws\n"
    "are very powerful. While it may think\n"
    "it is just playfully nipping, its bite has\n"
    "enough strength to cause serious injury.");

const u8 gCroconawPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Once its jaws clamp down on a foe, it will\n"
    "absolutely not let go. Because its fang\n"
...
const u8 gFurretPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A Furret has a very slim build. When under\n"
    "attack, it can squirm through narrow\n"
    "spaces and get away. In spite of its\n"
    "short limbs, it is very nimble and fleet.");

const u8 gHoothootPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gNoctowlPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It unfailingly catches prey in darkness.\n"
    "Noctowl owe their success to superior\n"
    "vision that allows them to see in minimal\n"
    "light, and to their supple silent wings.");

const u8 gLedybaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gAriadosPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gCrobatPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Over the course of evolution, its hind\n"
    "legs turned into wings. By alternately\n"
    "resting its front and rear wings,\n"
    "it can fly all day without having to stop.");

const u8 gChinchouPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTogeticPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It is said to be a Pokémon that brings\n"
    "good fortune. When it spots someone\n"
    "who is pure of heart, a Togetic appears\n"
    "and shares its happiness with that person.");

const u8 gNatuPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gXatuPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMareepPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gFlaaffyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its fleece quality changes to generate\n"
    "strong static electricity with a small\n"
    "amount of wool. The bare, slick parts of\n"
    "its hide are shielded against electricity.");

const u8 gAmpharosPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gBellossomPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMarillPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gAzumarillPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSudowoodoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPolitoedPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gHoppipPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSkiploomPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gJumpluffPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gAipomPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSunkernPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gEspeonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gUmbreonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMisdreavusPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A Misdreavus frightens people with a\n"
    "creepy, sobbing cry. It apparently uses\n"
    "its red spheres to absorb the fear\n"
    "of foes as its nutrition.");

const u8 gUnownPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gWobbuffetPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGirafarigPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPinecoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Pineco hang from tree branches and wait\n"
    "for prey. While eating, if disturbed\n"
    "by someone shaking its tree, it falls\n"
    "the ground and suddenly explodes.");

const u8 gForretressPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDunsparcePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its drill-tipped tail is used to burrow\n"
    "into the ground backwards. This Pokémon\n"
    "is known to make its nest in complex\n"
    "shapes deep under the ground.");

const u8 gGligarPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSteelixPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSnubbullPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGranbullPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It has a particularly well-developed\n"
    "lower jaw. The huge fangs are heavy,\n"
    "causing it to tilt its head. Unless it\n"
    "is startled, it won't try to bite.");

const u8 gQwilfishPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gScizorPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gShucklePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A Shuckle hides under rocks, keeping its\n"
    "body concealed inside its shell while\n"
    "eating stored berries. The berries mix\n"
    "with its body fluids to become a juice.");

const u8 gHeracrossPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSneaselPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTeddiursaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It licks its palms that are sweetened by\n"
    "being soaked in honey. A Teddiursa makes\n"
    "its own honey by blending fruits and\n"
    "pollen collected by Beedrill.");

const u8 gUrsaringPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSwinubPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPiloswinePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gCorsolaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Corsola live in warm southern seas.\n"
    "If the sea becomes polluted, the\n"
    "beautiful coral stalks become discolored\n"
    "and crumble away in tatters.");

const u8 gRemoraidPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gOctilleryPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDelibirdPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPorygon2PokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gStantlerPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Stantler's magnificent antlers were once\n"
    "traded at high prices as works of art.\n"
    "As a result, this Pokémon was hunted\n"
    "close to extinction.");

const u8 gSmearglePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTyroguePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gHitmontopPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMagbyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "If a Magby is spouting yellow flames\n"
    "from its mouth, it is in good health.\n"
    "When it is fatigued, black smoke\n"
    "will be mixed in with the flames.");

const u8 gMiltankPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It gives over five gallons of milk daily.\n"
    "Its sweet milk is enjoyed by children and\n"
    "grown-ups alike. People who can't drink\n"
    "milk turn it into yogurt to eat instead.");

const u8 gBlisseyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "If it senses sadness with its fluffy fur,\n"
    "a Blissey will rush over to the person,\n"
    "however far away, to share an egg of\n"
    "happiness that brings a smile to any face.");

const u8 gRaikouPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gEnteiPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSuicunePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLarvitarPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A Larvitar is born deep under the ground.\n"
    "It must eat its way through the\n"
    "soil above and reach the surface\n"
    "for it to see its parents' faces.");

const u8 gPupitarPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTyranitarPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLugiaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Lugia is so powerful even a light\n"
    "fluttering of its wings can blow apart\n"
    "houses. As a result, it chooses to\n"
    "live out of sight deep under the sea.");

const u8 gHoOhPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its feathers--which glow in seven colors\n"
    "depending on the angle at which they are\n"
    "struck by light--are thought to bring joy.\n"
    "Its said to live at the foot of a rainbow.");

const u8 gCelebiPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTreeckoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGrovylePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Leaves grow out of this Pokémon's body.\n"
    "They help obscure a Grovyle from the\n"
    "eyes of its enemies while it\n"
    "is in a thickly overgrown forest.");

const u8 gSceptilePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTorchicPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMudkipPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "On land, it can powerfully lift large\n"
    "boulders by planting its four feet and\n"
    "heaving. It sleeps by burying itself\n"
...
const u8 gPoochyenaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMightyenaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "In the wild, Mightyena live in a pack.\n"
    "They never defy their leader's orders.\n"
    "They defeat foes with perfectly\n"
    "coordinated teamwork.");

const u8 gZigzagoonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDustoxPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLotadPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLombrePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "In the evening, it takes great delight in\n"
    "popping out of rivers to startle people.\n"
    "It feeds on aquatic moss that grows on\n"
    "rocks in the riverbed.");

const u8 gLudicoloPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSeedotPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It hangs off branches and absorbs\n"
    "nutrients. When it finishes eating, its\n"
    "body becomes so heavy that it drops to\n"
    "the ground with a thump.");

const u8 gNuzleafPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A forest-dwelling Pokémon that is skilled\n"
    "at climbing trees. Its long and pointed\n"
    "nose is its weak point. It loses power if\n"
    "the nose is gripped.");

const u8 gShiftryPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It is said to arrive on chilly, wintry\n"
    "wind. Feared from long ago as the guardian\n"
    "in forests, this Pokémon lives in a deep\n"
    "forest where people do not venture.");

const u8 gNincadaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTaillowPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Although small, its very courageous.\n"
    "It will take on a larger Skarmory on\n"
    "equal footing. However, its will weakens\n"
    "if it becomes hungry.");

const u8 gSwellowPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Swellow dive upon prey from far above\n"
    "and never misses their targets.\n"
    "It takes to the skies in search of\n"
    "lands with a warm climate.");

const u8 gShroomishPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSurskitPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gWailmerPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "While this Pokémon usually lives in the\n"
    "sea, it can survive on land, although\n"
    "not too long. It loses vitality if\n"
    "its body becomes dried out.");

const u8 gWailordPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It breathes through nostrils that it\n"
    "raises above the sea. By inhaling to its\n"
    "maximum capacity, Wailord can dive\n"
    "close to 10,000 feet beneath the waves.");

const u8 gSkittyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
//realized was missing my custom entries 
//so pulled these from other repo
const u8 gDelcattyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gKecleonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A Pokémon that has the ability to alter\n"
    "its body colors to match its surroundings.\n"
    "A Kecleon reverts to its original colors\n"
    "if it is startled.");

const u8 gBaltoyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A Baltoy moves by spinning on its single\n"
    "foot. It has been depicted in murals \n"
    "adorning the walls of a once-bustling city\n"
    "in an ancient age.");

const u8 gClaydolPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSableyePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It digs branching holes in caves using its\n"
    "sharp claws in search of food--raw gems.\n"
    "A Sableye lurks in darkness and is seen\n"
    "only rarely.");

const u8 gBarboachPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its body is covered with a slimy film.\n"
    "The film acts as a barrier to prevent\n"
    "germs in muddy water from entering the\n"
    "Barboach's body.");

const u8 gWhiscashPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLuvdiscPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gFeebasPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMiloticPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gCarvanhaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Carvanha attack ships in swarms, making\n"
    "them sink. Although it is said to be\n"
    "a very vicious Pokémon, it timidly\n"
    "flees as soon as it finds itself alone.");

const u8 gSharpedoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTrapinchPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMakuhitaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It loves to toughen up its body above\n"
    "all else. If you hear quaking rumbles\n"
    "in a cave, it is the sound of Makuhita\n"
    "undertaking strenuous training.");

const u8 gHariyamaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gElectrikePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It generates electricity using friction\n"
    "from the atmosphere. In seasons with\n"
    "especially arid air, its entire body\n"
...
const u8 gNumelPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    ...
    "on its back. It is a hardy Pokémon that\n"
    "can transport a 220-pound load. It has\n"
    "served humans at work since long ago.");

const u8 gCameruptPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGlaliePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLunatonePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It becomes very active on the night of\n"
    "a full moon. This Pokémon was first\n"
    "discovered 40 years ago at the site of\n"
    "a meteor strike.");

const u8 gSolrockPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Solar energy is the source of this \n"
    "Pokémon's power. On sunny days, groups of\n"
    "Solrock line up facing the sun and absorb\n"
    "its light.");

const u8 gAzurillPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its tail, which is packed with nutrition,\n"
    "is very bouncy like a rubber ball.\n"
    "On sunny days they gather at the edge\n"
    "of water and splash about for fun.");

const u8 gSpoinkPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "The shock of bouncing makes its heart\n"
    "pump. It doesn't stop bouncing even when\n"
    "it is asleep. It loves eating mushrooms\n"
    "that grow underground.");

const u8 gGrumpigPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPluslePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMinunPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMawilePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMedititePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It continually meditates for hours every\n"
    "day. As a result of rigorous and\n"
    "dedicated yoga training, it has tempered\n"
    "its spiritual power so much it can fly.");

const u8 gMedichamPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Through crushingly harsh yoga training, it\n"
    "gained great internal strength, and the\n"
    "power to foretell its foe's actions. It\n"
    "battles with elegant, dance-like movement.");

const u8 gSwabluPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gAltariaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It hums in a beautiful soprano voice.\n"
    "It flies among white clouds in the blue\n"
    "sky. It launches intensely hot fireballs\n"
    "from its mouth.");

const u8 gWynautPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A Wynaut loves to eat sweet fruits.\n"
    "It cleverly picks fruits using its earlike\n"
    "arms. They gather in fruit gardens, drawn\n"
    "by the fragrance.");

const u8 gDuskullPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A glare from its single scarlet eye makes\n"
    "even grown-ups freeze in utter fear.\n"
    "It is a nocturnal Pokémon that roams\n"
    "about under the cloak of darkness.");

const u8 gDusclopsPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It is thought that its body is hollow\n"
    "with only a spectral ball of fire burning\n"
    "inside. However, no one has been\n"
    "able to confirm this theory as fact.");

const u8 gRoseliaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gVigorothPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    ...
    "boils with energy. It runs through the\n"
    "fields and mountains all day to calm\n"
    "itself. Otherwise, it can't sleep at night.");
...
const u8 gSwalotPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its powerful stomach acid is capable of\n"
    "digesting almost anything. The one thing\n"
    "in the whole world a Swalot can't\n"
    "digest is its own stomach.");

const u8 gTropiusPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gWhismurPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLoudredPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It positions the round speakers on its\n"
    "head to assail foes with ultrasonic waves\n"
    "at massive volume. It builds power by\n"
    "stomping the ground.");

const u8 gExploudPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It has sound-generating organs all over\n"
    "its body. It communicates with others by\n"
    "adjusting the tone and volume of the\n"
    "cries it emits.");

const u8 gClamperlPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A Clamperl slams its shell closed on prey\n"
    "to prevent escape. The pearl it creates\n"
    "upon evolution is said to be infused with\n"
    "a mysterious energy.");

const u8 gHuntailPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "To withstand the crushing pressure deep\n"
    "under the sea, its spine is very thick\n"
    "and sturdy. Its tail, which is shaped like\n"
    "a small fish, has eyes that light up.");

const u8 gGorebyssPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A Gorebyss siphons the body fluids\n"
    "of prey through its thin, tubular mouth.\n"
    "Its light pink body color turns vivid\n"
    "when it finishes feeding.");

/*Although Gorebyss is the very picture of
 elegance and beauty while swimming,
  it is also cruel. When it spots prey,
   this Pokémon inserts its thin mouth into the prey's
    body and drains the prey of its body fluids.*/

const u8 gAbsolPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSeviperPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gRelicanthPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    ...
    "its form for 100 million years. It walks\n"
    "on the seafloor using its pectoral fins.");

const u8 gAronPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "This Pokémon is clad in steel armor. A\n"
    "new suit of armor is made when it evolves\n"
    "The old, discarded armor is salvaged\n"
    "as metal for making iron products.");

const u8 gLaironPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gAggronPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gCastformPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gVolbeatPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gIllumisePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLileepPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gCradilyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It drags its heavy body along the\n"
    "seafloor. It makes its nest in the\n"
    "shallows of warm seas. Cradily can be\n"
    "seen on beaches when the tide goes out.");

const u8 gAnorithPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMetagrossPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Metagross has four brains that are joined\n"
    "by a complex neural network. As a result\n"
    "of integration, this Pokémon is smarter\n"
    "than a supercomputer.");

const u8 gRegirockPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A Pokémon that is made entirely of rocks\n"
    "and boulders. If parts of its body\n"
    "chip off in battle, Regirock repairs\n"
    "itself by adding new rocks.");

const u8 gRegicePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its entire body is made of Antarctic ice.\n"
    "After extensive studies, researchers\n"
    "believe the ice was formed during an\n"
    "ice age.");

const u8 gRegisteelPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gKyogrePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLatiosPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gJirachiPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Jirachi is said to make wishes come true.\n"
    "While it sleeps, a tough crystalline shell\n"
    "envelops the body to protect it from\n"
    "enemies.");

const u8 gDeoxysPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Deoxys emerged from a virus that came\n"
    "from space. It is highly intelligent and\n"
    "can shoot lasers from the crystalline\n"
    "organ on its chest.");

const u8 gChimechoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "They fly about very actively when\n"
    "the hot season arrives. They communicate\n"
    "among themselves using seven different\n"
    "and distinguishing cries.");

const u8 gTurtwigPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gChimcharPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMonfernoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gInfernapePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPiplupPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "This Pokémon often falls down. However,\n"
    "its strong pride makes it puff its chest\n"
    "without a care. It's difficult to bond\n"
    "with since it won't listen to its Trainer.");

const u8 gPrinplupPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Because every Prinplup considers itself\n"
    "to be the most important, they can never\n"
    "form a group. It searches for prey in\n"
    "icy seas.");

const u8 gEmpoleonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gStarlyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gStaraviaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gStaraptorPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "When Staravia evolve into Staraptor, they\n"
    "leave the flock to live alone. It has\n"
    "a savage nature. It will courageously\n"
    "challenge foes that are much larger.");

const u8 gBidoofPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gBibarelPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gKricketotPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gBudewPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gRoseradePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gShieldonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gBastiodonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gBurmyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gWormadamPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gVespiquenPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPachirisuPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gBuizelPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gFloatzelPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its flotation sac developed as a result\n"
    "of pursuing aquatic prey. It can double\n"
    "as a rubber raft. It assists in the\n"
    "rescues of drowning people.");

const u8 gCherubiPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gCherrimPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gShellosPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGastrodonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gAmbipomPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLopunnyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMismagiusPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its cries sound like incantations.\n"
    "Those hearing it are tormented by\n"
    "headaches and hallucinations.\n"
    "It appears where you least expect it.");

const u8 gHonchkrowPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGlameowPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPuruglyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gChinglingPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gBronzongPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gBonslyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMimeJrPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSpiritombPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGarchompPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gHippopotasPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Hippopotas shuts its nostrils tight when\n"
    "travelling through sand. Instead of\n"
    "perspiration, it expels grains of sand\n"
    "from its body.");

const u8 gHippowdonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSkorupiPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDrapionPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Possessing a sturdy build, it takes\n"
    "pride in its strength. It has the power\n"
    "in its clawed arms to make scrap\n"
    "out of a car.");

const u8 gCroagunkPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gToxicroakPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Swaying and dodging the attacks\n"
    "of its foes, it weaves its flexible body\n"
    "in close, then lunges out with its\n"
    "poisonous claws.");

const u8 gCarnivinePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSnoverPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gAbomasnowPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gWeavilePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMagnezonePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLickilickyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gRhyperiorPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMagmortarPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGlaceonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGliscorPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Gliscor observes prey while hanging\n"
    "upside down from branches. Its flight is\n"
    "soundless. When the chance presents\n"
    "itself, it swoops!");

const u8 gMamoswinePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPorygonZPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGalladePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gProbopassPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It freely controls three units called\n"
    "Mini-Noses using magnetic force.\n"
    "With them, it can attack its foes from\n"
    "three directions.");

const u8 gDusknoirPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gUxiePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMespritPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gAzelfPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDialgaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPalkiaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gHeatranPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gRegigigasPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "There is an enduring legend that\n"
    "states this Pokémon shaped Regirock,\n"
    "Regice, and Registeel out of clay, ice,\n"
    "and magma.");

const u8 gGiratinaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gCresseliaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Those who sleep holding one of\n"
    "Cresselia's feathers are assured of\n"
    "joyful dreams. It is said to represent\n"
    "the crescent moon.");

const u8 gPhionePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gServinePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSerperiorPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gOshawottPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDewottPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSamurottPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPatratPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSimisearPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPanpourPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSimipourPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMunnaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "This Pokémon appears before people\n"
    "and Pokémon who are having nightmares\n"
    "and eats those dreams. Munna always\n"
    "float in the air. ");

const u8 gMusharnaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gRoggenrolaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "The hexagonal cavity is its ear.\n"
    "It walks in the direction of sounds it\n"
    "hears, but if the sounds cease, it panics\n"
    "and topples over.");

const u8 gBoldorePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGigalithPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gWoobatPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gAudinoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTimburrPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGurdurrPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gConkeldurrPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTympolePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPalpitoadPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSeismitoadPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSewaddlePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSwadloonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Forests where Swadloon live have\n"
    "superb foliage because the nutrients\n"
    "they make from fallen leaves nourish\n"
    "the plant life.");

const u8 gLeavannyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gVenipedePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gWhirlipedePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gScolipedePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gCottoneePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "When it finds others of its kind, they all\n"
    "stick together. When enough of them\n"
    "have collected, the mass resembles a\n"
    "cumulonimbus cloud.");

const u8 gWhimsicottPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPetililPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gKrookodilePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Very violent Pokémon, they never allow\n"
    "their prey to escape. Their jaws are so\n"
    "powerful, they can crush the body of\n"
    "an automobile.");

const u8 gDarumakaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDarmanitanPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMaractusPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gScraftyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSigilyphPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gYamaskPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gCofagrigusPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTirtougaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gCarracostaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGarbodorPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gZoruaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gZoroarkPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMinccinoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gCinccinoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDuosionPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "When their brains, now divided in two,\n"
    "are thinking the same thoughts,\n"
    "these Pokémon exhibit their maximized\n"
    "psychic power.");

const u8 gReuniclusPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDucklettPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSwannaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gVanilluxePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDeerlingPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSawsbuckPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gEmolgaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gKarrablastPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gEscavalierPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gFoongusPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gAlomomolaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gJoltikPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGalvantulaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gKlangPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gKlinklangPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its red core functions as an energy tank.\n"
    "It is rotated at high speed for a rapid\n"
    "energy charge. It fires the charged\n"
    "energy through its spikes into an area.");

const u8 gTynamoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gEelektrikPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gBeheeyemPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLitwickPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "While Litwick shines a light and pretends\n"
    "to be a guide, it absorbs the life force\n"
    "of any who follow it, which becomes\n"
    "the fuel that it burns.");

const u8 gLampentPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gChandelurePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gAxewPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gFraxurePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gBearticPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gCryogonalPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gShelmetPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gAccelgorPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "When its body dries out, it weakens. So,\n"
    "to prevent dehydration, it wraps itself in\n"
    "layers of thin membrane. It is very light\n"
    "and fights with ninja-like movements.");

const u8 gStunfiskPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGolettPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGolurkPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPawniardPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Ignoring their injuries, groups attack by\n"
    "sinking the blades that cover their bodies\n"
    "into their prey. If battling dulls them,\n"
    "it sharpens them on stones by the river.");

const u8 gBisharpPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDeinoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gZweilousPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gHydreigonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLarvestaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gVolcaronaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "When volcanic ash darkened the\n"
    "atmosphere, it appeared and saved\n"
    "Pokémon from freezing, Volcarona's fire\n"
    "provided a replacement for the sun.");

const u8 gCobalionPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTerrakionPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gVirizionPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its head sprouts horns sharp as blades.\n"
    "Legends say this Pokémon used\n"
    "whirlwind-like movements to confound\n"
    "and swiftly cut its opponents.");

const u8 gTornadusPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gThundurusPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gReshiramPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gZekromPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLandorusPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "The energy that comes pouring from its\n"
    "tail increases the nutrition in the soil,\n"
    "making crops grow to great size. Its been\n"
    "hailed as “The Guardian of the Fields.”");

const u8 gKyuremPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "This legendary ice Pokémon waits for a\n"
    "hero to fill in the missing parts of its\n"
    "body with truth or ideals. Its body\n"
    "became frozen when its energy leaked out.");

const u8 gKeldeoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "When it is resolute, its body fills with\n"
    "power and it becomes swifter. It crosses\n"
    "the world, running over the surfaces of\n"
    "oceans and rivers.");

const u8 gMeloettaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGenesectPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gChespinPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gQuilladinPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gChesnaughtPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gFennekinPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gBraixenPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDelphoxPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gFroakiePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gFrogadierPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDiggersbyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gFletchlingPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gScatterbugPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLitleoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "They set off on their own from their pride\n"
    "and live by themselves to become strong.\n"
    "These hot-blooded Pokémon are quick\n"
    "to start a fight.");

const u8 gPyroarPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gFlorgesPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It claims exquisite flower gardens as its\n"
    "territory. In times long past, governors\n"
    "of castles would invite Florges to create\n"
    "gardens to embellish the castle domains.");

const u8 gSkiddoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGogoatPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It can tell how its trainer is feeling by\n"
    "subtle shifts in the grip on its horns.\n"
    "This empathetic sense lets them run as one\n"
    "being. They inhabit mountainous regions.");

const u8 gPanchamPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPangoroPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It boasts superb physical strength.\n"
    "Those who wish to become Pangoro's\n"
    "Trainer have no choice but to converse\n"
    "with their fists.");

const u8 gFurfrouPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gEspurrPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMeowsticPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gHonedgePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "If anyone dares to grab its hilt, it\n"
    "wraps a blue cloth around that person's\n"
    "arm and drains that person's life\n"
    "energy completely.");

const u8 gDoubladePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gAromatissePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its scent is so overpowering that,\n"
    "unless a Trainer happens to really enjoy\n"
    "the smell, he or she will have a hard\n"
    "time walking alongside it.");

const u8 gSwirlixPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMalamarPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDragalgePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gClauncherPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Through controlled expulsions of internal\n"
    "gas, it can expel water like a pistol.\n"
    "At close distances, it can even shatter\n"
    "large rocks.");

const u8 gClawitzerPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gHelioptilePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "They make their home in deserts.\n"
    "They can generate their own energy from\n"
    "basking in the sun, so eating food is not\n"
    "a requirement.");

const u8 gHelioliskPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTyruntPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTyrantrumPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Thanks to its gargantuan jaws, which\n"
    "could shred thick metal plates as if they\n"
    "were paper, it was invincible in\n"
    "the ancient world it once inhabited.");

const u8 gAmauraPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "This ancient Pokémon was restored from\n"
    "part of its body that had been frozen in\n"
    "ice for over 100 million years. It lived\n"
    "in tundra where there were no predators.");

const u8 gAurorusPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Using the diamond-shaped crystals on its\n"
    "body it can instantly create a wall\n"
    "of ice to block an opponent's attack,\n"
...
const u8 gTrevenantPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPumpkabooPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGourgeistPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gBergmitePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gAvaluggPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gNoibatPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gNoivernPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "They fly around on moonless nights and\n"
    "attack careless prey. The ultrasonic\n"
    "waves it emits from its ears\n"
    "can reduce a large boulder to pebbles.");

const u8 gXerneasPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gYveltalPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gZygardePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDianciePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gVolcanionPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It lets out billows of steam from the\n"
    "arms on its back and disappears into the\n"
    "dense fog. It's said to live in mountains\n"
    "where humans do not tread.");

const u8 gRowletPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLittenPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTorracatPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "At its throat, it bears a bell of fire.\n"
    "The bell rings brightly whenever this\n"
    "Pokémon spits fire. With a single punch,\n"
    "it can bend an iron bar right over.");
...
const u8 gTrumbeakPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gToucannonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGrubbinPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "They often gather near places frequented\n"
    "by electric Pokémon in order to avoid\n"
    "being attacked by bird Pokémon,\n"
    "though it normally lives underground.");

const u8 gCharjabugPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gVikavoltPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gCrabrawlerPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gCrabominablePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It aimed for the top but got lost and\n"
    "ended up on a snowy mountain. Forced\n"
    "to endure the cold, this Pokémon evolved\n"
    "and grew thick fur.");

const u8 gOricorioPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Oricorio can change its body by sipping\n"
    "different coloured nectar. It's enemies'\n"
    "hearts melt at the sight of its varying,\n"
    "beautiful dances.");

const u8 gCutieflyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Myriads of Cutiefly flutter above the\n"
    "heads of people who have auras\n"
    "resembling those of flowers. It can\n"
    "identify which flowers are about to bloom.");

const u8 gRibombeePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gRockruffPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMareaniePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gToxapexPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMudbrayPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMudsdalePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its heavy, mud-covered kicks are its\n"
    "best means of attack, and it can reduce\n"
    "large trucks to scrap without breaking\n"
    "a sweat.");

const u8 gDewpiderPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It crawls onto the land in search of \n"
    "food. When it comes across enemies or\n"
    "potential prey, this Pokémon smashes its\n"
    "water-bubble-covered head into them.\n"
    "");

const u8 gAraquanidPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Despite what its appearance suggests,\n"
    "it cares for others. If it finds\n"
    "vulnerable Pokémon, it protectively\n"
    "brings them into its water bubble.");

const u8 gFomantisPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "During the day, it sleeps and soaks up\n"
    "light. They give off a sweet, refreshing\n"
    "scent. Cutiefly often gather near the\n"
    "tall grass where Fomantis are hiding.");

const u8 gLurantisPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It requires a lot of effort to maintain\n"
    "Lurantis's vivid coloring, but some\n"
    "collectors enjoy this work and treat it\n"
    "as their hobby.");

const u8 gMorelullPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gShiinoticPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSalanditPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSalazzlePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gStuffulPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gComfeyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gOranguruPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPassimianPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTypeNullPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSilvallyPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMiniorPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gDhelmisePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gJangmooPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gHakamooPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTapuLelePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTapuBuluPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gTapuFiniPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSolgaleoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gLunalaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "When its third eye activates, it flies\n"
    "to another world. This Pokémon devours\n"
    "light, drawing the moonless dark veil of\n"
    "night over the brightness of day.");

const u8 gNihilegoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gBuzzwolePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGuzzlordPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gNecrozmaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMagearnaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gMarshadowPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gRookideePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gCorvisquirePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Smart enough to use tools in battle,\n"
    "these Pokémon have been seen picking up\n"
    "rocks and flinging them or using ropes\n"
    "to wrap up enemies.");

const u8 gCorviknightPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gEldegossPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gApplinPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gBarraskewdaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gToxelPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gToxtricityPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "When this Pokémon sounds as if it's\n"
    "strumming a guitar, it's actually clawing\n"
    "at the protrusions on its chest to\n"
    "generate electricity.");

const u8 gSizzlipedePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It stores flammable gas in its body and\n"
    "uses it to generate heat. \n"
    "The yellow sections on its belly\n"
    "get particularly hot.");

const u8 gCentiskorchPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gClobbopusPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gGrimmsnarlPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "With the hair wrapped around its body\n"
    "helping to enhance its muscles, this\n"
    "Pokémon can overwhelm even Machamp.");

const u8 gObstagoonPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gPerrserkerPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "What appears to be an iron helmet is\n"
    "actually hardened hair. This Pokémon\n"
    "lives for the thrill of battle.");

const u8 gCursolaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSirfetchdPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Only Farfetch'd that have survived many\n"
    "battles can attain this evolution. When\n"
    "this Pokémon's leek withers, it will\n"
    "retire from combat.");

const u8 gMrRimePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It's highly skilled at tap-dancing. It\n"
    "waves its cane of ice in time with its\n"
    "graceful movements.");

const u8 gRunerigusPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "A powerful curse was woven into an\n"
    "ancient painting. After absorbing the\n"
    "spirit of a Yamask, the painting\n"
    "began to move.");

const u8 gMilceryPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "This Pokémon was born from sweet-smelling\n"
    "particles in the air. Its body is made\n"
    "of cream.");

const u8 gAlcremiePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "When it trusts a Trainer, it will treat\n"
    "them to berries it's decorated with cream.");

const u8 gFalinksPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Five of them are troopers, and one is the\n"
    "brass. The brass's orders are absolute.");

const u8 gPincurchinPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It feeds on seaweed, using its teeth to\n"
    "scrape it off rocks. Electric current\n"
    "flows from the tips of its spines.");

const u8 gSnomPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gFrosmothPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gStonjournerPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It stands in grasslands, watching the\n"
    "sun's descent from zenith to horizon. This\n"
    "Pokémon has a talent for delivering\n"
    "dynamic kicks.");

const u8 gEiscuePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It drifted in on the flow of ocean waters\n"
    "from a frigid place. It keeps its head\n"
    "iced constantly to make sure it stays\n"
    "nice and cold.");

const u8 gIndeedeePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "It uses the horns on its head to sense\n"
    "the emotions of others. Males will\n"
    "act as valets for those they serve,\n"
    "looking after their every need.");

const u8 gMorpekoPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gZarudePokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gRegielekiPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gKleavorPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gUrsalunaPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Swampy terrain gives Ursaluna its burly\n"
    "physique and newfound capacity to\n"
    "manipulate peat at will.");

const u8 gBasculegionPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gSneaslerPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
...
const u8 gOverqwilPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(
    "Its lancelike spikes and savage\n"
    "temperament have earned it the\n"
    "nickname “Sea Fiend”.\n"
    "It slurps up poison to nourish itself.");

const u8 gEnamorusPokedexText[DEX_ENTRY_MAX_LENGTH + 3] = _(

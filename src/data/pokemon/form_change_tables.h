...
static const struct FormChange sCastformFormChangeTable[] =
{
    ...
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_CASTFORM_SNOWY, WEATHER_COLD_ANY, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_CASTFORM_NORMAL, ~(WEATHER_SUN | WEATHER_RAIN | WEATHER_COLD_ANY), ABILITY_FORECAST},
    ...
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_CASTFORM_SNOWY, WEATHER_COLD_ANY},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_CASTFORM_NORMAL, ~(WEATHER_SUN | WEATHER_RAIN | WEATHER_COLD_ANY)},
...
{
    {FORM_CHANGE_ITEM_USE, SPECIES_SILVALLY_NORMAL,   ITEM_NULL_MEMORY},
...
{
    {FORM_CHANGE_BATTLE_WEATHER,                   SPECIES_EISCUE_ICE_FACE,   WEATHER_COLD_ANY, ABILITY_ICE_FACE},

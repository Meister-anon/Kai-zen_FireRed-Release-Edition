...
static const struct FormChange sCastformFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_SUNNY, WEATHER_SUN_ANY, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_RAINY, WEATHER_RAIN_ANY, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_SNOWY, WEATHER_HAIL_ANY, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM, ~(WEATHER_SUN_ANY | WEATHER_RAIN_ANY | WEATHER_HAIL_ANY), ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM, ENUM_WEATHER_NONE, ABILITY_FORECAST},

    {FORM_CHANGE_BATTLE_SWITCH,                 SPECIES_CASTFORM},
    {FORM_CHANGE_FAINT,                         SPECIES_CASTFORM},
    {FORM_CHANGE_END_BATTLE,                    SPECIES_CASTFORM},
    {FORM_CHANGE_TERMINATOR}, 
}; //don't need this think
...
static const struct FormChange sCherrimFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CHERRIM_SUNSHINE, WEATHER_SUN_ANY, ABILITY_FLOWER_GIFT},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CHERRIM, ~WEATHER_SUN_ANY, ABILITY_FLOWER_GIFT},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CHERRIM, ENUM_WEATHER_NONE, ABILITY_FLOWER_GIFT},
...
/*#if I_GRISEOUS_ORB_FORM_CHANGE < GEN_9
    ...
    {FORM_CHANGE_TERMINATOR},
}; //changed to not need item? look into
...
static const struct FormChange sSilvallyFormChangeTable[] = {
    //{FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY,          ITEM_NONE,            ABILITY_RKS_SYSTEM}, //won't need this

#define LEVEL_UP_MOVE(lvl, moveLearned) {.level = lvl, .move = moveLearned}
//((lvl << 9) | move)
#define LEVEL_UP_MOVE_ID   0x01FF   //these 2 no longer used as not using bit logic, replalced with u16 struct
#define LEVEL_UP_MOVE_LV   0xFE00
#define LEVEL_UP_END       0xFFFF //will need to comb learnsets below chimecho for updates later
//EXPANDED MAX_LEVEL_UP_MOVES from 20 to 35   can learn more moves at lower intervals but with eventual move relearner also good to just add more level 1 moves
// below normal ones
//for evos
...
static const struct LevelUpMove sPidgeotLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_SONIC_BOOM),  //NEW move
    LEVEL_UP_MOVE(1, MOVE_TACKLE),
    LEVEL_UP_MOVE(1, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE(1, MOVE_GUST),
    LEVEL_UP_MOVE(1, MOVE_QUICK_ATTACK),
...
static const struct LevelUpMove sPikachuLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(42, MOVE_EERIE_IMPULSE), //for test but may keep
...
//actually think can bring down most of learnset but elevate slash 
//would give much more utility and none of the moves are really that good to be that high
//slash would be the equivalent of the evo move
...
static const struct LevelUpMove sZubatLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(6, MOVE_SPOOK),
    LEVEL_UP_MOVE(10, MOVE_SONIC_SCREECH),
    ...
    LEVEL_UP_MOVE(41, MOVE_TOXIC_FANG),
...
static const struct LevelUpMove sGolbatLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(49, MOVE_TOXIC_FANG),
    LEVEL_UP_MOVE(56, MOVE_HAZE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMagnemiteLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_SUPERSONIC),
    LEVEL_UP_MOVE(16, MOVE_SONIC_SCREECH),
...
static const struct LevelUpMove sVoltorbLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(1, MOVE_MIRROR_SHOT),  //add these moves in line somewhere
...
static const struct LevelUpMove sTangelaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(34, MOVE_ANCIENT_POWER),//since bulkier and stronger moved higher
...
static const struct LevelUpMove sMrMimeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_MAGIC_COAT), //IS NOW a screen so added
...
static const struct LevelUpMove sYanmaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(17, MOVE_SONIC_SCREECH),
...
static const struct LevelUpMove sHoundourLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(22, MOVE_FAINT_ATTACK),
    LEVEL_UP_MOVE(31, MOVE_FLAMETHROWER), //gets same level charmander does
...
static const struct LevelUpMove sSmeargleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_MONOTYPE),
    LEVEL_UP_MOVE(21, MOVE_MONOTYPE),
    LEVEL_UP_MOVE(31, MOVE_MONOTYPE),
    LEVEL_UP_MOVE(41, MOVE_MONOTYPE),
    LEVEL_UP_MOVE(51, MOVE_MONOTYPE),
    LEVEL_UP_MOVE(61, MOVE_MONOTYPE),
    LEVEL_UP_MOVE(71, MOVE_MONOTYPE),
    LEVEL_UP_MOVE(81, MOVE_MONOTYPE),
    LEVEL_UP_MOVE(91, MOVE_MONOTYPE),
    LEVEL_UP_END
};
...
//instead add more moves to learnset to extend viability i.e bulk up
//agility, quick attack etc. counter?
...
//think these were for the unown letters? pretty sure I can remove
...
static const struct LevelUpMove sMawileLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_TOXIC_FANG),
...
static const struct LevelUpMove sVigorothLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_SLASH),
    LEVEL_UP_MOVE(35, MOVE_FLAME_CHARGE),   //JUST trolly things
    LEVEL_UP_MOVE(37, MOVE_COUNTER),
...
//more draining moves  //maybe not acid armor
...
static const struct LevelUpMove sSeviperLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_CRUNCH),
    LEVEL_UP_MOVE(34, MOVE_TOXIC_FANG),
    LEVEL_UP_MOVE(37, MOVE_SWAGGER),
...
//#if defined(FIRERED)  for base form deoxys
...
static const struct LevelUpMove sGabiteLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_DUAL_STRIKE),
    LEVEL_UP_MOVE( 1, MOVE_DUAL_STRIKE),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
...
static const struct LevelUpMove sSkorupiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(23, MOVE_TOXIC_FANG),
...
static const struct LevelUpMove sTangrowthLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_INGRAIN),    //for test trade evo move learn, forgot removed trade evos, so I don't have to worry about
    LEVEL_UP_MOVE( 1, MOVE_BLOCK),
    LEVEL_UP_MOVE( 1, MOVE_CONSTRICT),
    LEVEL_UP_MOVE( 4, MOVE_SLEEP_POWDER),
...
static const struct LevelUpMove sYanmegaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 6, MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(11, MOVE_DOUBLE_TEAM),
    LEVEL_UP_MOVE(14, MOVE_SONIC_SCREECH),
...
static const struct LevelUpMove sMaractusLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SPIKE_SHIELD),
...
static const struct LevelUpMove sArchenLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(57, MOVE_HEART_SWAP), //same level for archtops
    LEVEL_UP_END
};
...
static const struct LevelUpMove sAxewLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_DUAL_STRIKE),
    LEVEL_UP_MOVE(16, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(20, MOVE_SLASH),
...
static const struct LevelUpMove sChesnaughtLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_SPIKE_SHIELD),
    LEVEL_UP_MOVE( 1, MOVE_SPIKE_SHIELD),
    LEVEL_UP_MOVE( 1, MOVE_NEEDLE_ARM),
    LEVEL_UP_MOVE( 1, MOVE_HAMMER_ARM),
...
//readjust learnset give fire moves earlier 
...
static const struct LevelUpMove sFomantisLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(23, MOVE_RAZOR_LEAF), //since buffed need to move up in learnset
    LEVEL_UP_MOVE(28, MOVE_SYNTHESIS),
    LEVEL_UP_MOVE(32, MOVE_SLASH),
...
static const struct LevelUpMove sTogedemaruLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(45, MOVE_PIN_MISSILE),
    LEVEL_UP_MOVE(49, MOVE_SPIKE_SHIELD),
    LEVEL_UP_MOVE(53, MOVE_FELL_STINGER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sZeraoraLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(43, MOVE_PLASMA_FIST),
...
static const struct LevelUpMove sCoalossalLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(63, MOVE_BURN_OUT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCentiskorchLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(67, MOVE_BURN_OUT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCefireonLevelUpLearnset[] = {
    LEVEL_UP_MOVE(0, MOVE_OMINOUS_WIND),
...
static const struct LevelUpMove sGrimerAlolanLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(18, MOVE_TOXIC_FANG),
    LEVEL_UP_MOVE(21, MOVE_MINIMIZE),
...
static const struct LevelUpMove sMeowstic_FemaleLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_STORED_POWER),
...
static const struct LevelUpMove sShroodleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(14, MOVE_TOXIC_FANG),
...
static const struct LevelUpMove sOkidogiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(16, MOVE_TOXIC_FANG),
...
static const struct LevelUpMove sOgerponLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(48, MOVE_SPIKE_SHIELD),

...
const u8 *const gMonIconTable[] = {
    ...
    [SPECIES_ENAMORUS] = gMonIcon_Enamorus,
      ...
      [SPECIES_BASCULIN_WHITE_STRIPED] = gMonIcon_BasculinHisuian,
...
const u8 gMonIconPaletteIndices[] = {
    ...
    [SPECIES_ALCREMIE_MINT_CREAM] = 3,
    [SPECIES_ALCREMIE_LEMON_CREAM] = 2,
    [SPECIES_ALCREMIE_SALTED_CREAM] = 0,
    [SPECIES_ALCREMIE_RUBY_SWIRL] = 1,
    [SPECIES_ALCREMIE_CARAMEL_SWIRL] = 2,
    [SPECIES_ALCREMIE_RAINBOW_SWIRL] = 2,

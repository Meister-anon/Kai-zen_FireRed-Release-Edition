...
static void DoBattleIntro(void); //EE addition
...
EWRAM_DATA u16 gLastThrownBall = 0;    //need to implement add in these 2 somewhere //removed glastthrownball make htis u16
...
//also apparent in fairy lore fae and bugs are similar
//some even treat them the same 
...
//only referenced here now no longer need to keep updating extern define
static const u8 gTypeEffectiveness[] = // 336 is number of entries x 3 i.e number of efffectiveness since only super not effective and no effect are included. 
...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [CLASS_SCIENTIST] = { _("SCIENTIST"), 12 },
    [CLASS_CRUSH_GIRL] = { _("CRUSH GIRL"), 6 },
    [CLASS_TUBER_FRLG] = { _("TUBER"), 1 },
    [CLASS_PKMN_BREEDER_FRLG] = { _("{PKMN} BREEDER"), 7 },
    [CLASS_PKMN_RANGER_FRLG] = { _("{PKMN} RANGER"), 9 },
    [CLASS_AROMA_LADY_FRLG] = { _("AROMA LADY"), 7 },
    [CLASS_RUIN_MANIAC_FRLG] = { _("RUIN MANIAC"), 12 },
    [CLASS_LADY_FRLG] = { _("LADY"), 50 }, //the fuck is this? oh think this is rich lady? ists same as Em rich boy money
    [CLASS_PAINTER] = { _("PAINTER"), 4 },
    [CLASS_TWINS_FRLG] = { _("TWINS"), 3 },
    [CLASS_YOUNG_COUPLE_FRLG] = { _("YOUNG COUPLE"), 7 },
    [CLASS_SIS_AND_BRO_FRLG] = { _("SIS AND BRO"), 1 },
    [CLASS_COOL_COUPLE] = { _("COOL COUPLE"), 6 },
    [CLASS_CRUSH_KIN] = { _("CRUSH KIN"), 6 },
    [CLASS_SWIMMER_FEMALE_FRLG] = { _("SWIMMER♀"), 1 },
    [CLASS_PLAYER] = { _("PLAYER"), 1 },
    [CLASS_GYM_LEADER] = { _("LEADER"), 25 },
    [CLASS_ELITE_FOUR] = { _("ELITE FOUR"), 25 },
    [CLASS_LASS] = { _("LASS"), 4 },
    [CLASS_YOUNGSTER] = { _("YOUNGSTER"), 4 },
    [CLASS_PKMN_TRAINER_3] = { _("{PKMN} TRAINER"), 15 },
    [CLASS_HIKER] = {  _("HIKER"), 10 },
    [CLASS_BEAUTY] = { _("BEAUTY"), 20 },
    [CLASS_FISHERMAN] = { _("FISHERMAN"), 10 },
    [CLASS_LADY] = { _("LADY"), 50 },
    [CLASS_TRIATHLETE] = { _("TRIATHLETE"), 10 },
    [CLASS_TEAM_AQUA] = { _("TEAM AQUA"), 5 },
    [CLASS_TWINS] = { _("TWINS"), 3 },
    [CLASS_SWIMMER_FEMALE] = {  _("SWIMMER♀"), 2 },
    [CLASS_BUG_CATCHER] = { _("BUG CATCHER"), 4 },
    [CLASS_SCHOOL_KID] = { _("SCHOOL KID"), 5 },
    [CLASS_RICH_BOY] = { _("RICH BOY"), 50 },
    [CLASS_SR_AND_JR] = { _("SR. AND JR."), 4 },
    [CLASS_BLACK_BELT] = { _("BLACK BELT"), 8 },
    [CLASS_TUBER_F] = { _("TUBER"), 1 },
    [CLASS_HEX_MANIAC] = { _("HEX MANIAC"), 6 },
    [CLASS_PKMN_BREEDER] = { _("{PKMN} BREEDER"), 10 },
    [CLASS_TEAM_MAGMA] = { _("TEAM MAGMA"), 5 },
    [CLASS_INTERVIEWER] = { _("INTERVIEWER"), 12 },
    [CLASS_TUBER_M] = { _("TUBER"), 1 },
    [CLASS_YOUNG_COUPLE] = { _("YOUNG COUPLE"), 8 },
    [CLASS_GUITARIST] = { _("GUITARIST"), 8 },
    [CLASS_GENTLEMAN] = { _("GENTLEMAN"), 20 },
    [CLASS_CHAMPION] = { _("CHAMPION"), 50 },
    [CLASS_MAGMA_LEADER] = { _("MAGMA LEADER"), 20 },
    [CLASS_BATTLE_GIRL] = { _("BATTLE GIRL"), 6 },
    [CLASS_SWIMMER_MALE] = { _("SWIMMER♂"), 2 },
    [CLASS_POKEFAN] = { _("POKéFAN"), 20 },
    [CLASS_EXPERT] = { _("EXPERT"), 10 },
    [CLASS_DRAGON_TAMER] = { _("DRAGON TAMER"), 12 },
    [CLASS_BIRD_KEEPER] = { _("BIRD KEEPER"), 8 },
    [CLASS_NINJA_BOY] = { _("NINJA BOY"), 3 },
    [CLASS_PARASOL_LADY] = { _("PARASOL LADY"), 10 },
    [CLASS_BUG_MANIAC] = { _("BUG MANIAC"), 15 },
    [CLASS_SAILOR] = { _("SAILOR"), 8 },
    [CLASS_COLLECTOR] = { _("COLLECTOR"), 15 },
    [CLASS_PKMN_RANGER] = { _("{PKMN} RANGER"), 12 },
    [CLASS_MAGMA_ADMIN] = { _("MAGMA ADMIN"), 10 },
    [CLASS_AROMA_LADY] = { _("AROMA LADY"), 10 },
    [CLASS_RUIN_MANIAC] = { _("RUIN MANIAC"), 15 },
    [CLASS_COOLTRAINER] = { _("COOLTRAINER"), 12 },
    [CLASS_POKEMANIAC] = { _("POKéMANIAC"), 15 },
    [CLASS_KINDLER] = { _("KINDLER"), 8 },
    [CLASS_CAMPER] = { _("CAMPER"), 4 },
    [CLASS_PICNICKER] = { _("PICNICKER"), 4 },
    [CLASS_PSYCHIC] = { _("PSYCHIC"), 6 },
    [CLASS_SIS_AND_BRO] = { _("SIS AND BRO"), 3 },
    [CLASS_OLD_COUPLE] = { _("OLD COUPLE"), 10 },
    [CLASS_AQUA_ADMIN] = { _("AQUA ADMIN"), 10 },
    [CLASS_AQUA_LEADER] = { _("AQUA LEADER"), 20 },
...
//think on another branch but decided to make this
//the sole function I use type calc and remove retrunmovetype
//no reason to have a dupe, can just make this assigned to a  stored type
//rather than always setting dynamicmovetype
//oh nvm it was on this  branches return function I said that lol
//ok believe should be solid, if I want to set the type
//rather than just get it all I need to do
    ...
    *typeStorage = gMovesInfo[move].type;
    ...
    else if (gMovesInfo[move].effect == EFFECT_REVELATION_DANCE)
    {
        if (gBattleMons[battlerAtk].type1 != TYPE_MYSTERY)
            ...
            *typeStorage = gBattleMons[battlerAtk].type2;
    ...
    else if (gMovesInfo[move].effect == EFFECT_TERRAIN_PULSE)
    {
        if (IsBattlerTerrainAffected(battlerAtk, atkAbility, holdEffect, gFieldStatuses, STATUS_FIELD_TERRAIN_ANY))
        {
            if (gFieldStatuses & STATUS_FIELD_ELECTRIC_TERRAIN)
                ...
                *typeStorage = TYPE_GRASS;
            else if (gFieldStatuses & STATUS_FIELD_MISTY_TERRAIN)
                *typeStorage = TYPE_FAIRY;
            else if (gFieldStatuses & STATUS_FIELD_PSYCHIC_TERRAIN)
                *typeStorage = TYPE_PSYCHIC;
            else //failsafe
                *typeStorage = TYPE_NORMAL;
        }
    }
    else if (move == MOVE_WEATHER_BALL) //thought set elsewhere but guess no longer need that
    {
        *typeStorage = GetWeatherBallType(move);
    ...
    if (move == MOVE_RAGE) //sets rage type with preference for non normal
        {
            ...
            && gBattleMons[battlerAtk].type2 != TYPE_NORMAL)
                ...
                *typeStorage = gBattleMons[battlerAtk].type1; //need make sure use battlerAtk not gbattlerattacker that causes errors for some reason
        }
    ...
    else if (IsAbilityOnField(ABILITY_ABSOLUTE_ZERO) && *typeStorage == TYPE_WATER)
    {
        *typeStorage = TYPE_ICE;
    }
    else if (GetBattlerAbility(gBattlerTarget) == ABILITY_CREATION_ENGINE && *typeStorage == TYPE_WATER)
    {
        *typeStorage = TYPE_ICE;
    }
    ...
    {
       *typeStorage = GetBattlerHiddenPowerType(battlerAtk); //works
    }
...
static void CB2_PreInitMultiBattle(void)
{
    ...
    case 0:
        if (gReceivedRemoteLinkPlayers && IsLinkTaskFinished())
        {
            ...
            SendBlock(BitmaskAllOtherLinkPlayers(), sMultiPartnerPartyBuffer, sizeof(sMultiPartnerPartyBuffer));
            ++gBattleCommunication[MULTIUSE_STATE];
        }
        break;
    case 1:
...
//can cut this down a lot if I just unify trainer data into one struct
//with all the options rather than separate ones, physical space saved
//believe should be negligable
static u8 CreateNPCTrainerParty(struct Pokemon *party, u16 trainerNum)
{
     ...
     && !(gBattleTypeFlags & (BATTLE_TYPE_BATTLE_TOWER | BATTLE_TYPE_EREADER_TRAINER | BATTLE_TYPE_TRAINER_TOWER)))
    {
        ...
        {//vsonic
            ...
            else if (gTrainers[trainerNum].gender == TRAINER_GENDER_FEMALE)
...
void SwitchInClearSetData(enum BattlerId battler, struct Volatiles *volatilesCopy) //handles what gets reset on switchout
{
    ...
    if (effect == EFFECT_BATON_PASS) //added yawn to baton pass effects with change to activation should work
    {
    ...
    else //if not using baton pass clear status 2 & 3 on switch? //this is status clear on mon switching out
    {
        ...
        gBattleMons[battler].volatiles.bindTurns = 0;
        gBattleMons[battler].volatiles.clampTurns = 0;
...
const u8* FaintClearSetData(enum BattlerId battler) //see about make status1 not fade wen faint?
{
    ...
    gProtectStructs[battler].OmniAideElevated = FALSE;
    gProtectStructs[battler].NuisanceElevated = FALSE;
    gProtectStructs[battler].LightMetalElevated = FALSE;
    gProtectStructs[battler].LongReachElevated = FALSE;
    ...
    gLastMoves[battler] = MOVE_NONE;
    gLastLandedMoves[battler] = MOVE_NONE;
    gLastHitByType[battler] = MOVE_NONE;
    gLastResultingMoves[battler] = MOVE_NONE;
    gLastPrintedMoves[battler] = MOVE_NONE;
    gLastHitBy[battler] = 0xFF;
...
static void DoBattleIntro(void)
{
    ...
    case BATTLE_INTRO_STATE_GET_MON_DATA:
        battler = gBattleCommunication[SPRITES_INIT_STATE1];
        ...
        for (battler = 0; battler < gBattlersCount; battler++)
        {
            ...
            case B_POSITION_OPPONENT_LEFT:
                ...
                {                   
                    ...
                    else if (!BattleTypeCannotSetDex())
                        HandleSetPokedexFlag(SpeciesToNationalPokedexNum(gBattleMons[battler].species), FLAG_SET_SEEN, gBattleMons[battler].personality);
...
//swaped for EE version need update battle setup stuff for trainer params
//can cherry pick unsure how far changes go
/*static void TryDoEventsBeforeFirstTurn(void)
{
    s32 i, j;
    u8 effect = 0;
    ...
    for (battler = 0; battler < gBattlersCount; ++battler)
    {
        ...
        case STATE_WAIT_ACTION_CHOSEN: // Try to perform an action. //i.e selection from fight,pokemon,item/run
            if (!IsBattleControllerActiveOrPendingSyncAnywhere(battler))
            {
                ...
                case B_ACTION_USE_MOVE:
                    ...
                    else if (gBattleMons[battler].volatiles.encoredMove != MOVE_NONE)
                    {
                    ...
                    else
                    {
                        ...
                        MarkBattlerForControllerExec(battler); //unsure what above means? but its default?
                ...
                case B_ACTION_MOVE_INFO:
                    BtlController_EmitMoveInfo(battler, B_COMM_TO_CONTROLLER);
                    MarkBattlerForControllerExec(battler);
                    break;
                }//vsonic
        ...
        case STATE_WAIT_ACTION_CASE_CHOSEN:
            if (!IsBattleControllerActiveOrPendingSyncAnywhere(battler))
            {
                ...
                {
                case B_ACTION_USE_MOVE:
                    switch (gBattleResources->bufferB[battler][1]) //values 3 -9 don't know what are?
                    {
                    case 3 ... 9:
                        gChosenActionByBattler[battler] = gBattleResources->bufferB[battler][1];
                        return;
...
u32 GetBattlerTotalSpeedStat(enum BattlerId battler, enum Ability ability, enum HoldEffect holdEffect)
{
    ...
    if (IsAbilityOnField(ABILITY_TABLETS_OF_RUIN) && GetBattlerAbility(battler) != ABILITY_TABLETS_OF_RUIN)
    ...
    if (IsAbilityPreventingEscape(battler)) //realize this need be an if, to always trigger
    ...
    else if (IsBattlerofTypeAffinity(ability, battler, ability, TYPE_ROCK, TRUE) && holdEffect == HOLD_EFFECT_FLOAT_STONE)
        speed = (speed * 150) / 100;
    ...
    if (gBattleMons[battler].volatiles.unburdenActive)
        speed *= 2;
    if (IsBattlerofTypeAffinity(ability, battler, ability, TYPE_GRASS, TRUE) && (gSideStatuses[GET_BATTLER_SIDE(battler)] & SIDE_STATUS_WATERSPORT)) //give to more grass types
    ...
    if (IsBattlerTrappedViaMove(battler))
    {
        ...
        if ((IsBattlerofTypeAffinity(ability, battler, ability, TYPE_GHOST, TRUE) && gBattleMons[battler].species != SPECIES_SPIRITOMB)
        || (IsBattlerofTypeAffinity(ability, battler, ability, TYPE_FLYING, TRUE) && !IsFlyingTypeBattlerUnableToFly(battler) && !IsBattlerGrounded(battler, ability, atkability, holdEffect))
        || (IsBattlerofTypeAffinity(ability, battler, ability, TYPE_WIND, TRUE) && !IsFlyingTypeBattlerUnableToFly(battler) && !IsBattlerGrounded(battler, ability, atkability, holdEffect)))
        {
            ...
            for (battler = 0; battler < gBattlersCount - 1; battler++)
            {
                for (battler2 = battler + 1; battler2 < gBattlersCount; battler2++)
                {
                    ...
                    if (gActionsByTurnOrder[battler] != B_ACTION_USE_ITEM
                        ...
                        && gActionsByTurnOrder[battler2] != B_ACTION_THROW_BALL*/) //vsonic doesnt exist in FR
                    {
...
static void TurnValuesCleanUp(bool8 var0) //resets protect structs specific disble structs and folloemetimer at turn end
{
    ...
    for (enum BattlerId i = 0; i < gBattlersCount; i++)
    {
        ...
        {
            //dataPtr = (u8 *)(&gProtectStructs[i]);
            //for (i = 0; i < sizeof(struct ProtectStruct); ++i)
            //    dataPtr[i] = 0; //clears protect struct
            
            memset(&gProtectStructs[i], 0, sizeof(struct ProtectStruct));

            if (gBattleStruct->battlerState[i].isFirstTurn) //starts at 2, think this decrements so its no longer switch in?
...
static void CheckFocusPunch_ClearVarsBeforeTurnStarts(void)
{
    ...
    if (!(gHitMarker & HITMARKER_RUN))
    {
        ...
        {
            battler = gBattlerAttacker = gBattleStruct->focusPunchBattlerId;
            ++gBattleStruct->focusPunchBattlerId;
            if (gChosenMoveByBattler[battler] == MOVE_FOCUS_PUNCH
...
/*static void HandleAction_UseMove(void)
{
    ...
    //else if (gBattleMons[gBattlerAttacker].volatiles.bindedMove != MOVE_NONE
    //    && gBattleMons[gBattlerAttacker].volatiles.bindedMove == gBattleMons[gBattlerAttacker].moves[gBattleMons[gBattlerAttacker].volatiles.bindMovepos])  //should always be true cuz bs com logic
    ...
    else if (gBattleMons[gBattlerAttacker].volatiles.encoredMove != MOVE_NONE
...
s32 GetChosenMovePriority(enum BattlerId battler, enum Ability ability) //made u8 (in test build)
{
    ...
    if (gProtectStructs[battler].noValidMoves) //think put called move effec here, ad set move to called move rather than used move?
        move = MOVE_STRUGGLE;
    else
...
bool8 IsPriorityElevatedviaAbility(enum BattlerId battler)
{
    ...
    || gProtectStructs[battler].triageElevated
    || gProtectStructs[battler].OmniAideElevated
    || gProtectStructs[battler].NuisanceElevated
    || gProtectStructs[battler].LightMetalElevated
    || gProtectStructs[battler].LongReachElevated)
        return TRUE;

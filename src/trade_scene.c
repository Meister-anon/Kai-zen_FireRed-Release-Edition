...
void CB2_InitTradeAnim_LinkTrade(void)
{
    ...
    case 10:
        ...
        ShowBg(0);
        sTradeData->monSpecies[0] = GetMonData(&gPlayerParty[gSelectedTradeMonPositions[0]], MON_DATA_SPECIES_OR_EGG);
        sTradeData->monSpecies[1] = GetMonData(&gEnemyParty[gSelectedTradeMonPositions[1] % 6], MON_DATA_SPECIES_OR_EGG);
...
static bool8 DoTradeAnim_Cable(void)
{
    ...
    case 0:
        ...
        gSprites[sTradeData->pokePicSpriteIdxs[0]].y2 = gSpeciesGraphics[sTradeData->tradeSpecies[0]].frontPicYOffset;
        sTradeData->state++;
    ...
    case 66:
        ...
        gSprites[sTradeData->pokePicSpriteIdxs[1]].y = gSpeciesGraphics[sTradeData->tradeSpecies[1]].frontPicYOffset + 60;
...
static void BufferInGameTradeMonName(void)
{
    ...
    // gStringVar2 with the name of the offered species.
    u8 nickname[30];
    u16 species = GetMonData(&gPlayerParty[gSpecialVar_0x8005], MON_DATA_SPECIES);
...
static void CreateInGameTradePokemonInternal(u8 playerSlot, u8 inGameTradeIdx) //make sure to remove any mail items from in game trades
{
    ...
    SetMonData(tradeMon, MON_DATA_BEAUTY, &inGameTrade->contestStats[1]);
    SetMonData(tradeMon, MON_DATA_CUTE, &inGameTrade->contestStats[2]);

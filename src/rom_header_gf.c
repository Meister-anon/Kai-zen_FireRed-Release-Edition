...
static const struct GFRomHeader sGFRomHeader = {
    ...
    .monIconPaletteIds = gMonIconPaletteIndices,*/ //handled by species_graphic_info
    .monIconPalettes = gMonIconPaletteTable,
    //.monSpeciesNames = gSpeciesNames, //handled in base stats
    ...
    .pokedexFlag = FLAG_NATIONAL_DEX_TOGGLE,
    ...
    .unkFlagOffset = offsetof(struct SaveBlock2, unkFlag2), //believed are emerald leftovers as is frontier in Emer
    ...
    .items = gItemsInfo,    //has inteliscence on it but it should be fine?
    .moves = gMovesInfo,

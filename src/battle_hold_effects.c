...
static enum ItemEffect TryTerrainSeeds(enum BattlerId battler, u32 item)
{
    enum ItemEffect effect = ITEM_NO_EFFECT;
...
static enum ItemEffect TryKingsRock(enum BattlerId battlerAtk, enum BattlerId battlerDef, u32 item)
{
    enum ItemEffect effect = ITEM_NO_EFFECT;
...
static enum ItemEffect TryRockyHelmet(enum BattlerId battlerDef, enum BattlerId battlerAtk, u32 item)
{
    enum ItemEffect effect = ITEM_NO_EFFECT;
    enum Ability ability = GetBattlerAbility(battlerAtk);
...
static enum ItemEffect TryJabocaBerry(enum BattlerId battlerDef, enum BattlerId battlerAtk, u32 item)
{
    enum ItemEffect effect = ITEM_NO_EFFECT;
...
static enum ItemEffect TryRowapBerry(enum BattlerId battlerDef, enum BattlerId battlerAtk, u32 item)
{
    enum ItemEffect effect = ITEM_NO_EFFECT;
...
static enum ItemEffect TrySetEnigmaBerry(enum BattlerId battlerDef, enum BattlerId battlerAtk)
{
    ...
    if (IsBattlerAlive(battlerDef)
     ...
     && !(gSideStatuses[GetBattlerSide(battlerDef)] & SIDE_STATUS_HEAL_BLOCK))
    {
...
static enum ItemEffect TryStickyBarbOnTargetHit(enum BattlerId battlerDef, enum BattlerId battlerAtk, u32 item)
{
    enum ItemEffect effect = ITEM_NO_EFFECT;
...
static enum ItemEffect TryStickyBarbOnEndTurn(enum BattlerId battler, u32 item)
{
    enum ItemEffect effect = ITEM_NO_EFFECT;
...
static u32 ItemHealHp(enum BattlerId battler, u32 itemId, enum HealAmount percentHeal)
{
    enum ItemEffect effect = ITEM_NO_EFFECT;
    enum Ability ability = GetBattlerAbility(battler);
...
static u32 ItemRestorePp(enum BattlerId battler, u32 itemId)
{
    enum ItemEffect effect = ITEM_NO_EFFECT;
...
static enum ItemEffect HealConfuseBerry(enum BattlerId battler, u32 itemId, u32 flavorId)
{
    enum ItemEffect effect = ITEM_NO_EFFECT;
...
static enum ItemEffect StatRaiseBerry(enum BattlerId battler, u32 itemId, enum Stat statId)
{
    enum ItemEffect effect = ITEM_NO_EFFECT;
    enum Ability ability = GetBattlerAbility(battler);
...
static enum ItemEffect CriticalHitRatioUp(enum BattlerId battler, u32 itemId)
{
    enum ItemEffect effect = ITEM_NO_EFFECT;
...
static enum ItemEffect RandomStatRaiseBerry(enum BattlerId battler, u32 itemId)
{
    enum ItemEffect effect = ITEM_NO_EFFECT;
    enum Stat stat;
    enum Ability ability = GetBattlerAbility(battler);
...
static enum ItemEffect TrySetMicleBerry(enum BattlerId battler, u32 itemId)
{
    enum ItemEffect effect = ITEM_NO_EFFECT;

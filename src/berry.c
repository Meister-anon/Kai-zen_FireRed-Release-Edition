...
//seems to be stats for emerald berry stats screen
//which I wanted to use for my  berry nature idea
//so can just add on to this if can implement berry summary in frlg
//VSONIC IMPORTANT

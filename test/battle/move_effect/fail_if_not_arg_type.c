...
SINGLE_BATTLE_TEST("Burn Up user loses its Fire-type")
{
    GIVEN {
        ...
        ASSUME(gSpeciesInfo[SPECIES_WOBBUFFET].type1 != TYPE_FIRE || gSpeciesInfo[SPECIES_WOBBUFFET].type2 != TYPE_FIRE);
        ASSUME(gSpeciesInfo[SPECIES_CYNDAQUIL].type1 == TYPE_FIRE || gSpeciesInfo[SPECIES_CYNDAQUIL].type2 == TYPE_FIRE);
...
SINGLE_BATTLE_TEST("Double Shock user loses its Electric-type")
{
    GIVEN {
        ...
        ASSUME(gSpeciesInfo[SPECIES_WOBBUFFET].type1 != TYPE_ELECTRIC || gSpeciesInfo[SPECIES_WOBBUFFET].type2 != TYPE_ELECTRIC);
        ASSUME(gSpeciesInfo[SPECIES_PIKACHU].type1 == TYPE_ELECTRIC || gSpeciesInfo[SPECIES_PIKACHU].type2 == TYPE_ELECTRIC);

...
{
    GIVEN {
        ASSUME(GetSpeciesPrimaryType(SPECIES_TANGELA) == TYPE_GRASS);
        ASSUME(GetSpeciesPrimaryType(SPECIES_TANGROWTH) == TYPE_GRASS);
        ASSUME(GetSpeciesPrimaryType(SPECIES_SUNKERN) == TYPE_GRASS);
        ASSUME(GetSpeciesPrimaryType(SPECIES_SUNFLORA) == TYPE_GRASS);
...
AI_DOUBLE_BATTLE_TEST("AI uses Flower Shield")
{
    GIVEN {
        ASSUME(GetSpeciesPrimaryType(SPECIES_TANGELA) == TYPE_GRASS);
        ASSUME(GetSpeciesPrimaryType(SPECIES_WOBBUFFET) != TYPE_GRASS);
        ASSUME(GetSpeciesSecondaryType(SPECIES_WOBBUFFET) != TYPE_GRASS);

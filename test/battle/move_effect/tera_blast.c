...
SINGLE_BATTLE_TEST("Tera Blast has correct effectiveness for every Tera Type")
{
    ...
    GIVEN {
        ASSUME(gSpeciesInfo[SPECIES_CHIKORITA].type1 == TYPE_GRASS);
        ASSUME(gSpeciesInfo[SPECIES_CHIKORITA].type2 == TYPE_GRASS);
        ASSUME(gSpeciesInfo[SPECIES_CYNDAQUIL].type1 == TYPE_FIRE);
        ASSUME(gSpeciesInfo[SPECIES_CYNDAQUIL].type2 == TYPE_FIRE);
        ASSUME(gSpeciesInfo[SPECIES_GASTLY].type1 == TYPE_GHOST);
        ASSUME(gSpeciesInfo[SPECIES_GASTLY].type2 == TYPE_POISON);
        ASSUME(gSpeciesInfo[SPECIES_TOTODILE].type1 == TYPE_WATER);
        ASSUME(gSpeciesInfo[SPECIES_TOTODILE].type2 == TYPE_WATER);
        ASSUME(gSpeciesInfo[SPECIES_DRATINI].type1 == TYPE_DRAGON);
        ASSUME(gSpeciesInfo[SPECIES_DRATINI].type2 == TYPE_DRAGON);
        ASSUME(gSpeciesInfo[SPECIES_SNEASEL].type1 == TYPE_DARK);
        ASSUME(gSpeciesInfo[SPECIES_SNEASEL].type2 == TYPE_ICE);
        ASSUME(gSpeciesInfo[SPECIES_ABRA].type1 == TYPE_PSYCHIC);
        ASSUME(gSpeciesInfo[SPECIES_ABRA].type2 == TYPE_PSYCHIC);

...
extern const u8 BattleScript_EffectSpeedUpHit[]; //vsonic update removes
...
extern const u8 BattleScript_EffectDefenseUp2Hit[]; //vsonic update removes
...
extern const u8 BattleScript_EffectSpAtkUpHit[]; //vsonic update removes
...
extern const u8 BattleScript_EffectStrengthUpHit[]; //this stays can make its own effect raise stat then attack
...
extern const u8 BattleScript_ResoluteActivatesOnMoveEndTarget[];
...
extern const u8 BattleScript_GroundNullifiesEarth[];
...
extern const u8 BattleScript_SkyAttackGlowing[];
...
extern const u8 BattleScript_InthrallActivates[];
...
extern const u8 BattleScript_DestinyBondSturdied[];
...
extern const u8 BattleScript_MoveCanceler_IronWill[]; //this is actually iron will effect
extern const u8 BattleScript_Pressure_IronWill_LostResolve[]; //and this is pressure...
extern const u8 BattleScript_MoveUsedFlinched[];
extern const u8 BattleScript_MoveUsedInterrupted[];
...
extern const u8 BattleScript_DampPreventsAftermathOnSwitch[];
...
extern const u8 BattleScript_RoughSkinActivatesDef[];
...
extern const u8 BattleScript_SpikesAbsorbed[];
extern const u8 BattleScript_ToxicSpikesAbsorbed[];
extern const u8 BattleScript_StealthRockAbsorb[];
extern const u8 BattleScript_SteelSpearsAbsorbed[];
extern const u8 BattleScript_SpikesAbsorbed_Endturn[];
extern const u8 BattleScript_ToxicSpikesAbsorbed_Endturn[];
extern const u8 BattleScript_StealthRockAbsorb_Endturn[];
extern const u8 BattleScript_SteelSpearsAbsorbed_Endturn[];
extern const u8 BattleScript_HazardAbsorbAbility[];
extern const u8 BattleScript_HazardAbsorbAbility_Endturn[];
extern const u8 BattleScript_HazardAbsorbAbilityHeal[];
extern const u8 BattleScript_HazardAbsorbAbilityHeal_Endturn[];
extern const u8 BattleScript_HazardAbsorbAbilityStatBoost[];
extern const u8 BattleScript_HazardAbsorbAbilityStatBoost_Endturn[];
...
extern const u8 BattlesScript_RoostEndsHeal[];
...
extern const u8 BattleScript_StatChangesRemoved[];
...
extern const u8 BattleScipt_AbilityAttackDropExclusions[];
extern const u8 BattleScipt_AbilityDefenseDropExclusions[];
...
extern const u8 BattleScript_CleanseTagStatusCure[];
...
extern const u8 BattleScript_ColorChangeActivates[];
extern const u8 BattleScript_PoetArtistActivates[];
extern const u8 BattleScript_CuteCharmActivates[];
...
extern const u8 BattleScript_OctolockEnds[];
extern const u8 BattleScript_NeutralizingGasExits[];
extern const u8 BattleScript_MagicianActivates[];
...
extern const u8 BattleScript_EffectWhirlwind[];

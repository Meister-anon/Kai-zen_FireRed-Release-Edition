...
extern const u8 BattleScript_TargetAtkSpAtkDownRet[];
extern const u8 BattleScript_TargetAtkSpAtkDownTrySpAtk[];
extern const u8 BattleScript_TargetAtkSpAtkDown[];

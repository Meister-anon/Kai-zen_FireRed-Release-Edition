...
void RecordKnownMove(enum BattlerId battlerId, u32 move);
...
void SetBattlerAiData(enum BattlerId battlerId, struct AiLogicData *aiData);
...
s32 AI_WhoStrikesFirst(enum BattlerId battlerAI, enum BattlerId battler2, u32 aiMoveConsidered, u32 playerMoveConsidered, enum ConsiderPriority considerPriority);
...
// score increases
u32 IncreaseStatUpScore(enum BattlerId battlerAtk, enum BattlerId battlerDef, enum StatChange statId);
u32 IncreaseStatUpScoreContrary(enum BattlerId battlerAtk, enum BattlerId battlerDef, enum StatChange statId);

...
enum Move {
 ...
 MOVE_SING = 47,
 MOVE_SUPERSONIC = 48,
 MOVE_SONIC_SCREECH = 49, // renamed was MOVE_SONIC_BOOM
 MOVE_DISABLE = 50,
 MOVE_ACID = 51,
 MOVE_EMBER = 52,
 ...
 MOVE_BIDE = 117,
 MOVE_METRONOME = 118,
 MOVE_MIRROR_MOVE = 119,	//mirror move is meant to be a parrot like ability to copy, maybe can use battlehistory to make it turn into any move already used it doesn't already know?
 MOVE_SELF_DESTRUCT = 120,
 MOVE_EGG_BOMB = 121,
 MOVE_AURORA_VEIL = 122,	//MOVE_AURORA_VEIL swaped for Lick, to make cleardefoghazarad work
 MOVE_SMOG = 123,
 MOVE_SLUDGE = 124,
 MOVE_BONE_CLUB = 125,
 MOVE_FIRE_BLAST = 126,
...
// Gen = 5, moves.
 ...
 MOVES_COUNT_GEN5 = 560,

// Gen = 6, moves.
 MOVE_FLYING_PRESS = MOVES_COUNT_GEN5,
 MOVE_MAT_BLOCK = 561,
 MOVE_BELCH = 562,	//change belch so it also works with stockpile
 MOVE_ROTOTILLER = 563,
 MOVE_STICKY_WEB = 564,
...
// Gen = 9, moves.
 ...
 MOVE_TIDY_UP = 808,
 MOVE_SNOWESCAPE = 809,
 MOVE_GRASSHOPPER = 810,    //renamed was MOVE_POUNCE
 MOVE_TRAILBLAZE = 811,
 ...
 MOVE_PSYBLADE = 827, //still need add data and descriptions
...
// The Indigo Disk Moves
 ...
 MOVES_COUNT_GEN9 = 848,

// New Custom Additions
 MOVE_COCOON = MOVES_COUNT_GEN9,	//ONLY one that has animation, but is just a copy of cosmic power
 MOVE_MONOTYPE = 849,
 MOVE_FLASH_FREEZE = 850,
 MOVE_DRYADS_CURSE = 851,
 MOVE_SHIELD_BASH = 852,
 MOVE_UP_ROOT = 853,
 MOVE_DIVE_BOMB = 854,
 MOVE_NETTLE_WHIP = 855,	//Will be grass move that can apply burn	//MOVE_NETTLE_WHIP	MOVE_BURNING_VINE    MOVE_NETTLE_WHIP
 MOVE_SONIC_BOOM = 856,	//new move  -animations for these are set below aren't
 MOVE_OVER_MAX_POWER = 857,	//PSYCHIC BURN OUT	
 MOVE_SHIMON = 858,	//FIGHTING BURN OUT	
 MOVE_FINAL_FLIGHT = 859,	//FLYING BURN OUT	
 MOVE_PLASMA_RAILGUN = 860,	//ELECTRIC BURN OUT	
 MOVE_BOLTBEAM = 861,	//joke idea taken from CammyMeeleTea video on icetypes
 MOVE_BACK_STAB = 862,	//new dark exclusive, give every dark type sucker punch and backstab  potentially make a tm, but keep sucker punch as learn move?
 MOVE_POUNCE = 863,
 MOVE_CHEAP_SHOT = 864, //low prio fighting uturn
 MOVE_SNOWBALL = 865,
 MOVE_TRENCH_RUN = 866,    //flying status move, = 71, stagae evasion boost, flies low to ground/grounds flyer removing electric weakness
 MOVE_SPIN_DASH = 867, //groud move tuck into ball and spin at the foe, give flag dmg in air can bounce into the air
 MOVE_ARCTIC_RAKE = 868,    //move for base sneasel line
 MOVE_CONVERSION_Z = 869, //don't forget adjust battle_anim_scritpts
 MOVE_SOLAR_FLARE = 870, //idea solrock magmar, fire based electro web
 MOVE_MUDSLIDE = 871, //new special groud move for gigalith line
 MOVE_SPICE_TRADE = 872, //scovillain new signature move change target ability to ABILITY_HEAT_TRANCE
 MOVE_PEPPER_POPPER = 873, //scovillain signature boost speed = 1, or = 2, stages
 MOVE_STEEL_SURGE = 874,
 MOVE_DIRT_NAP = 875,
 MOVE_WATERY_GRAVE = 876, //if too edgey alt name MOVE_SEAFLOOR_RESPITE /make watery grave water variant skydrop give to that anchor psuedo legend/
 MOVE_SEAFLOOR_RESPITE = 877, //new idea make its own thing
 MOVE_BRUTE_FORCE = 878,    //my version of super power, takes litreal translation of move name
 MOVE_SHOCKING_MALICE = 879,    //burning jealousy clone
 MOVE_MOONDANCE = 880,  //moon version of sunny day
 MOVE_ACID_RAIN = 881,   //poison move to make acid rain
 MOVE_COLD_FRONT = 882,     //ice solar beam, 
 MOVE_LIFE_DRAIN = 883,     //mostly for giratina but ghost healing attack
 MOVE_DARK_SWAMP = 884, //new special dark move
 MOVE_CONTRALTO = 885,  //idea for reworked sing more like canonical effect may rename
 MOVES_COUNT, //avoid extra copy paste
};

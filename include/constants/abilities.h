...
#define ABILITY_MIRACLE_POWER 407 //solosis line signature miracle eye + physical moves use special stat i.e all physical become opposite psyshock
#define ABILITY_NA 408

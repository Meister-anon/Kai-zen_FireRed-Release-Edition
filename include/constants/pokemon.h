...
enum __attribute__((packed)) Type
{
 ...
 TYPE_DRAGON = 0x11,
 TYPE_DARK = 0x12,
 TYPE_FAIRY = 0x13, //fairy addition
 TYPE_WIND = 0x14,
 TYPE_SOUND = 0x15, //for normal type sound moves -having issue with non move type locations.. //may need to be = 18,?
 TYPE_STELLAR = 0x16,
 NUMBER_OF_MON_TYPES = 23,
};
// Pokemon egg groups

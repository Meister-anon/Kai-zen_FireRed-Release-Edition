...
{
     STRINGID_INTROMSG = 0,
     STRINGID_INTROSENDOUT = 1,
     STRINGID_RETURNMON = 2,
     STRINGID_SWITCHINMON = 3,
     STRINGID_USEDMOVE = 4,
     STRINGID_BATTLEEND = 5,
     STRINGID_TRAINER1LOSETEXT = 12, // Make sure to add new messages below this marker

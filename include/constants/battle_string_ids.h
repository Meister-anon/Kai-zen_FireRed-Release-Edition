...
enum SwitchInAbilityStringID
{
    ...
    B_MSG_SWITCHIN_CORRUPTION,
    B_MSG_SWITCHIN_STENCH,
    B_MSG_SWITCHIN_NEUTRALIZING_GAS,
    B_MSG_SWITCHIN_IMMUTABLE_WIND,
    B_MSG_SWITCHIN_BANDIT,
    B_MSG_SWITCHIN_FLUORESCENT,
...
/*EE*/    F(STRINGID_TWOENEMIESDEFEATED,                                         ("You defeated {B_TRAINER1_CLASS} {B_TRAINER1_NAME} and {B_TRAINER2_CLASS} {B_TRAINER2_NAME}!\p"))\
    ...
    F(STRINGID_ZENMODETRIGGERED,                                     ("{B_SCR_NAME_WITH_PREFIX} entered {B_SCR_ABILITY}!"))\
    F(STRINGID_ZENMODEENDED,                                           ("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} ended!"))\

...
//new ids
    ...
    STRINGID_THIRDTYPEADDED,
     ...
     STRINGID_CONSUMED_HAZARD                   , //requires use of stin copy to set name of hazard to stringvar2 in each script
     STRINGID_PKMNBLEWAWAYSTEELSURGE            ,
     STRINGID_POINTEDSTEELSURROUNDS             ,
     STRINGID_STEELSURGE_ABSORBED               ,
     ...
     STRINGID_THUNDERCAGETRAPPED                , //missing string ids trap moves
     ...
     STRINGID_STARTEDSNOW                       , //forgot never added this

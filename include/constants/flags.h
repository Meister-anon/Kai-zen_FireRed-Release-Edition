...
#define FLAG_DEFEATED_POKEMON_TOWER_ROCKETS                                       0x23E
...
#define FLAG_PENDING_ROUTE_5_DAYCARE_EGG                 0x262
...
#define FLAG_GOT_FLOAT_STONE_FROM_OAKS_AIDE              0x2FA
...
// Unused?
#define FLAG_CAPITALIZE_ABILITY_TEXT     0x300    //when set text that capitalizes will instead show Lower case text
#define FLAG_CAPITALIZE_SPECIES_TEXT     0x301
...
#define FLAG_SAW_POKEBALL_SWAP_INTRO                                (SYS_FLAGS + 0x3E)

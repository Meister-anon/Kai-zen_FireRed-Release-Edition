...
#define WEATHER_LOW_LIGHT     (WEATHER_FOG | WEATHER_ICY_ANY | WEATHER_RAIN | WEATHER_SANDSTORM | WEATHER_MOON | WEATHER_ACID_RAIN)

//rn only used for spore
//weather effet
#define WEATHER_INCLEMENT     (WEATHER_FOG | WEATHER_ICY_ANY | WEATHER_RAIN | WEATHER_SANDSTORM | WEATHER_ACID_RAIN)

...
#define BATTLE_TYPE_PLAYER_HAS_PARTNER (BATTLE_TYPE_RECORDED_IS_MASTER | BATTLE_TYPE_SECRET_BASE)
#define BATTLE_TYPE_RAID (BATTLE_TYPE_TRIPLE | BATTLE_TYPE_GHOST)
...
#define VOLATILE_DEFINITIONS(F) \
    ...
    F(VOLATILE_STATE_RE_CHARGE,             recharge,                      (u32, 1))  \
    F(VOLATILE_STATE_CHARGING,              charging,                      (u32, 1))  \
...
#define WEATHER_RAIN          (WEATHER_RAIN_NORMAL | WEATHER_RAIN_PRIMAL | WEATHER_RAIN_DOWNPOUR)
#define WEATHER_SUN_NORMAL    (1 << BATTLE_WEATHER_SUN)
#define WEATHER_SUN_PRIMAL    (1 << BATTLE_WEATHER_SUN_PRIMAL)
#define WEATHER_SUN            (WEATHER_SUN_NORMAL | WEATHER_SUN_PRIMAL)
...
#define WEATHER_ANY           (WEATHER_RAIN | WEATHER_SANDSTORM | WEATHER_SUN | WEATHER_HAIL | WEATHER_STRONG_WINDS | WEATHER_SNOW | WEATHER_MOON | WEATHER_ACID_RAIN | WEATHER_FOG)
#define WEATHER_DAMAGING_ANY  (WEATHER_HAIL | WEATHER_SANDSTORM | WEATHER_ACID_RAIN)
#define WEATHER_COLD_ANY       (WEATHER_HAIL | WEATHER_SNOW)
#define WEATHER_LOW_LIGHT     (WEATHER_FOG | WEATHER_COLD_ANY | WEATHER_RAIN | WEATHER_SANDSTORM | WEATHER_MOON | WEATHER_ACID_RAIN)

//rn only used for spore
//weather effet
#define WEATHER_INCLEMENT     (WEATHER_FOG | WEATHER_COLD_ANY | WEATHER_RAIN | WEATHER_SANDSTORM | WEATHER_ACID_RAIN)

#define WEATHER_PRIMAL_ANY    (WEATHER_RAIN_PRIMAL | WEATHER_SUN_PRIMAL | WEATHER_STRONG_WINDS)

#define WEATHER_RAIN_ALL    (WEATHER_RAIN | WEATHER_ACID_RAIN)
#define WEATHER_LIGHT_BASED (WEATHER_SUN | WEATHER_MOON)
#define WEATHER_ICE_SAND    (WEATHER_COLD_ANY | WEATHER_SANDSTORM)
...
enum __attribute__((packed)) MoveEffect
{
    ...
    MOVE_EFFECT_RECOIL_HP_25, //appears not used?

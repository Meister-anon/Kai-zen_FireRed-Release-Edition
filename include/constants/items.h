...
//planning replace item list w EE values for add
...
//can clear num align with \W+\d+,
//think want remove and have py script
//just add the values after the fact

//ok what I could do is regex =\W+(\d+)
//line sub '' to remove a number
//and if item_ on line c
//and have it build the list number
//on compile
//need add #define ITEM_SAFARI_BALL_2 568 //for safari expansion to get around safari zone ball scripts
...
enum __attribute__((packed)) Item
{
    ...
    // Charms
    ITEM_OVAL_CHARM = 640,
    ITEM_SHINY_CHARM = 641,
    ITEM_CATCHING_CHARM = 642,
    ITEM_EXP_CHARM = 643,

    // Form-changing Key Items
    ITEM_ROTOM_CATALOG = 644,
    ITEM_GRACIDEA = 645,
    ITEM_REVEAL_GLASS = 646,
    ITEM_DNA_SPLICERS = 647,
    ITEM_ZYGARDE_CUBE = 648,
    ITEM_PRISON_BOTTLE = 649,
    ITEM_N_SOLARIZER = 650,
    ITEM_N_LUNARIZER = 651,
    ITEM_REINS_OF_UNITY = 652,

    // Battle Mechanic Key Items
    ITEM_MEGA_RING = 653,
    ITEM_Z_POWER_RING = 654,
    ITEM_DYNAMAX_BAND = 655,
    ...
    ITEM_GOOD_ROD = 660,
    ITEM_SUPER_ROD = 661,
    ITEM_DOWSING_MACHINE = 662,
    ITEM_ITEMFINDER = ITEM_DOWSING_MACHINE, // Pre-Gen IV name
    ITEM_DOWSING_MCHN = ITEM_DOWSING_MACHINE, // Gen IV-V name
    ITEM_TOWN_MAP = 663,
    ITEM_VS_SEEKER = 664,
    ITEM_TM_CASE = 665,
    ITEM_BERRY_POUCH = 666,
    ITEM_POKEMON_BOX_LINK = 667,
    ITEM_POKEMON_BOX = ITEM_POKEMON_BOX_LINK, // Pre-Gen VIII name
    ITEM_COIN_CASE = 668,
    ITEM_POWDER_JAR = 669,
    ITEM_WAILMER_PAIL = 670,
    ITEM_POKE_RADAR = 671,
    ITEM_POKEBLOCK_CASE = 672,
    ITEM_SOOT_SACK = 673,
    ITEM_POKE_FLUTE = 674,
    ITEM_FAME_CHECKER = 675,
    ITEM_TEACHY_TV = 676,

    // Story Key Items
    ITEM_SS_TICKET = 677,
    ITEM_EON_TICKET = 678,
    ITEM_MYSTIC_TICKET = 679,
    ITEM_AURORA_TICKET = 680,
    ITEM_OLD_SEA_MAP = 681,
    ITEM_LETTER = 682,
    ITEM_DEVON_PARTS = 683,
    ITEM_DEVON_GOODS = ITEM_DEVON_PARTS, // Pre-Gen VI name
    ITEM_GO_GOGGLES = 684,
    ITEM_DEVON_SCOPE = 685,
    ITEM_BASEMENT_KEY = 686,
    ITEM_SCANNER = 687,
    ...
    ITEM_SECRET_KEY = 697,
    ITEM_BIKE_VOUCHER = 698,
    ITEM_GOLD_TEETH = 699,
    ITEM_CARD_KEY = 700,
    ITEM_LIFT_KEY = 701,
    ITEM_SILPH_SCOPE = 702,
    ITEM_TRI_PASS = 703,
    ITEM_RAINBOW_PASS = 704,
    ITEM_TEA = 705,
    ITEM_RUBY = 706,
    ITEM_SAPPHIRE = 707,

    // GEN IX ITEMS
    ITEM_ABILITY_SHIELD = 708,
    ITEM_CLEAR_AMULET = 709,
    ITEM_PUNCHING_GLOVE = 710,
    ITEM_COVERT_CLOAK = 711,
    ITEM_LOADED_DICE = 712,
    ITEM_AUSPICIOUS_ARMOR = 713,
    ITEM_BOOSTER_ENERGY = 714,
    ITEM_BIG_BAMBOO_SHOOT = 715,
    ITEM_GIMMIGHOUL_COIN = 716,
    ITEM_LEADERS_CREST = 717,
    ITEM_MALICIOUS_ARMOR = 718,
    ITEM_MIRROR_HERB = 719,
    ITEM_SCROLL_OF_DARKNESS = 720,
    ITEM_SCROLL_OF_WATERS = 721,
    ITEM_TERA_ORB = 722,
    ITEM_TINY_BAMBOO_SHOOT = 723,

    ITEM_BUG_TERA_SHARD = 724,
    ITEM_DARK_TERA_SHARD = 725,
    ITEM_DRAGON_TERA_SHARD = 726,
    ITEM_ELECTRIC_TERA_SHARD = 727,
    ITEM_FAIRY_TERA_SHARD = 728,
    ITEM_FIGHTING_TERA_SHARD = 729,
    ITEM_FIRE_TERA_SHARD = 730,
    ITEM_FLYING_TERA_SHARD = 731,
    ITEM_GHOST_TERA_SHARD = 732,
    ITEM_GRASS_TERA_SHARD = 733,
    ITEM_GROUND_TERA_SHARD = 734,
    ITEM_ICE_TERA_SHARD = 735,
    ITEM_NORMAL_TERA_SHARD = 736,
    ITEM_POISON_TERA_SHARD = 737,
    ITEM_PSYCHIC_TERA_SHARD = 738,
    ITEM_ROCK_TERA_SHARD = 739,
    ITEM_STEEL_TERA_SHARD = 740,
    ITEM_WATER_TERA_SHARD = 741,

    ITEM_ADAMANT_CRYSTAL = 742,
    ITEM_GRISEOUS_CORE = 743,
    ITEM_LUSTROUS_GLOBE = 744,

    ITEM_BLACK_AUGURITE = 745,
    ITEM_LINKING_CORD = 746,
    ITEM_PEAT_BLOCK = 747,
    ITEM_BERSERK_GENE = 748,

    ITEM_FAIRY_FEATHER = 749,
    ITEM_SYRUPY_APPLE = 750,
    ITEM_UNREMARKABLE_TEACUP = 751,
    ITEM_MASTERPIECE_TEACUP = 752,
    ITEM_CORNERSTONE_MASK = 753,
    ITEM_WELLSPRING_MASK = 754,
    ITEM_HEARTHFLAME_MASK = 755,
    ITEM_HEALTH_MOCHI = 756,
    ITEM_MUSCLE_MOCHI = 757,
    ITEM_RESIST_MOCHI = 758,
    ITEM_GENIUS_MOCHI = 759,
    ITEM_CLEVER_MOCHI = 760,
    ITEM_SWIFT_MOCHI = 761,
    ITEM_FRESH_START_MOCHI = 762,
    ITEM_GLIMMERING_CHARM = 763,
    ITEM_METAL_ALLOY = 764,
    ITEM_STELLAR_TERA_SHARD = 765,

    ITEM_JUBILIFE_MUFFIN = 766,
    ITEM_REMEDY = 767,
    ITEM_FINE_REMEDY = 768,
    ITEM_SUPERB_REMEDY = 769,
    ITEM_AUX_EVASION = 770,
    ITEM_AUX_GUARD = 771,
    ITEM_AUX_POWER = 772,
    ITEM_AUX_POWERGUARD = 773,
    ITEM_CHOICE_DUMPLING = 774,
    ITEM_SWAP_SNACK = 775,
    ITEM_TWICE_SPICED_RADISH = 776,
    ITEM_POKESHI_DOLL = 777,

    ITEM_STRANGE_BALL = 778,

    // Legends Z-A Mega Stones
    ITEM_CLEFABLITE = 779,
    ITEM_VICTREEBELITE = 780, //has planned rework
    ITEM_STARMINITE = 781,
    ITEM_DRAGONINITE = 782, //attempting tweak
    ITEM_MEGANIUMITE = 783,
    ITEM_FERALIGITE = 784,
    ITEM_SKARMORITE = 785,
    ITEM_FROSLASSITE = 786, //keep
    ITEM_EMBOARITE = 787,
    ITEM_EXCADRITE = 788,
    ITEM_SCOLIPITE = 789,
    ITEM_SCRAFTINITE = 790, //keep
    ITEM_EELEKTROSSITE = 791, //deciding
    ITEM_CHANDELURITE = 792, //meh
    ITEM_CHESNAUGHTITE = 793,
    ITEM_DELPHOXITE = 794, //keep
    ITEM_GRENINJITE = 795, //replacing add _z
    ITEM_PYROARITE = 796,
    ITEM_FLOETTITE = 797,
    ITEM_MALAMARITE = 798, //keep
    ITEM_BARBARACITE = 799,
    ITEM_DRAGALGITE = 800,
    ITEM_HAWLUCHANITE = 801, //eh
    ITEM_ZYGARDITE = 802,
    ITEM_DRAMPANITE = 803,
    ITEM_FALINKSITE = 804,
    ...
    ITEM_DARKRANITE = 806,
    ITEM_ZERAORITE = 807,
    ITEM_RAICHUNITE_X = 808,
    ITEM_RAICHUNITE_Y = 809,
    ITEM_CHIMECHITE = 810,
    ITEM_ABSOLITE_Z = 811, //keep
    ITEM_STARAPTITE = 812,
    ITEM_GARCHOMPITE_Z = 813, //keep
    ITEM_LUCARIONITE_Z = 814,
    ITEM_GOLURKITE = 815,
    ITEM_MEOWSTICITE = 816, //hella keep
    ITEM_CRABOMINITE = 817,
    ITEM_GOLISOPITE = 818,
    ITEM_MAGEARNITE = 819, //keep
    ITEM_SCOVILLAINITE = 820, //think keep
    ITEM_BAXCALIBRITE = 821,
    ITEM_TATSUGIRINITE = 822,
    ITEM_GLIMMORANITE = 823, //keep

    //Custom items + tm expansion
    ITEM_EXP_NULL,
    ITEM_EVIOLITE_FAIL,
    ITEM_SAFARI_BALL_2, //for safari expansion get around safari zone ball scripts
    ITEM_ALOLAN_SAND,
    ITEM_GALAR_SAND,
    ITEM_HISUIAN_SAND,
    ITEM_PALDEAN_SAND, 
...
//at what hp threshold they trigger

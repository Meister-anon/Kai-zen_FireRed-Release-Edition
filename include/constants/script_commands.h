...
enum ScrOp
{
    ...
    SCR_OP_GOTOSTD = 0x8,
    SCR_OP_CALLSTD = 0x9,
    SCR_OP_GOTOSTD_IF = 0xA,
    SCR_OP_CALLSTD_IF = 0xB,
    SCR_OP_GOTORAM = 0xC,
    SCR_OP_KILLSCRIPT = 0xD,
    SCR_OP_SETMYSTERYEVENTSTATUS = 0xE,
    SCR_OP_LOADWORD = 0xF,
    SCR_OP_LOADBYTE = 0x10,
    SCR_OP_WRITEBYTETOADDR = 0x11,
    SCR_OP_LOADBYTEFROMADDR = 0x12,
    ...
    SCR_OP_COMPARE_LOCAL_TO_ADDR = 0x1D,
    SCR_OP_COMPARE_ADDR_TO_LOCAL = 0x1E,
    SCR_OP_COMPARE_ADDR_TO_VALUE = 0x1F,
    SCR_OP_COMPARE_ADDR_TO_ADDR = 0x20,
    ...
    SCR_OP_GIVEDECORATION = 0x4B,
    SCR_OP_TAKEDECORATION = 0x4C,
    SCR_OP_CHECKDECOR = 0x4D,
    SCR_OP_CHECKDECORSPACE = 0x4E,
    SCR_OP_APPLYMOVEMENT = 0x4F,
    SCR_OP_APPLYMOVEMENT_AT = 0x50,
    SCR_OP_WAITMOVEMENT = 0x51,
    SCR_OP_WAITMOVEMENT_AT = 0x52,
    SCR_OP_REMOVEOBJECT = 0x53,
    SCR_OP_REMOVEOBJECT_AT = 0x54,
    SCR_OP_ADDOBJECT = 0x55,
    SCR_OP_ADDOBJECT_AT = 0x56,
    SCR_OP_SETOBJECTXY = 0x57,
    SCR_OP_SHOWOBJECT_AT = 0x58,
    SCR_OP_HIDEOBJECT_AT = 0x59,
    ...
    SCR_OP_MOVEOBJECTOFFSCREEN = 0x64,
    ...
    SCR_OP_SHOWCONTESTWINNER = 0x77,
    SCR_OP_BRAILLEMESSAGE = 0x78,
    SCR_OP_GIVEMON = 0x79,
    SCR_OP_GIVEEGG = 0x7A,
    SCR_OP_SETMONMOVE = 0x7B,
    SCR_OP_CHECKPARTYMOVE = 0x7C,
    ...
    SCR_OP_SETOBJECTPRIORITY = 0xA8,
    SCR_OP_RESETOBJECTPRIORITY = 0xA9,
    ...
    SCR_OP_COMPARESTATTOWORD = 0xCC,
    SCR_OP_SETMONEVENTLEGAL = 0xCD,
    SCR_OP_CHECKMONEVENTLEGAL = 0xCE,
    SCR_OP_EXECRAM = 0xCF,
    SCR_OP_SETWORLDMAPFLAG = 0xD0,
    SCR_OP_WARPTELEPORT2 = 0xD1,
    SCR_OP_SETMONMETLOCATION = 0xD2,
    SCR_OP_GETBRAILLESTRINGWIDTH = 0xD3,
    SCR_OP_BUFFERITEMNAMEPLURAL = 0xD4,
    SCR_OP_BUFFERSPECIESTYPE = 0xD5,
    SCR_OP_GIVEMON2 = 0xD6,
    SCR_OP_POKEMART2 = 0xD7,
    SCR_OP_GIVEGROUP = 0xD8,
    SCR_OP_UPDATEOAKRANCH = 0xD9,
    SCR_OP_PREVENTBOXHEAL = 0xDA,
    SCR_OP_GETMONDATA = 0xDB,
    SCR_OP_RETURNISPLAYERBLOCKINGOBJECTPATH = 0xDC,
    SCR_OP_SETSAFARIBALLCOUNT = 0xDD,
    SCR_OP_TOGGLEFLAG = 0xDE,
    SCR_OP_SELECTAPPROACHINGTRAINER = 0xDF,
    SCR_OP_LOCKFORTRAINER = 0xE0,
};

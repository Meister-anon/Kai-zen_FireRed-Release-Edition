...
static const struct TmHmOrder gTMHM_List[] = {
    ...
    [ITEM_TM_MOONDANCE] = TMHM(ITEM_TM_MOONDANCE, 154),
    [ITEM_TM_ACID_RAIN] = TMHM(ITEM_TM_ACID_RAIN, 155),
    [ITEM_TM141] = TMHM(ITEM_TM141, 156),
    [ITEM_TM142] = TMHM(ITEM_TM142, 157),
    [ITEM_TM_TRAILBLAZE] = TMHM(ITEM_TM_TRAILBLAZE, 158),
    [ITEM_TM143] = TMHM(ITEM_TM143, 159),
    [ITEM_TM144] = TMHM(ITEM_TM144, 160),
    [ITEM_TM145] = TMHM(ITEM_TM145, 161),
    [ITEM_TM146] = TMHM(ITEM_TM146, 162),
    [ITEM_TM147] = TMHM(ITEM_TM147, 163),
    [ITEM_TM148] = TMHM(ITEM_TM148, 164),
    [ITEM_TM149] = TMHM(ITEM_TM149, 165),
    [ITEM_TM_AEROBLAST] = TMHM(ITEM_TM_AEROBLAST, 166),
    [ITEM_TM150] = TMHM(ITEM_TM150, 167),
    [ITEM_TM151] = TMHM(ITEM_TM151, 168),
    [ITEM_TM152] = TMHM(ITEM_TM152, 169),
    [ITEM_TM153] = TMHM(ITEM_TM153, 170),
    [ITEM_TM154] = TMHM(ITEM_TM154, 171),
    [ITEM_TM155] = TMHM(ITEM_TM155, 172),
    [ITEM_TM156] = TMHM(ITEM_TM156, 173),
    [ITEM_TM157] = TMHM(ITEM_TM157, 174),
    [ITEM_TM158] = TMHM(ITEM_TM158, 175),

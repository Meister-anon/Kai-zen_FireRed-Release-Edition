...
#define STRINGID_PLAYERWHITEDOUT BATTLESTRINGS_COUNT + 3
#define STRINGID_MONTOOSCAREDTOMOVE BATTLESTRINGS_COUNT + 4
#define STRINGID_GHOSTGETOUTGETOUT BATTLESTRINGS_COUNT + 5
#define STRINGID_SILPHSCOPEUNVEILED BATTLESTRINGS_COUNT + 6
#define STRINGID_GHOSTWASMAROWAK BATTLESTRINGS_COUNT + 7
#define STRINGID_TRAINER1MON1COMEBACK BATTLESTRINGS_COUNT + 8
#define STRINGID_TRAINER1WINTEXT BATTLESTRINGS_COUNT + 9

...
struct SaveBlock2
{
    ...
    /*0x014*/ u16 optionsTextSpeed:3; // OPTIONS_TEXT_SPEED_[SLOW/MID/FAST/FASTER/HYPER]
              ...
              u16 optionsTurnBattleSceneOff:1; // whether battle animations are disabled
              u16 regionMapZoom:1; // whether the map is zoomed in - Leftover from R/S  not used in FR/LG potentially useful if add dexnav/pokenav?

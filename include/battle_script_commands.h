...
u8 GetMoveTwoTurnAttackStringId(u16 move); //script chooser set values for charge turn of two turn moves
...
u8 IsExemptFromPursuit(u32 battler); //for blocking effect without needing separate battlescript

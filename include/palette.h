...
extern u8 gPaletteDecompressionBuffer[PLTT_DECOMP_BUFFER_SIZE]; //added for later day night system work
...
u8 PrevPaletteFadeResult(void); //new port from Pokabbie for battle speedup
